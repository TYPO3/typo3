...
class SC_index {
	...
	protected function mergeOldLoginLabels() {
		...
		if ($oldLoginLabels != '') {
			t3lib_div::deprecationLog('The use of $GLOBALS[\'TYPO3_CONF_VARS\'][\'BE\'][\'loginLabels\'] has been deprecated as of TYPO3 4.4, please use the according locallang.xml file.');
