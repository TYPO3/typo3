...
/*]]>*/
	 ...
	 * @param boolean $addSaveOptions If $addSaveOptions is set, then also the array of save-options for TCE_FORMS will appear.
	 ...
	 */
	function clearCacheMenu($id, $addSaveOptions = FALSE) {
		t3lib_div::logDeprecatedFunction();
		$opt=array();
		if ($addSaveOptions)	{
