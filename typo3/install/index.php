...
$shouldDeleteInstallToolFile = FALSE;
...
if (is_file($enableInstallToolFile) && (time() - filemtime($enableInstallToolFile) > 3600)) {
	...
	if (trim($content) !== $verifyString) {
		...
		if(is_writeable($enableInstallToolFile)) {
			unlink($enableInstallToolFile);
		} else {
			$shouldDeleteInstallToolFile = TRUE;
		}
...
if (1==2 || !is_file($enableInstallToolFile) || $shouldDeleteInstallToolFile) {
