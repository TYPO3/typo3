 ...
 * @subpackage typo3
 */
class Typo3_Clipboard_Clipboard implements t3lib_Singleton {

	/**
	 * Is clipboard is persisted after logout
	 *
	 * @var boolean
	 */
	protected $doCrossSessionPersistence = TRUE;
	...
	public function __construct() {
		$this->doCrossSessionPersistence = $GLOBALS['BE_USER']->getTSConfigVal('options.saveClipboard');
	 ...
	 *
	 * @param integer $id
	 * @return Typo3_Clipboard_Pad
	 */
	protected function createPad($id) {
		return Typo3_Clipboard_Pad::load(t3lib_utility_Math::forceIntegerInRange($id, 0, $this->numberOfPads - 1, 0));
	}
	 ...
	 * @return boolean
	 */
	public function hasDisplayProperty($property) {
	...
	protected function getData() {
		if ($this->getDoCrossSessionPersistence()) {
			return (array)$GLOBALS['BE_USER']->uc['moduleData']['clipboard'];
		} else {
			return (array)$GLOBALS['BE_USER']->getSessionData('clipboard');
		}
	}
	...
	/**
	 * @param boolean $doCrossSessionPersistence
	 */
	public function setDoCrossSessionPersistence($doCrossSessionPersistence) {
		$this->doCrossSessionPersistence = $doCrossSessionPersistence;
	}

	/**
	 * @return boolean
	 */
	public function getDoCrossSessionPersistence() {
		return $this->doCrossSessionPersistence;
	}
