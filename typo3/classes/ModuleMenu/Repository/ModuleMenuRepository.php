 ...
 * @subpackage core
 */
class Typo3_Repository_ModuleMenuRepository implements t3lib_Singleton {

	/**
	 * @var Typo3_ModuleMenu $moduleMenu
	 */
	...
	/**
	 * Find's' a module menu entry by name
	 *
	 * @param string $name
	 * @return Typo3_ModuleMenuEntry|boolean
	 */
	...
	/**
	 * Find a module menu entry by name in a given storage
	 *
	 * @param string $name
	 * @param SplObjectStorage $entries
	 * @return Typo3_ModuleMenuEntry|bool
	 */
