 ...
 * @subpackage core
 */
class Typo3_ModuleMenu_Utility {
	/**
	 * @var Typo3_ModuleMenu
	 */
	protected $moduleMenu;

	/**
	 * @var Typo3_Repository_ModuleMenuRepository
	 */
	...
	public function __construct() {
		$this->moduleMenu = t3lib_div::makeInstance('Typo3_ModuleMenu');
		$this->moduleMenuRepository = t3lib_div::makeInstance('Typo3_Repository_ModuleMenuRepository');
	}

	/**
	 * This method creates the module menu if necessary
	 * afterwards you only need an instance of Typo3_ModuleMenu
	 * to get the menu
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param array $module
	 * @return Typo3_ModuleMenuEntry
	 */
	protected function createEntryFromRawData(array $module) {
		/** @var $entry Typo3_ModuleMenuEntry */
		$entry = t3lib_div::makeInstance('Typo3_ModuleMenuEntry');
