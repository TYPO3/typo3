...
class EnhancerSiteRequestTest extends AbstractTestCase
{
    ...
    {
        $this->applyExceptionDeclaration($testSet);
    ...
    protected function applyExceptionDeclaration(TestSet $testSet): void
    {
        ...
        if ($exceptionDeclaration->getClassName() !== null) {
            $this->expectException($exceptionDeclaration->getClassName());
        }
        if ($exceptionDeclaration->getCode() !== null) {
            $this->expectExceptionCode($exceptionDeclaration->getCode());
        }
