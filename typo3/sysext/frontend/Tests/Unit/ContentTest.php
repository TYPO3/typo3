 ...
 ***************************************************************/
/**
 * Testcase for the TYPO3\CMS\Frontend\ContentObject\ContentObjectRenderer class in the TYPO3 Core.
 *
 * @package TYPO3
 * @subpackage tslib
...
class ContentTest extends \tx_phpunit_testcase {
	...
	public function tearDown() {
		...
		$GLOBALS['TSFE'] = NULL;
		unset($this->backupGlobalVariables, $this->cObj, $this->tsfe, $this->template, $this->typoScriptImage);
	}
