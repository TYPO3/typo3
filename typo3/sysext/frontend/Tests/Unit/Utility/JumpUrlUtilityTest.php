...
class JumpUrlUtilityTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	public function jumpUrlAcceptsValidUrlsDataProvider() {
		return array(
			array(
	...
	/**
	 * @test
	 * @dataProvider jumpUrlAcceptsValidUrlsDataProvider
	 */
	...
	public function jumpUrlSecureAcceptsValidUrlsDataProvider() {
	...
	/**
	 * @test
	 * @dataProvider jumpUrlSecureAcceptsValidUrlsDataProvider
	 */
