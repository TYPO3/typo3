...
class RecordsContentObject extends AbstractContentObject {
	...
	public function render($conf = array()) {
		...
		if ($tables) {
			...
			if ($source) {
				...
				$this->collectRecordsFromCategories($categories, $tablesArray);
			}
	 ...
	 * @return void
	 */
	protected function collectRecordsFromSource($source, $tables) {
	 ...
	 * @return void
	 */
	protected function collectRecordsFromCategories($selectedCategories, $tables) {
