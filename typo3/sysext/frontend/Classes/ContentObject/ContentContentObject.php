				...
				if ($error = $GLOBALS['TYPO3_DB']->sql_error()) {
					...
					while ($row = $GLOBALS['TYPO3_DB']->sql_fetch_assoc($res)) {
						...
						if (is_array($row)) {
							...
							if (is_array($TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_content_content.php']['modifyDBRow'])) {
								foreach ($TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_content_content.php']['modifyDBRow'] as $_classRef) {
