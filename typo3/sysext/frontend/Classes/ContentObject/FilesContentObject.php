	...
	public function render($conf = array()) {
		...
		if ($conf['references'] || $conf['references.']) {
			...
			if ($referencesFieldName) {
				...
				$this->addToArray($fileRepository->findByRelation($referencesForeignTable, $referencesFieldName, $referencesForeignUid, $referencesMaximum, $referencesOffset), $fileObjects);
			}
		}
