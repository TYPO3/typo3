...
class AboutController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function indexAction() {
		...
		$this->view->assign('TYPO3Version', TYPO3_version)->assign('TYPO3CopyrightYear', TYPO3_copyright_year)->assign('TYPO3UrlDonate', TYPO3_URL_DONATE)->assign('loadedExtensions', $extensions);
	}
