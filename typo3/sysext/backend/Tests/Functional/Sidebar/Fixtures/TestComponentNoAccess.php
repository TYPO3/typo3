...
#[AsSidebarComponent(identifier: 'test-component-no-access')]
final class TestComponentNoAccess implements SidebarComponentInterface
{
    public function getResult(SidebarComponentContext $context): SidebarComponentResult
    {
        return new SidebarComponentResult('test-component-no-access', '<div>No Access Component</div>');
    }
