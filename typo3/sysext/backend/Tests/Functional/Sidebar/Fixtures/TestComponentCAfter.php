...
#[AsSidebarComponent(
    identifier: 'test-component-c-after',
    after: ['test-component-a'],
)]
final class TestComponentCAfter implements SidebarComponentInterface
{
    public function getResult(SidebarComponentContext $context): SidebarComponentResult
    {
        return new SidebarComponentResult('test-component-c-after', '<div>Component C (after A)</div>');
    }
