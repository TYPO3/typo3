...
<div class="btn-group">
    ...
    <ul class="dropdown-menu">
        <li>
            <typo3-backend-bookmark-button route="records" arguments="{&quot;id&quot;:123,&quot;table&quot;:&quot;some_table&quot;,&quot;GET&quot;:{&quot;clipBoard&quot;:1}}" display-name="Recordlist - single table view" class="dropdown-item dropdown-item-spaced"></typo3-backend-bookmark-button>
        </li>
        <li>
            <typo3-copy-to-clipboard
                text="http://example.com/typo3/module/content/records?id=123&amp;table=some_table&amp;GET%5BclipBoard%5D=1"
