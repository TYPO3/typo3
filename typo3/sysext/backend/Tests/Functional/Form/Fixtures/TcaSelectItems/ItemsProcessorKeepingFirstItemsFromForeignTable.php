...
/**
 * This class is used for testing itemsProcessors in the context select-type fields.
 *
 * It filters out items with a value smaller than 3.
 */
class ItemsProcessorKeepingFirstItemsFromForeignTable implements ItemsProcessorInterface
{
    public function processItems(
        SelectItemCollection $items,
        ItemsProcessorContext $context,
    ): SelectItemCollection {
        $filteredItems = new SelectItemCollection();
