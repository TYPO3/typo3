...
final class DocumentationViewHelperTest extends FunctionalTestCase
{
    ...
    public function renderReturnsValidLink(): void
    {
        ...
        $context->getTemplatePaths()->setTemplateSource('<be:link.documentation identifier="foobar" class="baz" additionalAttributes="{\'target\':\'_self\', \'rel\':\'nofollow\'}">see documentation</be:link.documentation>');
        $result = urldecode((new TemplateView($context))->render());

        $typo3Version = (new Typo3Version())->getBranch();
        self::assertSame('<a target="_blank" rel="noreferrer" class="baz" href="https://docs.typo3.org/permalink/foobar@' . $typo3Version . '">see documentation</a>', $result);
    }
