...
class ItemsProcessorForTestingExceptionsForCheckboxItems implements ItemsProcessorInterface
{
    public function processItems(
        ...
        if (
            ...
            || $items->current()['invertStateDisplay'] !== false
            ...
            || $context->additionalParameters['flexParentDatabaseRow']['aParentDatabaseRowFieldName'] !== 'aParentDatabaseRowFieldValue'
            ...
            throw new \UnexpectedValueException('broken', 1761741675);
        }
        return $items;
    }
}
