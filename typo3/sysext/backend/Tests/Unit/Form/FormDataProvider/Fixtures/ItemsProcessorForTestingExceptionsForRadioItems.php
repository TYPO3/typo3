...
class ItemsProcessorForTestingExceptionsForRadioItems implements ItemsProcessorInterface
{
    public function processItems(
        ...
        $items->rewind();
        if (
            $items->current()['label'] !== 'foo'
            || $items->current()['value'] !== 'bar'
            ...
            throw new \UnexpectedValueException('broken', 1761741666);
        }
        return $items;
    }
}
