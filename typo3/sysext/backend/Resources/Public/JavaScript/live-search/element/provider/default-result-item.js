...
var __decorate=function(e,t,r,i){var o,a=arguments.length,l=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,r,i);else for(var c=e.length-1;c>=0;c--)(o=e[c])&&(l=(a<3?o(l):a>3?o(t,r,l):o(t,r))||l);return a>3&&l&&Object.defineProperty(t,r,l),l};import{customElement,property}from"lit/decorators.js";import{html,LitElement}from"lit";import"@typo3/backend/element/icon-element.js";let PageProviderResultItem=class extends LitElement{createRenderRoot(){return this}render(){return html`
      ...
      <div class="livesearch-result-item-title">
        ${this.itemTitle}${void 0!==this.extraData.breadcrumb?html`<br><small>${this.extraData.breadcrumb}</small>`:""}
      </div>
    `}};__decorate([property({type:Object,attribute:!1})],PageProviderResultItem.prototype,"icon",void 0),__decorate([property({type:String,attribute:!1})],PageProviderResultItem.prototype,"itemTitle",void 0),__decorate([property({type:String,attribute:!1})],PageProviderResultItem.prototype,"typeLabel",void 0),__decorate([property({type:Object,attribute:!1})],PageProviderResultItem.prototype,"extraData",void 0),PageProviderResultItem=__decorate([customElement("typo3-backend-live-search-result-item-default")],PageProviderResultItem);export{PageProviderResultItem};