 ...
 ***************************************************************/
/**
 * JavaScript RequireJS module called "TYPO3/CMS/Backend/TabMenu"
 *
 ...
 *
 */
define('TYPO3/CMS/Backend/TabMenu', ['jquery', 'TYPO3/CMS/Backend/Plugins/TabMenuPlugin'], function($) {
	...
	var initialize = function(options) {
		...
		if (undefined !== TYPO3.settings && undefined !== TYPO3.settings.RequireJS.PostInitializationModules && undefined !== TYPO3.settings.RequireJS.PostInitializationModules['TYPO3/CMS/Backend/TabMenu']) {
