      ...
      <div class="settings-category-list" data-key=${e.key}>
        <div class="settings-category" data-key=${e.key} ?hidden=${e.__hidden}>
          ...
          <div class="settings-category-description">
            ${e.description?markdown(e.description,"minimal"):nothing}
          </div>
        </div>
