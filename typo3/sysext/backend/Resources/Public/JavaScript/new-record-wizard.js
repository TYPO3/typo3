...
var __decorate=function(e,t,o,r){var i,a=arguments.length,n=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(n=(a<3?i(n):a>3?i(t,o,n):i(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};import{customElement,property}from"lit/decorators.js";import{html,css,LitElement,nothing}from"lit";import Modal from"@typo3/backend/modal.js";import"@typo3/backend/element/icon-element.js";import AjaxRequest from"@typo3/core/ajax/ajax-request.js";import{lll}from"@typo3/core/lit-helper.js";import Notification from"@typo3/backend/notification.js";import Viewport from"@typo3/backend/viewport.js";import RegularEvent from"@typo3/core/event/regular-event.js";import{KeyTypesEnum}from"@typo3/backend/enum/key-types.js";class Item{constructor(e,t,o,r,i,a,n,s,l){this.identifier=e,this.label=t,this.description=o,this.icon=r,this.url=i,this.requestType=a,this.defaultValues=n,this.saveAndClose=s,this.event=l,this.visible=!0}static fromData(e){return new Item(e.identifier,e.label,e.description,e.icon,e.url??null,e.requestType??"location",e.defaultValues??[],e.saveAndClose??!1,e.event??null)}reset(){this.visible=!0}}export class Category{constructor(e,t,o){this.identifier=e,this.label=t,this.items=o,this.disabled=!1}static fromData(e){return new Category(e.identifier,e.label,e.items.map((e=>Item.fromData(e))))}reset(){this.disabled=!1,this.items.forEach((e=>{e.reset()}))}activeItems(){return this.items.filter((e=>e.visible))??[]}}export class Categories{constructor(e){this.items=e}static fromData(e){return new Categories(Object.values(e).map((e=>Category.fromData(e))))}reset(){this.items.forEach((e=>{e.reset()}))}categoriesWithItems(){return this.items.filter((e=>e.activeItems().length>0))??[]}}let NewRecordWizard=class extends LitElement{constructor(){super(...arguments),this.categories=new Categories([]),this.searchPlaceholder="newRecordWizard.filter.placeholder",this.searchNothingFoundLabel="newRecordWizard.filter.noResults",this.selectedCategory=null,this.searchTerm="",this.messages=[],this.toggleMenu=!1}firstUpdated(){const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href",TYPO3.settings.cssUrls.backend),this.shadowRoot.appendChild(e);this.renderRoot.querySelector('input[name="search"]').focus(),this.selectAvailableCategory()}getLanguageLabel(e){const t=lll(e);return""!==t?t:e}selectAvailableCategory(){0===this.categories.categoriesWithItems().filter((e=>e===this.selectedCategory)).length&&(this.selectedCategory=this.categories.categoriesWithItems()[0]??null),this.messages=[],null===this.selectedCategory&&(this.messages=[{message:this.getLanguageLabel(this.searchNothingFoundLabel),severity:"info"}])}filter(e){this.searchTerm=e,this.categories.reset(),this.categories.items.forEach((e=>{const t=e.label.trim().replace(/\s+/g," ");!(""!==this.searchTerm&&!RegExp(this.searchTerm,"i").test(t))||e.items.forEach((e=>{const t=e.label.trim().replace(/\s+/g," ")+e.description.trim().replace(/\s+/g," ");e.visible=!(""!==this.searchTerm&&!RegExp(this.searchTerm,"i").test(t))})),e.disabled=0===e.items.filter((e=>e.visible)).length})),this.selectAvailableCategory()}render(){return html`
  ...
  ${this.categories.items.map((e=>this.renderCategory(e)))}
    ...
    `}renderCategory(e){return html`${this.selectedCategory===e?html`
      ...
      `:nothing}`}handleItemClick(e){if("event"===e.requestType){const t=new CustomEvent(e.event,{detail:{item:e}});return this.dispatchEvent(t),void Modal.dismiss()}if(""!==e.url.trim())return"location"===e.requestType?(Viewport.ContentContainer.setUrl(e.url),void Modal.dismiss()):void("ajax"===e.requestType&&new AjaxRequest(e.url).post({defVals:e.defaultValues,saveAndClose:e.saveAndClose?"1":"0"}).then((async e=>{const t=document.createRange().createContextualFragment(await e.resolve());Modal.currentModal.addEventListener("modal-updated",(()=>{new RegularEvent("click",((e,t)=>{e.preventDefault();const o=t.dataset.target;o&&(Viewport.ContentContainer.setUrl(o),Modal.dismiss())})).delegateTo(Modal.currentModal,"button[data-target]")})),Modal.currentModal.setContent(t)})).catch((()=>{Notification.error("Could not load module data")})))}};NewRecordWizard.styles=[css`
      :host {
        display: block;
