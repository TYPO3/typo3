    ...
    `}renderFilter(){return html`
      <form class="filter" @submit="${e=>e.preventDefault()}">
        <input
          ...
          @keydown="${e=>{e.key===KeyTypesEnum.ESCAPE&&(e.stopImmediatePropagation(),this.filter(""))}}"
