		...
		if ($this->page_id) {
			...
			if ((string) $this->table == 'tt_content') {
				...
				if (is_array($pageinfo) && $GLOBALS['BE_USER']->isInWebMount($pageinfo['pid'], $this->perms_clause)) {
					...
					$colPosArray = \TYPO3\CMS\Core\Utility\GeneralUtility::callUserFunction('EXT:backend/Classes/View/BackendLayoutView.php:TYPO3\\CMS\\Backend\\View\\BackendLayoutView->getColPosListItemsParsed', $this->page_id, $this);
