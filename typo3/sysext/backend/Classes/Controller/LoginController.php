...
class LoginController {
    ...
    protected function initOpenIdProviders()
    {
        ...
        $providers = array();
        if (isset($TYPO3_CONF_VARS['SVCONF']['auth']['tx_openid']['providers'])) {
            $providers = $TYPO3_CONF_VARS['SVCONF']['auth']['tx_openid']['providers'];
        }

        $globalConfig = unserialize($TYPO3_CONF_VARS['EXT']['extConf']['openid']);
