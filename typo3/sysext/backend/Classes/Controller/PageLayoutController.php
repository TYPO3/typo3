...
class PageLayoutController {
	...
	public function main() {
		...
		if ($this->id && $access) {
			...
			$colPosList = GeneralUtility::makeInstance('TYPO3\\CMS\\Backend\\View\\BackendLayoutView', $this->id)->getSelectedBackendLayoutColPosList();
	...
	public function renderListContent() {
		...
		$tableJSOutput = array();
		$CMcounter = 0;
		$tcaItems = GeneralUtility::makeInstance('TYPO3\\CMS\\Backend\\View\\BackendLayoutView', $this->id)->getColPosListItemsParsed();
