...
abstract class AbstractTreeView {
	...
	public function getTitleStr($row, $titleLen = 30) {
		if ($this->ext_showNavTitle && strlen(trim($row['nav_title']))) {
			...
			$title = trim($row['title']) ?: '<em>[' . $GLOBALS['LANG']->sL('LLL:EXT:lang/locallang_core.php:labels.no_title', 1) . ']</em>';
		}
		return $title;
	}
