	...
	public function printTree($treeItems = '') {
		...
		if (empty($treeItems)) {
			$message = GeneralUtility::makeInstance(
				...
				$this->getLanguageService()->sL('LLL:EXT:backend/Resources/Private/Language/locallang_errors.xlf:foldertreeview.noFolders.message'),
				$this->getLanguageService()->sL('LLL:EXT:backend/Resources/Private/Language/locallang_errors.xlf:foldertreeview.noFolders.title'),
				FlashMessage::INFO
			);
