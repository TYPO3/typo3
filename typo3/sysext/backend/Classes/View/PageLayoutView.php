		...
		if (!$this->tt_contentConfig['single']) {
			...
			foreach ($langListArr as $lP) {
				...
				foreach ($cList as $key) {
					...
					$tcaItems = \TYPO3\CMS\Core\Utility\GeneralUtility::callUserFunction('EXT:backend/Classes/View/BackendLayoutView.php:TYPO3\\CMS\\Backend\\View\\BackendLayoutView->getColPosListItemsParsed', $id, $this);
