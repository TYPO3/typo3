...
class ElementConditionMatcher {
	 ...
	 *
	 * The condition string is separated by colons and the first part indicated what type of evaluation should be
	 * performed.
	 *
	 ...
	 *
	 * Example:
	 * "EXT:saltedpasswords:LOADED:TRUE" => TRUE, if the extension saötedpasswords is loaded.
	 *
