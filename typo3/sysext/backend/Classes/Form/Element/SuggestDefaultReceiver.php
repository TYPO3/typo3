...
class SuggestDefaultReceiver {
	...
	/**
	 * Return the icon for a record - just a wrapper for two functions from IconUtility
	 *
	...
	/**
	 * Returns a label for a given record; usually only a wrapper for BackendUtility::getRecordTitle
	 *
