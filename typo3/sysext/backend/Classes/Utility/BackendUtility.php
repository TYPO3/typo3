...
class BackendUtility {
	 ...
	 * @param string $printAllWrap Wrap value - set function description - this parameter is deprecated since TYPO3 6.1, and is removed two versions later. This paramater is a conceptual failure, as the content can then never be HSCed afterwards (which is how the method is used all the time), and then the code would be HSCed twice.
	...
	static public function getItemLabel($table, $col, $printAllWrap = '') {
		...
		if ($printAllWrap) {
			\TYPO3\CMS\Core\Utility\GeneralUtility::deprecationLog('The third parameter of getItemLabel() is deprecated with TYPO3 CMS 6.1, and will be removed two versions later.');
