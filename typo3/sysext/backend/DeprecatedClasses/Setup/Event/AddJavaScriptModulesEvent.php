 ...
 * This is the prior implementation before the move of EXT:setup into EXT:backend.
 * @deprecated since 14.0, remove in 15.0 - replacement is TYPO3\CMS\Backend\Event\AddUserSettingsJavaScriptModulesEvent
 */
