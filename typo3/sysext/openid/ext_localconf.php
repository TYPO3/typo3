...
if (TYPO3_MODE == 'BE') {
	$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['LoginForm']['provideLoginForm'][200]
		= array(
			'callback' => 'TYPO3\\CMS\\Openid\\View\\LoginForm\\Openid->render',
			'conf' => array(
				'template' => 'EXT:openid/Resources/Private/Templates/LoginForm/Openid.html',
				'css' => 'sysext/openid/Resources/Public/StyleSheet/login.css'
			)
		);
}
?>