...
class Openid {
	 ...
	 *
	 * @param array  $params    Array with keys "forms" and "labels"
	...
	public function render($params, LoginController $loginCtrl) {
		...
		$view->setTemplatePathAndFilename(
			...
			'Resources/Private/Templates/LoginForm/Openid.html'
		);
		...
		$GLOBALS['TBE_TEMPLATE']->getPageRenderer()->enableDebugMode();
		$GLOBALS['TBE_TEMPLATE']->getPageRenderer()->addCssFile(
			ExtensionManagementUtility::extRelPath('openid') .
			'Resources/Public/StyleSheet/login.css'
		);
	}
}
?>
