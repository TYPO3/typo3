 ...
 */
var __decorate=function(e,t,o,l){var r,i=arguments.length,c=i<3?t:null===l?l=Object.getOwnPropertyDescriptor(t,o):l;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)c=Reflect.decorate(e,t,o,l);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(c=(i<3?r(c):i>3?r(t,o,c):r(t,o))||c);return i>3&&c&&Object.defineProperty(t,o,c),c};import{customElement,property}from"lit/decorators.js";import{html,LitElement}from"lit";import{lll}from"@typo3/core/lit-helper.js";import"@typo3/backend/element/icon-element.js";const selectorConverter={fromAttribute:e=>document.querySelector(e)};let ThemeSwitcherElement=class extends LitElement{constructor(){super(...arguments),this.activeTheme="light",this.themes={light:{icon:"actions-brightness-high",label:"colorScheme.light.label"},dark:{icon:"actions-moon",label:"colorScheme.dark.label"}}}createRenderRoot(){return this}render(){const e=html`<span class="text-primary"><typo3-backend-icon identifier="actions-dot" size="small"></typo3-backend-icon></span>`,t=html`<typo3-backend-icon identifier="miscellaneous-placeholder" size="small"></typo3-backend-icon>`,o=[];for(const[l,r]of Object.entries(this.themes))o.push(html`
        <li>
