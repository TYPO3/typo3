...
//$LANG->includeLLFile('EXT:rtehtmlarea/locallang_rtehtmlarea_parse_html.php');
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/rtehtmlarea/rtehtmlarea_parse_html.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/rtehtmlarea/rtehtmlarea_parse_html.php']);
}
