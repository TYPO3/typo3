...
class StageChangeNotification implements LoggerAwareInterface
{
     ...
     * @param array $currentUser array of the be_users row
     */
    public function notifyStageChange(array $workspaceRecord, int $stageId, array $affectedElements, string $comment, array $recipients, array $currentUser): void
    {
