...
class Tx_Workspaces_Controller_PreviewController extends Tx_Workspaces_Controller_AbstractController {
	...
	public function indexAction() {
		...
		$wsSettingsUrl =   t3lib_div::getIndpEnv('TYPO3_SITE_URL') . 'typo3/' . $uriBuilder->uriFor('singleIndex', array(), $ctrl, 'workspaces', 'web_workspacesworkspaces') . '&tx_workspaces_web_workspacesworkspaces[controller]=Review';
	...
	public function initializeAction() {
		...
		$this->pageRenderer->addJsFile($this->backPath .
			'ajax.php?ajaxID=ExtDirect::getAPI&namespace=TYPO3.Workspaces',
			NULL,
			FALSE
		);
