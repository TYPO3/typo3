...
namespace TYPO3\CMS\Workspaces\Tests\Functional\Controller\Remote;
...
final class RemoteServerTest extends FunctionalTestCase
{
    ...
    public function getRowDetailsThrowsException(string $table, int $liveId, int $versionId, int $stage): void
    {
        ...
        $subject = $this->get(RemoteServer::class);

        $this->expectException(\RuntimeException::class);
        $this->expectExceptionCode(1756882012);
        $subject->getRowDetails($instruction, $request);
    }
}
