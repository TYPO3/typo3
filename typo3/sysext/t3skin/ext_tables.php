...
if (TYPO3_MODE == 'BE' || TYPO3_MODE == 'FE' && isset($GLOBALS['BE_USER'])) {
	...
	$TBE_STYLES['skinImg'] = array_merge($presetSkinImgs, array(
		...
		'MOD:integration_perm/perm.gif' => array($temp_eP . 'icons/module_integration_perm.png', 'width="24" height="24"'),
		'MOD:integration_ts/ts1.gif' => array($temp_eP . 'icons/module_integration_ts.gif', 'width="24" height="24"'),
