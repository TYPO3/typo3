...
class LogEntryRepositoryTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @var \TYPO3\CMS\Extbase\Persistence\Typo3QuerySettings
	 */
	private $querySettings = NULL;

	public function setUp() {
		$this->querySettings = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\QuerySettingsInterface');
		$this->objectManager = $this->getMock('TYPO3\\CMS\\Extbase\\Object\\ObjectManagerExceptionInterface');
		$this->objectManager->expects($this->any())->method('create')->with('TYPO3\\CMS\\Extbase\\Persistence\\QuerySettingsInterface')->will($this->returnValue($this->querySettings));
	}
