...
class LogEntryRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
	...
	public function initializeObject() {
		...
		/** @var $defaultQuerySettings \TYPO3\CMS\Extbase\Persistence\QuerySettingsInterface */
		$defaultQuerySettings = $this->objectManager->create('TYPO3\\CMS\\Extbase\\Persistence\\QuerySettingsInterface');
