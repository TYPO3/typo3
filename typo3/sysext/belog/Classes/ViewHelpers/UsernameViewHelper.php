...
class Tx_Belog_ViewHelpers_UsernameViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	...
	public function render($uid) {
		/** @var $userObject Tx_Belog_Domain_Model_BackendUser */
		$userObject = $this->backendUserRepository->findByUid($uid);

		if ($userObject instanceof Tx_Belog_Domain_Model_BackendUser) {
