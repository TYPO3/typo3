 ...
 * @subpackage belog
 */
class tx_belog_WebInfo_Boostrap {
	...
	public function main() {
		...
		$_GET['tx_belog_tools_beloglog']['controller'] = 'WebInfo';
			...
			/** @var $extbaseBoostrap Tx_Extbase_Core_Bootstrap */
		$extbaseBoostrap = t3lib_div::makeInstance('Tx_Extbase_Core_Bootstrap');
		$content = $extbaseBoostrap->run('', $configuration);
