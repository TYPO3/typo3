...
class Typo3Status implements \TYPO3\CMS\Reports\StatusProviderInterface {
	...
	protected function getTypo3VersionStatus() {
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Reports\\Report\\Status\\Status', 'TYPO3', TYPO3_version, '', \TYPO3\CMS\Reports\Report\Status\Status::NOTICE);
	}
	...
	protected function getOldXclassUsageStatus() {
		...
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Reports\\Report\\Status\\Status', $GLOBALS['LANG']->getLL('status_oldXclassUsage'), $value, $message, $severity);
	}
