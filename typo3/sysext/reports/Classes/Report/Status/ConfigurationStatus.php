...
class ConfigurationStatus implements \TYPO3\CMS\Reports\StatusProviderInterface {
	 ...
	 *
	 * @return \TYPO3\CMS\Reports\Report\Status\Status An tx_reports_reports_status_Status object representing whether the reference index is empty or not
	 */
	protected function getReferenceIndexStatus() {
		...
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Reports\\Report\\Status\\Status', $GLOBALS['LANG']->getLL('status_referenceIndex'), $value, $message, $severity);
	}

	/**
	 * Checks if PHP safe_mode is enabled.
	 *
	 * @return \TYPO3\CMS\Reports\Report\Status\Status A tx_reports_reports_status_Status object representing whether the safe_mode is enabled or not
	 */
	protected function getPhpSafeModeStatus() {
		...
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Reports\\Report\\Status\\Status', $GLOBALS['LANG']->getLL('status_PhpSafeMode'), $value, $message, $severity);
	}

	/**
	 * Checks if PHP magic_quotes_gpc is enabled.
	 *
	 * @return \TYPO3\CMS\Reports\Report\Status\Status A tx_reports_reports_status_Status object representing whether the magic_quote_gpc is enabled or not
	 */
	protected function getPhpMagicQuotesGpcStatus() {
		...
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Reports\\Report\\Status\\Status', $GLOBALS['LANG']->getLL('status_PhpMagicQuotesGpc'), $value, $message, $severity);
	}
	 ...
	 *
	 * @return \TYPO3\CMS\Reports\Report\Status\Status An tx_reports_reports_status_Status object representing whether TYPO3 can connect to the configured memcached servers
	 */
	protected function getMemcachedConnectionStatus() {
		...
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Reports\\Report\\Status\\Status', $GLOBALS['LANG']->getLL('status_memcachedConfiguration'), $value, $message, $severity);
	}
	 ...
	 *
	 * @return \TYPO3\CMS\Reports\Report\Status\Status The deprecation log status.
	 */
	protected function getDeprecationLogStatus() {
		...
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Reports\\Report\\Status\\Status', $title, $value, $message, $severity);
	}

	/**
	 * Warning, if fileCreateMask has write bit for 'others' set.
	 *
	 * @return \TYPO3\CMS\Reports\Report\Status\Status The writable status for 'others'
	 */
	protected function getCreatedFilesWorldWritableStatus() {
		...
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Reports\\Report\\Status\\Status', $GLOBALS['LANG']->getLL('status_CreatedFilePermissions'), $value, $message, $severity);
	}
	...
	protected function getCreatedDirectoriesWorldWritableStatus() {
		...
		return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Reports\\Report\\Status\\Status', $GLOBALS['LANG']->getLL('status_CreatedDirectoryPermissions'), $value, $message, $severity);
	}
