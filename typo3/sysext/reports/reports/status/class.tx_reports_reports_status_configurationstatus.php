...
class tx_reports_reports_status_ConfigurationStatus implements tx_reports_StatusProvider {
	 ...
	 * E.g. Removing the deprecation log file.
	 *
	 * @return void
	 */
			...
			case 'removeDeprecationLogFile':
				if (@unlink(t3lib_div::getDeprecationLogFileName())) {
					$flashMessage = t3lib_div::makeInstance(
						't3lib_FlashMessage',
						$GLOBALS['LANG']->getLL('status_configuration_DeprecationLogDeletedSuccessful'),
						'',
					...
					$flashMessage = t3lib_div::makeInstance(
						't3lib_FlashMessage',
						$GLOBALS['LANG']->getLL('status_configuration_DeprecationLogDeletionFailed'),
						'',
