	...
	function __construct() {
		...
		if (!$GLOBALS['TYPO3_CONF_VARS']['BE']['installToolPassword']) {
			$this->outputErrorAndExit(
				...
				You must enable it by setting a password in typo3conf/LocalConfiguration.php If you insert the line below, the password will be \'joh316\':<br /><br />
...
REMOTE_ADDR was '".t3lib_div::getIndpEnv('REMOTE_ADDR')."' (".t3lib_div::getIndpEnv('REMOTE_HOST').')';
	...
	function generateConfigForm($type='') {
		$default_config_content = t3lib_div::getUrl(PATH_t3lib . t3lib_Configuration::DEFAULT_CONFIGURATION_FILE);
	...
	protected function setLocalConfigurationValues(array $pathValuePairs) {
		...
		if (t3lib_Configuration::setLocalConfigurationValuesByPathValuePairs($pathValuePairs) === TRUE) {
