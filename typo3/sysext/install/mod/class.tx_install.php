				...
				foreach ($GLOBALS['TYPO3_CONF_VARS'] as $k => $va) {
					...
					foreach ($va as $vk => $value) {
						if (isset($GLOBALS['TYPO3_CONF_VARS_extensionAdded'][$k][$vk])) {
							...
							while (preg_match('/' . str_replace('/', '\/', $GLOBALS['TYPO3_CONF_VARS_extensionAdded'][$k][$vk]) . '$/', '', $potentialValue)) {
								$potentialValue = preg_replace('/' . str_replace('/', '\/', $GLOBALS['TYPO3_CONF_VARS_extensionAdded'][$k][$vk]) . '$/', '', $potentialValue);
							}
