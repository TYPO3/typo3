...
class ExtensionManagerTables extends \TYPO3\CMS\Install\Updates\AbstractUpdate {
	...
	protected function getUpdateStatements() {
		...
		$rawDefinitions = \TYPO3\CMS\Core\Utility\GeneralUtility::getUrl(\TYPO3\CMS\Core\Extension\ExtensionManager::extPath('extensionmanager') . '/ext_tables.sql');
	...
	public function performUpdate(array &$dbQueries, &$customMessages) {
		...
		$rawDefinitions = \TYPO3\CMS\Core\Utility\GeneralUtility::getUrl(\TYPO3\CMS\Core\Extension\ExtensionManager::extPath('extensionmanager') . 'ext_tables_static+adt.sql');
