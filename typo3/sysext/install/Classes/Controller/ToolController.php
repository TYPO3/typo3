			...
			if ($error !== NULL) {
				...
				if ($errorType & (E_ERROR | E_PARSE | E_CORE_ERROR | E_COMPILE_ERROR | E_USER_ERROR | E_RECOVERABLE_ERROR)) {
					...
					if (!headers_sent()) {
						...
						echo '
<p><strong>
	The system determined a serious problem during the last action. Please go to the <a href="' . $redirectLocation . '">extension check</a>,
	uninstall all incompatible extensions and try turn return to your last action.
</strong></p>';
					}
				}
			}
