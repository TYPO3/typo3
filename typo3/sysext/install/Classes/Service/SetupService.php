...
readonly class SetupService
{
    ...
    public function createSite(): array
    {
        ...
        $databaseConnectionForContent->insert(
            ...
            [
                ...
                'bodytext' => '<p>This website is made with <a href="https://typo3.org" target="_blank" rel="noreferrer">TYPO3</a>.</p>',
            ]
        );
    ...
    public function initializeDefaultThemeContent(string $pageId, $contentId): void
    {
        ...
        $connectionPool->getConnectionForTable('tt_content')->update(
            'tt_content',
            [
                'bodytext' => 'This website is made with <a href="https://typo3.org" target="_blank" rel="noreferrer">TYPO3</a>  and the Camino Theme.</p>',
            ],
            [
                'uid' => $contentId,
            ]
...
page.10.value (
   <div style="width: 800px; margin: 15% auto;">
      ...
      <div><p>This website is made with <a href="https://typo3.org" target="_blank" rel="noreferrer">TYPO3</a>.</p></div>
   </div>
)
',
