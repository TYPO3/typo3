...
class s{constructor(){typeof HTMLInputElement.prototype.clearable!="function"&&this.registerClearable()}static createCloseButton(t){const l=`
    ...
    `,e=document.createElement("button");return e.type="button",e.tabIndex=-1,e.title=t,e.ariaLabel=t,e.innerHTML=l,e.style.visibility="hidden",e.classList.add("close"),e}registerClearable(){HTMLInputElement.prototype.clearable=function(t={}){if(this.dataset.clearable)return;if(typeof t!="object")throw new Error("Passed options must be an object, "+typeof t+" given");this.classList.add("form-control-clearable");const l=document.createElement("div");l.classList.add("form-control-clearable-wrapper"),this.parentNode.insertBefore(l,this),l.appendChild(this);let e="Clear input";this.dataset.clearableLabel?e=this.dataset.clearableLabel:"lang"in top.TYPO3&&top.TYPO3.lang["labels.inputfield.clearButton.title"]&&(e=top.TYPO3.lang["labels.inputfield.clearButton.title"]);const n=s.createCloseButton(e),a=()=>{n.style.visibility=this.value.length===0?"hidden":"visible"};n.addEventListener("click",i=>{i.preventDefault(),this.value="",typeof t.onClear=="function"&&t.onClear(this),this.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0})),a()}),l.appendChild(n),this.addEventListener("focus",a),this.addEventListener("keyup",a),a(),this.dataset.clearable="true"}}}var c=new s;export{c as default};
