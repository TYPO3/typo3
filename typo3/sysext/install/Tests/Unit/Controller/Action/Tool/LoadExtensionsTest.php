...
class LoadExtensionsTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	public function checkLoadedExtensionsReturnsJsonStringOkIfAllIsWell() {
		$loadExtensionsMock = $this->getAccessibleMock('TYPO3\\CMS\\Install\\Controller\\Action\\Tool\\LoadExtensions', array('getExtensionsToLoad', 'loadExtensions', 'deleteProtocolFile'), array());
	...
	public function checkLoadedExtensionsCallsGetExtensionsToLoad() {
		$loadExtensionsMock = $this->getAccessibleMock('TYPO3\\CMS\\Install\\Controller\\Action\\Tool\\LoadExtensions', array('getExtensionsToLoad', 'deleteProtocolFile', 'loadExtensions'), array());
