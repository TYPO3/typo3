...
final class PasswordSetCommandTest extends FunctionalTestCase
{
    ...
    {
        parent::setUp();
        $this->originalSettings = file_get_contents(Environment::getConfigPath() . '/system/settings.php');
    }

    protected function tearDown(): void
    {
        file_put_contents(Environment::getConfigPath() . '/system/settings.php', $this->originalSettings);
        parent::tearDown();
    }
    ...
    public function canRunDry(): void
    {
        ...
        $settingsPath = Environment::getConfigPath() . '/system/settings.php';
