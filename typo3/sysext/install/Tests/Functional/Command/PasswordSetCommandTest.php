...
final class PasswordSetCommandTest extends FunctionalTestCase
{
    ...
    {
        parent::setUp();
        $this->originalSettings = file_get_contents($this->getInstancePath() . '/typo3conf/system/settings.php');
    }

    protected function tearDown(): void
    {
        file_put_contents($this->getInstancePath() . '/typo3conf/system/settings.php', $this->originalSettings);
        parent::tearDown();
    }
    ...
    public function canRunDry(): void
    {
        ...
        $settingsPath = $this->getInstancePath() . '/typo3conf/system/settings.php';
