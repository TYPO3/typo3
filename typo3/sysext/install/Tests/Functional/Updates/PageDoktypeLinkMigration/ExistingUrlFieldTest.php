...
namespace TYPO3\CMS\Install\Tests\Functional\Updates\PageDoktypeLinkMigration;

use PHPUnit\Framework\Attributes\Test;
use TYPO3\CMS\Install\Updates\PageDoktypeLinkMigration;
...
final class ExistingUrlFieldTest extends FunctionalTestCase
{
    ...
    protected array $testExtensionsToLoad = [
        'typo3/sysext/install/Tests/Functional/Fixtures/Extensions/test_pagelinkmigration_existingurlfield',
    ];
