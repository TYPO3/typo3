...
namespace TYPO3\CMS\IndexedSearch\Upgrades;
...
/**
 * @since 13.0
 * @internal This class is only meant to be used within `EXT:indexed_search` and is not part of the TYPO3 Core API.
 */
