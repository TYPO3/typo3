...
class SearchFormController extends \TYPO3\CMS\Frontend\Plugin\AbstractPlugin {
	...
	public function makeSearchForm($optValues) {
		...
		if ($this->conf['show.']['advancedSearchLink']) {
			$linkToOtherMode = $this->piVars['ext'] ? $this->pi_getPageLink($GLOBALS['TSFE']->id, $GLOBALS['TSFE']->sPre, array($this->prefixId . '[ext]' => 0)) : $this->pi_getPageLink($GLOBALS['TSFE']->id, $GLOBALS['TSFE']->sPre);
