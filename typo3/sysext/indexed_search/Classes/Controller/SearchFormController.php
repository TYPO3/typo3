		...
		if ($pageCount > 1) {
			...
			if ($pointer > 0) {
				...
				$markerArray['###PREVIOUS###'] = $this->cObj->stdWrap(
					$this->makePointerSelector_link($this->pi_getLL('pi_list_browseresults_prev', '< Previous', 1), ($pointer - 1), $freeIndexUid),
			...
			if ($pointer + 1 < $pageCount) {
				$markerArray['###NEXT###'] = $this->cObj->stdWrap(
					$this->makePointerSelector_link($this->pi_getLL('pi_list_browseresults_next', 'Next >', 1), ($pointer + 1), $freeIndexUid),
