				...
				case 'enctype':
					formItems.push({
						...
						store: new Ext.data.JsonStore({
							fields: ['label', 'value'],
							data: [
								{label: TYPO3.l10n.localize('attributes_enctype_')1, value: 'application/x-www-form-urlencoded'},
								{label: TYPO3.l10n.localize('attributes_enctype_')2, value: 'multipart/form-data'},
								{label: TYPO3.l10n.localize('attributes_enctype_')3, value: 'text/plain'}
							]
						}),
						listeners: {
							'select': {
