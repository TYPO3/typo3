...
class FilePersistenceSlot implements SingletonInterface
{
     ...
     */
    public function onPreFileCreate(string $fileName, FolderInterface $targetFolder)
    {
     ...
     * @param string $targetFileName
     */
    public function onPreFileRename(FileInterface $file, string $targetFileName)
    {
        $combinedFileIdentifier = $this->buildCombinedIdentifier(
     ...
     */
    public function onPreFileReplace(FileInterface $file, string $localFilePath)
    {
        $combinedFileIdentifier = $this->buildCombinedIdentifier(
            $file->getParentFolder(),
            $file->getName()
     ...
     * @param mixed $content
     */
    public function onPreFileSetContents(FileInterface $file, $content = null)
    {
        $combinedFileIdentifier = $this->buildCombinedIdentifier(
            $file->getParentFolder(),
            $file->getName()
