...
class tx_form_Domain_Factory_Typoscript implements t3lib_Singleton {
	 ...
	 *
	 * @param tx_form_Domain_Model_Element_Container $parentElement Parent model object
	 * @param array $arguments Configuration array
	 * @throws Exception
	 * @return void
	 */
	public function getChildElementsByIntegerKey(tx_form_Domain_Model_Element_Container $parentElement, array $typoscript) {
	 ...
	 *
	 * @param tx_form_Domain_Model_Element_Container $parentElement The parent for the new element
	 * @param string $class Classname for the element
	 * @param array $arguments Configuration array
	 * @return void
	 */
	public function setElementType(tx_form_Domain_Model_Element_Container $parentElement, $class, array $arguments) {
		if (substr($class, 0, 1) == '<') {
	 ...
	 * @return object
	 */
	public function addElement(tx_form_Domain_Model_Element_Container $parentElement, $class, array $arguments = array()) {
