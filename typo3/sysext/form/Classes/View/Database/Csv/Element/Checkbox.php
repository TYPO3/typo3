 ...
 * @subpackage form
 */
class tx_form_View_Database_Csv_Element_Checkbox extends tx_form_View_Database_Csv_Element_Abstract {
	 ...
	 */
	public function __construct(tx_form_Domain_Model_Element_Checkbox $model, $delimiter) {
