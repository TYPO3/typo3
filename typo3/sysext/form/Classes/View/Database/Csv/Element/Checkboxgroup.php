 ...
 * @subpackage form
 */
class tx_form_View_Database_Csv_Element_Checkboxgroup extends tx_form_View_Database_Csv_Element_Container {
	 ...
	 */
	public function __construct(tx_form_Domain_Model_Element_Checkboxgroup $model, $delimiter) {
