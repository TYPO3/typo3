 ...
 * @subpackage form
 */
class tx_form_View_Database_Csv_Element_Fileupload extends tx_form_View_Database_Csv_Element_Container {
	/**
	 ...
	 */
	public function __construct(tx_form_Domain_Model_Element_Fileupload $model, $delimiter) {
