 ...
 * @subpackage form
 */
class tx_form_View_Database_Csv_Element_Textline extends tx_form_View_Database_Csv_Element_Abstract {
	 ...
	 */
	public function __construct(tx_form_Domain_Model_Element_Textline $model, $delimiter) {
