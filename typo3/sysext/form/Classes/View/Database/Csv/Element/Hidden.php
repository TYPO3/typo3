 ...
 * @subpackage form
 */
class tx_form_View_Database_Csv_Element_Hidden extends tx_form_View_Database_Csv_Element_Abstract {
	 ...
	 */
	public function __construct(tx_form_Domain_Model_Element_Hidden $model, $delimiter) {
