...
class tx_form_System_Validate_IntegerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function setUp() {
		...
		$this->fixture = new tx_form_System_Validate_Integer();
	}
	...
	public function validIntegerProvider() {
		return array(
			'12 for de locale'    => array(array(12, 'de'), TRUE),
			'1.200 for de locale' => array(array('1.200', 'de'), TRUE)
		);
	}

	public function invalidIntegerProvider() {
		return array(
			'12.1 for en_US locale' => array(array(12.1, 'en_US'), FALSE),
			'12,1 for de_DE locale' => array(array('12,1', 'de_DE'), FALSE)
		);
	}
