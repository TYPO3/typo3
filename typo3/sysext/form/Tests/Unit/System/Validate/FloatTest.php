...
/**
 * Test case for class tx_form_System_Validate_Float.
 *
 * @author Andreas Lappe <a.lappe@kuehlhaus.com>
 * @package TYPO3
 * @subpackage form
 */
class tx_form_System_Validate_FloatTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	/**
	 * @var tx_form_System_Validate_Float
	 */
	protected $fixture;

	public function setUp() {
		$this->helper = new tx_form_System_Validate_Helper();
		$this->fixture = new tx_form_System_Validate_Float();
	}
	...
	public function validFloatProvider() {
		return array(
			'12.1 for en_US locale' => array(array(12.1, 'en_US'), TRUE),
			'12,1 for de_DE locale' => array(array('12,1', 'de_DE'), TRUE)
		);
	}

	public function invalidFloatProbider() {
		return array(
			'12 for de locale' => array(array(12, 'de'), FALSE)
		);
	}
