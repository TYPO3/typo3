...
class tx_form_System_Validate_FileminimumsizeTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function setUp() {
		...
		$this->fixture = new tx_form_System_Validate_Fileminimumsize();
	}
	...
	public function validSizesProvider() {
		return array(
			'12B for min. 11B' => array(array(11, 12), TRUE),
			'12B for min. 12B' => array(array(12, 12), TRUE)
		);
	}

	public function invalidSizesProvider() {
		return array(
			'11B for min. 12B' => array(array(12, 11), FALSE)
		);
	}
