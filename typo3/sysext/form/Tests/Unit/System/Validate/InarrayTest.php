...
class tx_form_System_Validate_InarrayTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function arrayProvider() {
		return array(
				// array(arrayWithContent, contentToFind)
			array(array(array(12, 13), 12), TRUE),
			array(array(array(11, 13), 12), FALSE),
		);
	}
	 ...
	 * @dataProvider arrayProvider
	 */
	public function isValidReturnsExpectedValueWithStrictComparison($input, $expected) {
		$this->fixture->setFieldName('myfield');
