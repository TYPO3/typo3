...
class tx_form_System_Validate_InarrayTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function setUp() {
		...
		$this->fixture = new tx_form_System_Validate_Inarray();
	}
	...
	public function validArrayProvider() {
		return array(
			'12 in (12, 13)' => array(array(array(12, 13), 12), TRUE)
		);
	}

	public function invalidArrayProvider() {
		return array(
			'12 in (11, 13)' => array(array(array(11, 13), 12), FALSE),
		);
	}
	 ...
	 * @dataProvider validArrayProvider
	 */
	public function isValidForValidInputWithStrictComparisonReturnsTrue($input, $expected) {
		$this->fixture->setFieldName('myfield');
		$this->fixture->setArray($input[0]);
	 ...
	 * @dataProvider invalidArrayProvider
	 */
	public function isValidForInvalidInputWithStrictComparisonReturnsFalse($input, $expected) {
		$this->fixture->setFieldName('myfield');
		$this->fixture->setArray($input[0]);
		$this->fixture->setStrict(TRUE);
		$requestHandlerMock = $this->helper->getRequestHandler(array(
