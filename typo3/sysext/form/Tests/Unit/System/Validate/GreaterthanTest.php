...
class tx_form_System_Validate_GreaterthanTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function setUp() {
		...
		$this->fixture = new tx_form_System_Validate_Greaterthan();
	}
	...
	public function validNumberProvider() {
		return array(
			'13 > 12' => array(array(12, 13), TRUE),
		);
	}

	public function invalidNumberProvider() {
		return array(
			'12.1 > 12'  => array(array(12, 12.1), FALSE),
			'12 > 12'    => array(array(12, 12), FALSE),
			'11.99 > 12' => array(array(12, 11.99), FALSE)
		);
	}
