...
class tx_form_System_Validate_EqualsTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function setUp() {
		...
		$this->fixture = new tx_form_System_Validate_Equals();
	}
	...
	public function validPairProvider() {
		return array(
			'something === something' => array(array('something', 'something'), TRUE),
			'3 === 3'                 => array(array(3, 3), TRUE)
		);
	}

	public function invalidPairProvider() {
		return array(
			'somethingElse !== something' => array(array('somethingElse', 'something'), FALSE),
			'4 !== 3'                     => array(array(4, 3), FALSE)
		);
	}
