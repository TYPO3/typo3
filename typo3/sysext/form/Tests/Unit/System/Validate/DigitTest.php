...
/**
 * Test case for class tx_form_System_Validate_Digit.
 *
 * @author Andreas Lappe <a.lappe@kuehlhaus.com>
 * @package TYPO3
 * @subpackage form
 */
class tx_form_System_Validate_DigitTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	/**
	 * @var tx_form_System_Validate_Digit
	 */
	protected $fixture;

	public function setUp() {
		$this->helper = new tx_form_System_Validate_Helper();
		$this->fixture = new tx_form_System_Validate_Digit();
	}
	...
	public function validDigitProvider() {
		return array(
			'stringified integer'                    => array('2012', TRUE),
			'stringified integer with leading zeros' => array('0002', TRUE),
		);
	}

	public function invalidDigitProvider() {
		return array(
			'stringified float'      => array('0.2012', FALSE),
			'stringified scientific' => array('1.9E+11', FALSE)
		);
	}
