...
class tx_form_System_Validate_FileallowedtypesTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function validTypesProvider() {
		return array(
			'pdf in (pdf)'       => array(array('application/pdf', 'application/pdf'), TRUE),
			'pdf in (pdf, json)' => array(array('application/pdf, application/json', 'application/pdf'), TRUE)

		);
	}
	public function invalidTypesProvider() {
		return array(
			'xml in (pdf, json)' => array(array('application/pdf, application/json', 'application/xml'), FALSE),
			'xml in (pdf)'       => array(array('application/pdf, application/json', 'application/xml'), FALSE)
		);
	}
