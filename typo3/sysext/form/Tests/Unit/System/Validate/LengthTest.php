...
class tx_form_System_Validate_LengthTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function lengthProvider() {
		return array(
				// array(min, max, myString)
			array(array(4, 8, 'myString'), TRUE),
			array(array(8, 8, 'myString'), TRUE),
			array(array(4, NULL, 'myString'), TRUE),
			array(array(4, 4, 'asdf'), TRUE),
			array(array(4, 4, 'äüöß'), TRUE),
			array(array(4, 4, 'øüß¬'), TRUE),

			array(array(4, 12, 'my'), FALSE),
			array(array(4, 12, 'my long string'), FALSE),
		);
	}
