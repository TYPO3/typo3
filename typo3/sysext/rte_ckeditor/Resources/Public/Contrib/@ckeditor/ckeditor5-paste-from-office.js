 ...
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
const C=/<google-sheets-html-origin/i;class w{constructor(e){this.document=e}isActive(e){return C.test(e)}execute(e){const t=new n(this.document),{body:r}=e._parsedData;!
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
