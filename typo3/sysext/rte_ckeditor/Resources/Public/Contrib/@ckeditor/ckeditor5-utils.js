 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */const k=new Array(256).fill("").map(((t,e)=>("0"+e.toString(16)).slice(-2)));function A(){const t=4294967296*Math.random()>>>0,e=4294967296*Math.random()>>>0,n=4294967296*Math.random()>>>0,o=4294967296*Math.random()>>>0;return"e"+k[255&t]+k[t>>8&255]+k[t>>16&255]+k[t>>24&255]+k[255&e]+k[e>>8&255]+k[e>>16&255]+k[e>>24&255]+k[255&n]+k[n>>8&255]+k[n>>16&255]+k[n>>24&255]+k[255&o]+k[o>>8&255]+k[o>>16&255]+k[o>>24&255]}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */const O={get(t="normal"){return"number"!=typeof t?this[t]||this.normal:t},highest:1e5,high:1e3,normal:0,low:-1e3,lowest:-1e5};
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function M(t,e){const n=O.get(e.priority);for(let o=0;o<t.length;o++)if(O.get(t[o].priority)<n)return void t.splice(o,0,e);t.push(e)}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */const C="https://ckeditor.com/docs/ckeditor5/latest/support/error-codes.html";class N extends Error{constructor(t,e,n){super(function(t,e){const n=new WeakSet,o=(t,e)=>{if("object"==typeof e&&null!==e){if(n.has(e))return`[object ${e.constructor.name}]`;n.add(e)}return e},r=e?` ${JSON.stringify(e,o)}`:"",i=D(t);return t+r+i}(t,n)),this.name="CKEditorError",this.context=e,this.data=n}is(t){return"CKEditorError"===t}static rethrowUnexpectedError(t,e){if(t.is&&t.is("CKEditorError"))throw t;const n=new N(t.message,e);throw n.stack=t.stack,n}}function S(t,e){console.warn(...j(t,e))}function R(t,e){console.error(...j(t,e))}function D(t){return`\nRead more: ${C}#error-${t}`}function j(t,e){const n=D(t);return e?[t,e,n]:[t,n]}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */const P="43.0.0",B=new Date(2024,7,7);
/* istanbul ignore next -- @preserve */
if(globalThis.CKEDITOR_VERSION)throw new N("ckeditor-duplicated-modules",null);
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */globalThis.CKEDITOR_VERSION=P;const F=Symbol("listeningTo"),V=Symbol("emitterId"),W=Symbol("delegations"),H=K(Object);function K(t){if(!t)return H;return class extends t{on(t,e,n){this.listenTo(this,t,e,n)}once(t,e,n){let o=!1;this.listenTo(this,t,((t,...n)=>{o||(o=!0,t.off(),e.call(this,t,...n))}),n)}off(t,e){this.stopListening(this,t,e)}listenTo(t,e,n,o={}){let r,i;this[F]||(this[F]={});const s=this[F];q(t)||U(t);const l=q(t);(r=s[l])||(r=s[l]={emitter:t,callbacks:{}}),(i=r.callbacks[e])||(i=r.callbacks[e]=[]),i.push(n),function(t,e,n,o,r){e._addEventListener?e._addEventListener(n,o,r):t._addEventListener.call(e,n,o,r)}(this,t,e,n,o)}stopListening(t,e,n){const o=this[F];let r=t&&q(t);const i=o&&r?o[r]:void 0,s=i&&e?i.callbacks[e]:void 0;if(!(!o||t&&!i||e&&!s))if(n){X(this,t,e,n);-1!==s.indexOf(n)&&(1===s.length?delete i.callbacks[e]:X(this,t,e,n))}else if(s){for(;n=s.pop();)X(this,t,e,n);delete i.callbacks[e]}else if(i){for(e in i.callbacks)this.stopListening(t,e);delete o[r]}else{for(r in o)this.stopListening(o[r].emitter);delete this[F]}}fire(t,...e){try{const n=t instanceof L?t:new L(this,t),o=n.name;let r=z(this,o);if(n.path.push(this),r){const t=[n,...e];r=Array.from(r);for(let e=0;e<r.length&&(r[e].callback.apply(this,t),n.off.called&&(delete n.off.called,this._removeEventListener(o,r[e].callback)),!n.stop.called);e++);}const i=this[W];if(i){const t=i.get(o),r=i.get("*");t&&G(t,n,e),r&&G(r,n,e)}return n.return}catch(t){
/* istanbul ignore next -- @preserve */
N.rethrowUnexpectedError(t,this)}}delegate(...t){return{to:(e,n)=>{this[W]||(this[W]=new Map),t.forEach((t=>{const o=this[W].get(t);o?o.set(e,n):this[W].set(t,new Map([[e,n]]))}))}}}stopDelegating(t,e){if(this[W])if(t)if(e){const n=this[W].get(t);n&&n.delete(e)}else this[W].delete(t);else this[W].clear()}_addEventListener(t,e,n){!function(t,e){const n=Y(t);if(n[e])return;let o=e,r=null;const i=[];for(;""!==o&&!n[o];)n[o]={callbacks:[],childEvents:[]},i.push(n[o]),r&&n[o].childEvents.push(r),r=o,o=o.substr(0,o.lastIndexOf(":"));if(""!==o){for(const t of i)t.callbacks=n[o].callbacks.slice();n[o].childEvents.push(r)}}(this,t);const o=$(this,t),r={callback:e,priority:O.get(n.priority)};for(const t of o)M(t,r)}_removeEventListener(t,e){const n=$(this,t);for(const t of n)for(let n=0;n<t.length;n++)t[n].callback==e&&(t.splice(n,1),n--)}}}function U(t,e){t[V]||(t[V]=e||A())}function q(t){return t[V]}function Y(t){return t._events||Object.defineProperty(t,"_events",{value:{}}),t._events}function $(t,e){const n=Y(t)[e];if(!n)return[];let o=[n.callbacks];for(let e=0;e<n.childEvents.length;e++){const r=$(t,n.childEvents[e]);o=o.concat(r)}return o}function z(t,e){let n;return t._events&&(n=t._events[e])&&n.callbacks.length?n.callbacks:e.indexOf(":")>-1?z(t,e.substr(0,e.lastIndexOf(":"))):null}function G(t,e,n){for(let[o,r]of t){r?"function"==typeof r&&(r=r(e.name)):r=e.name;const t=new L(e.source,r);t.path=[...e.path],o.fire(t,...n)}}function X(t,e,n,o){e._removeEventListener?e._removeEventListener(n,o):t._removeEventListener.call(e,n,o)}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Ot(t){return"[object Range]"==Object.prototype.toString.apply(t)}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Ut(t){return!!(t&&t.getClientRects&&t.getClientRects().length)}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function qt({element:t,target:e,positions:n,limiter:o,fitInViewport:r,viewportOffsetConfig:s}){i(e)&&(e=e()),i(o)&&(o=o());const l=Mt(t),a=function(t){t=Object.assign({top:0,bottom:0,left:0,right:0},t);const e=new Nt(c.window);return e.top+=t.top,e.height-=t.top,e.bottom-=t.bottom,e.height-=t.bottom,e}(s),u=new Nt(t),h=Yt(e,a);let f;if(!h||!a.getIntersection(h))return null;const d={targetRect:h,elementRect:u,positionedElementAncestor:l,viewportRect:a};if(o||r){if(o){const t=Yt(o,a);t&&(d.limiterRect=t)}f=function(t,e){const{elementRect:n}=e,o=n.getArea(),r=t.map((t=>new $t(t,e))).filter((t=>!!t.name));let i=0,s=null;for(const t of r){const{limiterIntersectionArea:e,viewportIntersectionArea:n}=t;if(e===o)return t;const r=n**2+e**2;r>i&&(i=r,s=t)}return s}(n,d)}else f=new $t(n[0],d);return f}function Yt(t,e){const n=new Nt(t).getVisible();return n?n.getIntersection(e):null}Pt._observerInstance=null,Pt._elementCallbacks=null;class $t{constructor(t,e){const n=t(e.targetRect,e.elementRect,e.viewportRect,e.limiterRect);if(!n)return;const{left:o,top:r,name:i,config:s}=n;this.name=i,this.config=s,this._positioningFunctionCoordinates={left:o,top:r},this._options=e}get left(){return this._absoluteRect.left}get top(){return this._absoluteRect.top}get limiterIntersectionArea(){const t=this._options.limiterRect;return t?t.getIntersectionArea(this._rect):0}get viewportIntersectionArea(){return this._options.viewportRect.getIntersectionArea(this._rect)}get _rect(){return this._cachedRect||(this._cachedRect=this._options.elementRect.clone().moveTo(this._positioningFunctionCoordinates.left,this._positioningFunctionCoordinates.top)),this._cachedRect}get _absoluteRect(){return this._cachedAbsoluteRect||(this._cachedAbsoluteRect=this._rect.toAbsoluteRect()),this._cachedAbsoluteRect}}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Gt({target:t,viewportOffset:e=0,ancestorOffset:n=0,alignToTop:o,forceScroll:r}){const i=oe(t);let s=i,l=null;for(e=function(t){if("number"==typeof t)return{top:t,bottom:t,left:t,right:t};return t}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */(e);s;){let c;c=re(s==i?t:l),Qt({parent:c,getRect:()=>ie(t,s),alignToTop:o,ancestorOffset:n,forceScroll:r});const a=ie(t,s);if(Jt({window:s,rect:a,viewportOffset:e,alignToTop:o,forceScroll:r}),s.parent!=s){if(l=s.frameElement,s=s.parent,!l)return}else s=null}}function Xt(t,e,n){Qt({parent:re(t),getRect:()=>new Nt(t),ancestorOffset:e,limiterElement:n})}function Jt({window:t,rect:e,alignToTop:n,forceScroll:o,viewportOffset:r}){const i=e.clone().moveBy(0,r.bottom),s=e.clone().moveBy(0,-r.top),l=new Nt(t).excludeScrollbarsAndBorders(),c=n&&o,a=[s,i].every((t=>l.contains(t)));let{scrollX:u,scrollY:h}=t;const f=u,d=h;c?h-=l.top-e.top+r.top:a||(te(s,l)?h-=l.top-e.top+r.top:Zt(i,l)&&(h+=n?e.top-l.top-r.top:e.bottom-l.bottom+r.bottom)),a||(ee(e,l)?u-=l.left-e.left+r.left:ne(e,l)&&(u+=e.right-l.right+r.right)),u==f&&h===d||t.scrollTo(u,h)}function Qt({parent:t,getRect:e,alignToTop:n,forceScroll:o,ancestorOffset:r=0,limiterElement:i}){const s=oe(t),l=n&&o;let c,a,u;const h=i||s.document.body;for(;t!=h;)a=e(),c=new Nt(t).excludeScrollbarsAndBorders(),u=c.contains(a),l?t.scrollTop-=c.top-a.top+r:u||(te(a,c)?t.scrollTop-=c.top-a.top+r:Zt(a,c)&&(t.scrollTop+=n?a.top-c.top-r:a.bottom-c.bottom+r)),u||(ee(a,c)?t.scrollLeft-=c.left-a.left+r:ne(a,c)&&(t.scrollLeft+=a.right-c.right+r)),t=t.parentNode}function Zt(t,e){return t.bottom>e.bottom}function te(t,e){return t.top<e.top}function ee(t,e){return t.left<e.left}function ne(t,e){return t.right>e.right}function oe(t){return Ot(t)?t.startContainer.ownerDocument.defaultView:t.ownerDocument.defaultView}function re(t){if(Ot(t)){let e=t.commonAncestorContainer;return At(e)&&(e=e.parentNode),e}return t.parentNode}function ie(t,e){const n=oe(t),o=new Nt(t);if(n===e)return o;{let t=n;for(;t!=e;){const e=t.frameElement,n=new Nt(e).excludeScrollbarsAndBorders();o.moveBy(n.left,n.top),t=t.parent}}return o}const se={ctrl:"⌃",cmd:"⌘",alt:"⌥",shift:"⇧"},le={ctrl:"Ctrl+",alt:"Alt+",shift:"Shift+"},ce={37:"←",38:"↑",39:"→",40:"↓",9:"⇥",33:"Page Up",34:"Page Down"},ae=be(),ue=Object.fromEntries(Object.entries(ae).map((([t,e])=>{let n;return n=e in ce?ce[e]:t.charAt(0).toUpperCase()+t.slice(1),[e,n]})));function he(t){let e;if("string"==typeof t){if(e=ae[t.toLowerCase()],!e)throw new N("keyboard-unknown-key",null,{key:t})}else e=t.keyCode+(t.altKey?ae.alt:0)+(t.ctrlKey?ae.ctrl:0)+(t.shiftKey?ae.shift:0)+(t.metaKey?ae.cmd:0);return e}function fe(t){return"string"==typeof t&&(t=function(t){return t.split("+").map((t=>t.trim()))}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */(t)),t.map((t=>"string"==typeof t?function(t){if(t.endsWith("!"))return he(t.slice(0,-1));const e=he(t);return(h.isMac||h.isiOS)&&e==ae.ctrl?ae.cmd:e}(t):t)).reduce(((t,e)=>e+t),0)}function de(t){let e=fe(t);return Object.entries(h.isMac||h.isiOS?se:le).reduce(((t,[n,o])=>(e&ae[n]&&(e&=~ae[n],t+=o),t)),"")+(e?ue[e]:"")}function pe(t){return t==ae.arrowright||t==ae.arrowleft||t==ae.arrowup||t==ae.arrowdown}function ge(t,e){const n="ltr"===e;switch(t){case ae.arrowleft:return n?"left":"right";case ae.arrowright:return n?"right":"left";case ae.arrowup:return"up";case ae.arrowdown:return"down"}}function me(t,e){const n=ge(t,e);return"down"===n||"right"===n}function be(){const t={pageup:33,pagedown:34,arrowleft:37,arrowup:38,arrowright:39,arrowdown:40,backspace:8,delete:46,enter:13,space:32,esc:27,tab:9,ctrl:1114112,shift:2228224,alt:4456448,cmd:8912896};for(let e=65;e<=90;e++){t[String.fromCharCode(e).toLowerCase()]=e}for(let e=48;e<=57;e++)t[e-48]=e;for(let e=112;e<=123;e++)t["f"+(e-111)]=e;return Object.assign(t,{"'":222,",":108,"-":109,".":110,"/":111,";":186,"=":187,"[":219,"\\":220,"]":221,"`":223}),t}const _e=["ar","ara","dv","div","fa","per","fas","he","heb","ku","kur","ug","uig"];function we(t){return _e.includes(t)?"rtl":"ltr"}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */class Ie extends(vt(ot())){constructor(){super(),this._elements=new Set,this._nextEventLoopTimeout=null,this.set("isFocused",!1),this.set("focusedElement",null)}add(t){if(this._elements.has(t))throw new N("focustracker-add-element-already-exist",this);this.listenTo(t,"focus",(()=>this._focus(t)),{useCapture:!0}),this.listenTo(t,"blur",(()=>this._blur()),{useCapture:!0}),this._elements.add(t)}remove(t){t===this.focusedElement&&this._blur(),this._elements.has(t)&&(this.stopListening(t),this._elements.delete(t))}destroy(){this.stopListening()}_focus(t){clearTimeout(this._nextEventLoopTimeout),this.focusedElement=t,this.isFocused=!0}_blur(){clearTimeout(this._nextEventLoopTimeout),this._nextEventLoopTimeout=setTimeout((()=>{this.focusedElement=null,this.isFocused=!1}),0)}}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */class Le{constructor(){this._listener=new(vt())}listenTo(t){this._listener.listenTo(t,"keydown",((t,e)=>{this._listener.fire("_keydown:"+he(e),e)}))}set(t,e,n={}){const o=fe(t),r=n.priority;this._listener.listenTo(this._listener,"_keydown:"+o,((t,o)=>{n.filter&&!n.filter(o)||(e(o,(()=>{o.preventDefault(),o.stopPropagation(),t.stop()})),t.return=!0)}),{priority:r})}press(t){return!!this._listener.fire("_keydown:"+he(t),t)}stopListening(t){this._listener.stopListening(t)}destroy(){this.stopListening()}}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
 ...
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
function ke(t){return dt(t)?new Map(t):function(t){const e=new Map;for(const n in t)e.set(n,t[n]);return e}(t)}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */async function Oe(t,e={}){const{maxAttempts:n=4,retryDelay:o=Me(),signal:r=(new AbortController).signal}=e;r.throwIfAborted();for(let e=0;;e++){try{return await t()}catch(t){if(e+1>=n)throw t}await Ae(o(e),{signal:r})}}function Me(t={}){const{delay:e=1e3,factor:n=2,maxDelay:o=1e4}=t;return t=>Math.min(n**t*e,o)}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Ce(t,e,n,o){if(Math.max(e.length,t.length)>1e4)return t.slice(0,n).concat(e).concat(t.slice(n+o,t.length));{const r=Array.from(t);return r.splice(n,o,...e),r}}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Ne(t,e){let n;function o(...r){o.cancel(),n=setTimeout((()=>t(...r)),e)}return o.cancel=()=>{clearTimeout(n)},o}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Se(t){function e(t){return t.length>=40&&t.length<=255?"VALID":"INVALID"}if(!t)return"INVALID";let n="";try{n=atob(t)}catch(t){return"INVALID"}const o=n.split("-"),r=o[0],i=o[1];if(!i)return e(t);try{atob(i)}catch(n){try{if(atob(r),!atob(r).length)return e(t)}catch(n){return e(t)}}if(r.length<40||r.length>255)return"INVALID";let s="";try{atob(r),s=atob(i)}catch(t){return"INVALID"}if(8!==s.length)return"INVALID";const l=Number(s.substring(0,4)),c=Number(s.substring(4,6))-1,a=Number(s.substring(6,8)),u=new Date(l,c,a);return u<B||isNaN(Number(u))?"INVALID":"VALID"}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Re(t){return!!t&&1==t.length&&/[\u0300-\u036f\u1ab0-\u1aff\u1dc0-\u1dff\u20d0-\u20ff\ufe20-\ufe2f]/.test(t)}function De(t){return!!t&&1==t.length&&/[\ud800-\udbff]/.test(t)}function je(t){return!!t&&1==t.length&&/[\udc00-\udfff]/.test(t)}function Pe(t,e){return De(t.charAt(e-1))&&je(t.charAt(e))}function Be(t,e){return Re(t.charAt(e))}const Fe=We();function Ve(t,e){const n=String(t).matchAll(Fe);return Array.from(n).some((t=>t.index<e&&e<t.index+t[0].length))}function We(){const t=/\p{Regional_Indicator}{2}/u.source,e="(?:"+[/\p{Emoji}[\u{E0020}-\u{E007E}]+\u{E007F}/u,/\p{Emoji}\u{FE0F}?\u{20E3}/u,/\p{Emoji}\u{FE0F}/u,/(?=\p{General_Category=Other_Symbol})\p{Emoji}\p{Emoji_Modifier}*/u].map((t=>t.source)).join("|")+")";return new RegExp(`${t}|${e}(?:‍${e})*`,"ug")}export{N as CKEditorError,Te as Collection,gt as Config,vt as DomEmitterMixin,at as ElementReplacer,K as EmitterMixin,L as EventInfo,Ie as FocusTracker,Le as KeystrokeHandler,Ee as Locale,ot as ObservableMixin,Nt as Rect,Pt as ResizeObserver,ut as abortableDebounce,ft as compareArrays,ht as count,pt as createElement,Ne as delay,T as diff,x as diffToChanges,h as env,Me as exponentialDelay,y as fastDiff,xt as findClosestScrollableAncestor,xe as first,It as getAncestors,kt as getBorderWidths,he as getCode,Lt as getDataFromElement,de as getEnvKeystrokeText,we as getLanguageDirection,ge as getLocalizedArrowKeyCodeDirection,qt as getOptimalPosition,c as global,Vt as indexOf,Wt as insertAt,M as insertToPriorityArray,pe as isArrowKeyCode,Re as isCombiningMark,Ht as isComment,me as isForwardArrowKeyCode,De as isHighSurrogateHalf,Be as isInsideCombinedSymbol,Ve as isInsideEmojiSequence,Pe as isInsideSurrogatePair,dt as isIterable,je as isLowSurrogateHalf,_t as isNode,Ot as isRange,At as isText,Kt as isValidAttributeName,Ut as isVisible,ae as keyCodes,R as logError,S as logWarning,I as mix,fe as parseKeystroke,O as priorities,B as releaseDate,zt as remove,Oe as retry,Xt as scrollAncestorsToShowTarget,Gt as scrollViewportToShowTarget,Bt as setDataInElement,Ce as spliceArray,ye as toArray,ke as toMap,Ft as toUnit,A as uid,Se as verifyLicense,P as version,Ae as wait};