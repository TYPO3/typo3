 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */globalThis.CKEDITOR_VERSION=P;const B=Symbol("listeningTo"),F=Symbol("emitterId"),V=Symbol("delegations"),W=H(Object);function H(t){if(!t)return W;return class extends t{on(t,e,n){this.listenTo(this,t,e,n)}once(t,e,n){let r=!1;this.listenTo(this,t,(t,...n)=>{r||(r=!0,t.off(),e.call(this,t,...n))},n)}off(t,e){this.stopListening(this,t,e)}listenTo(t,e,n,r={}){let o,i;this[B]||(this[B]={});const s=this[B];U(t)||K(t);const l=U(t);(o=s[l])||(o=s[l]={emitter:t,callbacks:{}}),(i=o.callbacks[e])||(i=o.callbacks[e]=[]),i.push(n),function(t,e,n,r,o){e._addEventListener?e._addEventListener(n,r,o):t._addEventListener.call(e,n,r,o)}(this,t,e,n,r)}stopListening(t,e,n){const r=this[B];let o=t&&U(t);const i=r&&o?r[o]:void 0,s=i&&e?i.callbacks[e]:void 0;if(!(!r||t&&!i||e&&!s))if(n){G(this,t,e,n);-1!==s.indexOf(n)&&(1===s.length?delete i.callbacks[e]:G(this,t,e,n))}else if(s){for(;n=s.pop();)G(this,t,e,n);delete i.callbacks[e]}else if(i){for(e in i.callbacks)this.stopListening(t,e);delete r[o]}else{for(o in r)this.stopListening(r[o].emitter);delete this[B]}}fire(t,...e){try{const n=t instanceof I?t:new I(this,t),r=n.name;let o=function(t,e){if(!t._events)return null;let n=e;do{const e=t._events[n];if(e&&e.callbacks&&e.callbacks.length)return e.callbacks;const r=n.lastIndexOf(":");n=r>-1?n.substring(0,r):""}while(n);return null}(this,r);if(n.path.push(this),o){o=o.slice();for(let t=0;t<o.length;t++){const i=o[t].callback;if(i.call(this,n,...e),n.off.called&&(delete n.off.called,this._removeEventListener(r,i)),n.stop.called)break}}const i=this[V];if(i){const t=i.get(r),o=i.get("*");t&&z(t,n,e),o&&z(o,n,e)}return n.return}catch(t){
/* istanbul ignore next -- @preserve */
M.rethrowUnexpectedError(t,this)}}delegate(...t){return{to:(e,n)=>{this[V]||(this[V]=new Map),t.forEach(t=>{const r=this[V].get(t);r?r.set(e,n):this[V].set(t,new Map([[e,n]]))})}}}stopDelegating(t,e){if(this[V])if(t)if(e){const n=this[V].get(t);n&&n.delete(e)}else this[V].delete(t);else this[V].clear()}_addEventListener(t,e,n){!function(t,e){const n=Y(t);if(n[e])return;let r=e,o=null;const i=[];for(;""!==r&&!n[r];)n[r]=q(),i.push(n[r]),o&&n[r].childEvents.push(o),o=r,r=r.substr(0,r.lastIndexOf(":"));if(""!==r){for(const t of i)t.callbacks=n[r].callbacks.slice();n[r].childEvents.push(o)}}(this,t);const r=$(this,t),o={callback:e,priority:A.get(n.priority)};for(const t of r)C(t,o)}_removeEventListener(t,e){const n=$(this,t);for(const t of n)for(let n=0;n<t.length;n++)t[n].callback==e&&(t.splice(n,1),n--)}}}function K(t,e){t[F]||(t[F]=e||L())}function U(t){return t[F]}function Y(t){return t._events||Object.defineProperty(t,"_events",{value:{}}),t._events}function q(){return{callbacks:[],childEvents:[]}}function $(t,e){const n=Y(t)[e];if(!n)return[];let r=[n.callbacks];for(let e=0;e<n.childEvents.length;e++){const o=$(t,n.childEvents[e]);r=r.concat(o)}return r}function z(t,e,n){for(let[r,o]of t){o?"function"==typeof o&&(o=o(e.name)):o=e.name;const t=new I(e.source,o);t.path=[...e.path],r.fire(t,...n)}}function G(t,e,n,r){e._removeEventListener?e._removeEventListener(n,r):t._removeEventListener.call(e,n,r)}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */["on","once","off","listenTo","stopListening","fire","delegate","stopDelegating","_addEventListener","_removeEventListener"].forEach(t=>{H[t]=W.prototype[t]});const X=Symbol("observableProperties"),J=Symbol("boundObservables"),Q=Symbol("boundProperties"),Z=Symbol("decoratedMethods"),tt=Symbol("decoratedOriginal"),et=nt(H());function nt(e){if(!e)return et;return class extends e{set(e,n){if(t(e))return void Object.keys(e).forEach(t=>{this.set(t,e[t])},this);rt(this);const r=this[X];if(e in this&&!r.has(e))throw new M("observable-set-cannot-override",this);Object.defineProperty(this,e,{enumerable:!0,configurable:!0,get:()=>r.get(e),set(t){const n=r.get(e);let o=this.fire(`set:${e}`,e,t,n);void 0===o&&(o=t),n===o&&r.has(e)||(r.set(e,o),this.fire(`change:${e}`,e,o,n))}}),this[e]=n}bind(...t){if(!t.length||!st(t))throw new M("observable-bind-wrong-properties",this);if(new Set(t).size!==t.length)throw new M("observable-bind-duplicate-properties",this);rt(this);const e=this[Q];t.forEach(t=>{if(e.has(t))throw new M("observable-bind-rebind",this)});const n=new Map;return t.forEach(t=>{const r={property:t,to:[]};e.set(t,r),n.set(t,r)}),{to:ot,toMany:it,_observable:this,_bindProperties:t,_to:[],_bindings:n}}unbind(...t){if(!this[X])return;const e=this[Q],n=this[J];if(t.length){if(!st(t))throw new M("observable-unbind-wrong-properties",this);t.forEach(t=>{const r=e.get(t);r&&(r.to.forEach(([t,e])=>{const o=n.get(t),i=o[e];i.delete(r),i.size||delete o[e],Object.keys(o).length||(n.delete(t),this.stopListening(t,"change"))}),e.delete(t))})}else n.forEach((t,e)=>{this.stopListening(e,"change")}),n.clear(),e.clear()}decorate(t){rt(this);const e=this[t];if(!e)throw new M("observablemixin-cannot-decorate-undefined",this,{object:this,methodName:t});this.on(t,(t,n)=>{t.return=e.apply(this,n)}),this[t]=function(...e){return this.fire(t,e)},this[t][tt]=e,this[Z]||(this[Z]=[]),this[Z].push(t)}stopListening(t,e,n){if(!t&&this[Z]){for(const t of this[Z])this[t]=this[t][tt];delete this[Z]}super.stopListening(t,e,n)}}}function rt(t){t[X]||(Object.defineProperty(t,X,{value:new Map}),Object.defineProperty(t,J,{value:new Map}),Object.defineProperty(t,Q,{value:new Map}))}function ot(...t){const e=function(...t){if(!t.length)throw new M("observable-bind-to-parse-error",null);const e={to:[]};let n;"function"==typeof t[t.length-1]&&(e.callback=t.pop());return t.forEach(t=>{if("string"==typeof t)n.properties.push(t);else{if("object"!=typeof t)throw new M("observable-bind-to-parse-error",null);n={observable:t,properties:[]},e.to.push(n)}}),e}(...t),n=Array.from(this._bindings.keys()),r=n.length;if(!e.callback&&e.to.length>1)throw new M("observable-bind-to-no-callback",this);if(r>1&&e.callback)throw new M("observable-bind-to-extra-callback",this);var o;
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */e.to.forEach(t=>{if(t.properties.length&&t.properties.length!==r)throw new M("observable-bind-to-properties-length",this);t.properties.length||(t.properties=this._bindProperties)}),this._to=e.to,e.callback&&(this._bindings.get(n[0]).callback=e.callback),o=this._observable,this._to.forEach(t=>{const e=o[J];let n;e.get(t.observable)||o.listenTo(t.observable,"change",(r,i)=>{n=e.get(t.observable)[i],n&&n.forEach(t=>{lt(o,t.property)})})}),function(t){let e;t._bindings.forEach((n,r)=>{t._to.forEach(o=>{e=o.properties[n.callback?0:t._bindProperties.indexOf(r)],n.to.push([o.observable,e]),function(t,e,n,r){const o=t[J],i=o.get(n),s=i||{};s[r]||(s[r]=new Set);s[r].add(e),i||o.set(n,s)}(t._observable,n,o.observable,e)})})}(this),this._bindProperties.forEach(t=>{lt(this._observable,t)})}function it(t,e,n){if(this._bindings.size>1)throw new M("observable-bind-to-many-not-one-binding",this);this.to(...function(t,e){const n=t.map(t=>[t,e]);return Array.prototype.concat.apply([],n)}(t,e),n)}function st(t){return t.every(t=>"string"==typeof t)}function lt(t,e){const n=t[Q].get(e);let r;n.callback?r=n.callback.apply(t,n.to.map(t=>t[0][t[1]])):(r=n.to[0],r=r[0][r[1]]),Object.prototype.hasOwnProperty.call(t,e)?t[e]=r:t.set(e,r)}["set","bind","unbind","decorate","on","once","off","listenTo","stopListening","fire","delegate","stopDelegating","_addEventListener","_removeEventListener"].forEach(t=>{nt[t]=et.prototype[t]});class ct{constructor(){this._replacedElements=[]}replace(t,e){this._replacedElements.push({element:t,newElement:e}),t.style.display="none",e&&t.parentNode.insertBefore(e,t.nextSibling)}restore(){this._replacedElements.forEach(({element:t,newElement:e})=>{t.style.display="",e&&e.remove()}),this._replacedElements=[]}}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */function Xt({target:t,viewportOffset:e=0,ancestorOffset:n=0,alignToTop:r,forceScroll:o}){const i=oe(t);let s=i,l=null;for(e=function(t){if("number"==typeof t)return{top:t,bottom:t,left:t,right:t};return t}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */(e);s;){let c;c=ie(s==i?t:l),Zt({parent:c,getRect:()=>se(t,s),alignToTop:r,ancestorOffset:n,forceScroll:o});let a=se(t,s);const u=se(c,s);if(a.height>u.height){const t=a.getIntersection(u);t&&(a=t)}if(Qt({window:s,rect:a,viewportOffset:e,alignToTop:r,forceScroll:o}),s.parent!=s){if(l=s.frameElement,s=s.parent,!l)return}else s=null}}function Jt(t,e,n){Zt({parent:ie(t),getRect:()=>new St(t),ancestorOffset:e,limiterElement:n})}function Qt({window:t,rect:e,alignToTop:n,forceScroll:r,viewportOffset:o}){const i=e.clone().moveBy(0,o.bottom),s=e.clone().moveBy(0,-o.top),l=new St(t).excludeScrollbarsAndBorders(),c=n&&r,a=[s,i].every(t=>l.contains(t));let{scrollX:u,scrollY:h}=t;const f=u,d=h;c?h-=l.top-e.top+o.top:a||(ee(s,l)?h-=l.top-e.top+o.top:te(i,l)&&(h+=n?e.top-l.top-o.top:e.bottom-l.bottom+o.bottom)),a||(ne(e,l)?u-=l.left-e.left+o.left:re(e,l)&&(u+=e.right-l.right+o.right)),u==f&&h===d||t.scrollTo(u,h)}function Zt({parent:t,getRect:e,alignToTop:n,forceScroll:r,ancestorOffset:o=0,limiterElement:i}){const s=oe(t),l=n&&r;let c,a,u;const h=i||s.document.body;for(;t!=h;)a=e(),c=new St(t).excludeScrollbarsAndBorders(),u=c.contains(a),l?t.scrollTop-=c.top-a.top+o:u||(ee(a,c)?t.scrollTop-=c.top-a.top+o:te(a,c)&&(t.scrollTop+=n?a.top-c.top-o:a.bottom-c.bottom+o)),u||(ne(a,c)?t.scrollLeft-=c.left-a.left+o:re(a,c)&&(t.scrollLeft+=a.right-c.right+o)),t=t.parentNode}function te(t,e){return t.bottom>e.bottom}function ee(t,e){return t.top<e.top}function ne(t,e){return t.left<e.left}function re(t,e){return t.right>e.right}function oe(t){return At(t)?t.startContainer.ownerDocument.defaultView:t.ownerDocument.defaultView}function ie(t){if(At(t)){let e=t.commonAncestorContainer;return Lt(e)&&(e=e.parentNode),e}return t.parentNode}function se(t,e){const n=oe(t),r=new St(t);if(n===e)return r;{let t=n;for(;t!=e;){const e=t.frameElement,n=new St(e).excludeScrollbarsAndBorders();r.moveBy(n.left,n.top),t=t.parent}}return r}const le={ctrl:"⌃",cmd:"⌘",alt:"⌥",shift:"⇧"},ce={ctrl:"Ctrl+",alt:"Alt+",shift:"Shift+"},ae={37:"←",38:"↑",39:"→",40:"↓",9:"⇥",33:"Page Up",34:"Page Down"},ue=_e(),he=Object.fromEntries(Object.entries(ue).map(([t,e])=>{let n;return n=e in ae?ae[e]:t.charAt(0).toUpperCase()+t.slice(1),[e,n]}));function fe(t){let e;if("string"==typeof t){if(e=ue[t.toLowerCase()],!e)throw new M("keyboard-unknown-key",null,{key:t})}else e=t.keyCode+(t.altKey?ue.alt:0)+(t.ctrlKey?ue.ctrl:0)+(t.shiftKey?ue.shift:0)+(t.metaKey?ue.cmd:0);return e}function de(t){return"string"==typeof t&&(t=function(t){return t.split("+").map(t=>t.trim())}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */(t)),t.map(t=>"string"==typeof t?function(t){if(t.endsWith("!"))return fe(t.slice(0,-1));const e=fe(t);return(h.isMac||h.isiOS)&&e==ue.ctrl?ue.cmd:e}(t):t).reduce((t,e)=>e+t,0)}function pe(t){let e=de(t);return Object.entries(h.isMac||h.isiOS?le:ce).reduce((t,[n,r])=>(0!=(e&ue[n])&&(e&=~ue[n],t+=r),t),"")+(e?he[e]:"")}function me(t){return t==ue.arrowright||t==ue.arrowleft||t==ue.arrowup||t==ue.arrowdown}function ge(t,e){const n="ltr"===e;switch(t){case ue.arrowleft:return n?"left":"right";case ue.arrowright:return n?"right":"left";case ue.arrowup:return"up";case ue.arrowdown:return"down"}}function be(t,e){const n=ge(t,e);return"down"===n||"right"===n}function _e(){const t={pageup:33,pagedown:34,arrowleft:37,arrowup:38,arrowright:39,arrowdown:40,backspace:8,delete:46,enter:13,space:32,esc:27,tab:9,ctrl:1114112,shift:2228224,alt:4456448,cmd:8912896};for(let e=65;e<=90;e++){t[String.fromCharCode(e).toLowerCase()]=e}for(let e=48;e<=57;e++)t[e-48]=e;for(let e=112;e<=123;e++)t["f"+(e-111)]=e;return Object.assign(t,{"'":222,",":108,"-":109,".":110,"/":111,";":186,"=":187,"[":219,"\\":220,"]":221,"`":223}),t}const we=["ar","ara","dv","div","fa","per","fas","he","heb","ku","kur","ug","uig"];function ye(t){return we.includes(t)?"rtl":"ltr"}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 ...
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */
function Me(t){return ft(t)?new Map(t):function(t){const e=new Map;for(const n in t)e.set(n,t[n]);return e}(t)}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */function Se(t,e={}){return new Promise((n,r)=>{const o=e.signal||(new AbortController).signal;o.throwIfAborted();const i=setTimeout(function(){o.removeEventListener("abort",s),n()},t);function s(){clearTimeout(i),r(o.reason)}o.addEventListener("abort",s,{once:!0})})}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */async function Re(t,e={}){const{maxAttempts:n=4,retryDelay:r=Ne(),signal:o=(new AbortController).signal}=e;o.throwIfAborted();for(let e=0;;e++){try{return await t()}catch(t){if(e+1>=n)throw t}await Se(r(e),{signal:o})}}function Ne(t={}){const{delay:e=1e3,factor:n=2,maxDelay:r=1e4}=t;return t=>Math.min(n**t*e,r)}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */function je(t,e,n){const r=t.length,o=e.length;for(let e=r-1;e>=n;e--)t[e+o]=t[e];for(let r=0;r<o;r++)t[n+r]=e[r]}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */function Pe(t,e){let n;function r(...o){r.cancel(),n=setTimeout(()=>t(...o),e)}return r.cancel=()=>{clearTimeout(n)},r}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */function Be(t){const e=Array.isArray(t)?t:[t],n=function(){const t=[];for(let e=0;e<256;e++){let n=e;for(let t=0;t<8;t++)1&n?n=3988292384^n>>>1:n>>>=1;t[e]=n}return t}();let r=~0;const o=e.map(t=>Array.isArray(t)?t.join(""):String(t)).join("");for(let t=0;t<o.length;t++){r=r>>>8^n[255&(r^o.charCodeAt(t))]}return r=(-1^r)>>>0,r.toString(16).padStart(8,"0")}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */function Fe(t){return!!t&&1==t.length&&/[\u0300-\u036f\u1ab0-\u1aff\u1dc0-\u1dff\u20d0-\u20ff\ufe20-\ufe2f]/.test(t)}function Ve(t){return!!t&&1==t.length&&/[\ud800-\udbff]/.test(t)}function We(t){return!!t&&1==t.length&&/[\udc00-\udfff]/.test(t)}function He(t,e){return Ve(t.charAt(e-1))&&We(t.charAt(e))}function Ke(t,e){return Fe(t.charAt(e))}const Ue=qe();function Ye(t,e){const n=String(t).matchAll(Ue);return Array.from(n).some(t=>t.index<e&&e<t.index+t[0].length)}function qe(){const t=/\p{Regional_Indicator}{2}/u.source,e="(?:"+[/\p{Emoji}[\u{E0020}-\u{E007E}]+\u{E007F}/u,/\p{Emoji}\u{FE0F}?\u{20E3}/u,/\p{Emoji}\u{FE0F}/u,/(?=\p{General_Category=Other_Symbol})\p{Emoji}\p{Emoji_Modifier}*/u].map(t=>t.source).join("|")+")";return new RegExp(`${t}|${e}(?:‍${e})*`,"ug")}export{M as CKEditorError,xe as Collection,pt as Config,yt as DomEmitterMixin,ct as ElementReplacer,H as EmitterMixin,I as EventInfo,Ie as FocusTracker,Ce as KeystrokeHandler,Te as Locale,nt as ObservableMixin,St as Rect,Bt as ResizeObserver,at as abortableDebounce,ht as compareArrays,ut as count,Be as crc32,dt as createElement,Pe as delay,T as diff,x as diffToChanges,h as env,Ne as exponentialDelay,y as fastDiff,Tt as findClosestScrollableAncestor,ke as first,xt as getAncestors,It as getBorderWidths,fe as getCode,kt as getDataFromElement,pe as getEnvKeystrokeText,ye as getLanguageDirection,ge as getLocalizedArrowKeyCodeDirection,qt as getOptimalPosition,Ot as getRangeFromMouseEvent,c as global,Wt as indexOf,Ht as insertAt,C as insertToPriorityArray,me as isArrowKeyCode,Fe as isCombiningMark,Kt as isComment,be as isForwardArrowKeyCode,Ve as isHighSurrogateHalf,Ke as isInsideCombinedSymbol,Ye as isInsideEmojiSequence,He as isInsideSurrogatePair,ft as isIterable,We as isLowSurrogateHalf,bt as isNode,At as isRange,Lt as isText,Ut as isValidAttributeName,Oe as isViewWithFocusTracker,Yt as isVisible,ue as keyCodes,R as logError,S as logWarning,k as mix,De as parseBase64EncodedObject,de as parseKeystroke,A as priorities,D as releaseDate,Gt as remove,Re as retry,Jt as scrollAncestorsToShowTarget,Xt as scrollViewportToShowTarget,Ft as setDataInElement,je as spliceArray,ve as toArray,Me as toMap,Vt as toUnit,L as uid,P as version,Se as wait};