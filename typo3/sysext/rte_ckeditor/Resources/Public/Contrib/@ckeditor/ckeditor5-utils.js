 ...
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */const L="39.0.2",O=new Date(2023,8,6);
 ...
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function mt(t){return"[object Range]"==Object.prototype.toString.apply(t)}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 ...
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */const wt=["top","right","bottom","left","width","height"];class yt{constructor(t){const e=mt(t);if(Object.defineProperty(this,"_source",{value:t._source||t,writable:!0,enumerable:!1}),Tt(t)||e)if(e){const e=yt.getDomRangeRects(t);vt(this,yt.getBoundingRect(e))}else vt(this,t.getBoundingClientRect());else if(lt(t)){const{innerWidth:e,innerHeight:n}=t;vt(this,{top:0,right:e,bottom:n,left:0,width:e,height:n})}else vt(this,t)}clone(){return new yt(this)}moveTo(t,e){return this.top=e,this.right=t+this.width,this.bottom=e+this.height,this.left=t,this}moveBy(t,e){return this.top+=e,this.right+=t,this.left+=t,this.bottom+=e,this}getIntersection(t){const e={top:Math.max(this.top,t.top),right:Math.min(this.right,t.right),bottom:Math.min(this.bottom,t.bottom),left:Math.max(this.left,t.left),width:0,height:0};return e.width=e.right-e.left,e.height=e.bottom-e.top,e.width<0||e.height<0?null:new yt(e)}getIntersectionArea(t){const e=this.getIntersection(t);return e?e.getArea():0}getArea(){return this.width*this.height}getVisible(){const t=this._source;let e=this.clone();if(Et(t))return e;let n,o=t,r=t.parentNode||t.commonAncestorContainer;for(;r&&!Et(r);){if(o instanceof HTMLElement&&"absolute"===It(o)&&(n=o),n&&("relative"!==It(r)||"visible"===(i=r).ownerDocument.defaultView.getComputedStyle(i).overflow)){o=r,r=r.parentNode;continue}const t=new yt(r),s=e.getIntersection(t);if(!s)return null;s.getArea()<e.getArea()&&(e=s),o=r,r=r.parentNode}var i;
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */return e}isEqual(t){for(const e of wt)if(this[e]!==t[e])return!1;return!0}contains(t){const e=this.getIntersection(t);return!(!e||!e.isEqual(t))}excludeScrollbarsAndBorders(){const t=this._source;let e,n,o;if(lt(t))e=t.innerWidth-t.document.documentElement.clientWidth,n=t.innerHeight-t.document.documentElement.clientHeight,o=t.getComputedStyle(t.document.documentElement).direction;else{const r=bt(t);e=t.offsetWidth-t.clientWidth-r.left-r.right,n=t.offsetHeight-t.clientHeight-r.top-r.bottom,o=t.ownerDocument.defaultView.getComputedStyle(t).direction,this.left+=r.left,this.top+=r.top,this.right-=r.right,this.bottom-=r.bottom,this.width=this.right-this.left,this.height=this.bottom-this.top}return this.width-=e,"ltr"===o?this.right-=e:this.left+=e,this.height-=n,this.bottom-=n,this}static getDomRangeRects(t){const e=[],n=Array.from(t.getClientRects());if(n.length)for(const t of n)e.push(new yt(t));else{let n=t.startContainer;_t(n)&&(n=n.parentNode);const o=new yt(n.getBoundingClientRect());o.right=o.left,o.width=0,e.push(o)}return e}static getBoundingRect(t){const e={left:Number.POSITIVE_INFINITY,top:Number.POSITIVE_INFINITY,right:Number.NEGATIVE_INFINITY,bottom:Number.NEGATIVE_INFINITY,width:0,height:0};let n=0;for(const o of t)n++,e.left=Math.min(e.left,o.left),e.top=Math.min(e.top,o.top),e.right=Math.max(e.right,o.right),e.bottom=Math.max(e.bottom,o.bottom);return 0==n?null:(e.width=e.right-e.left,e.height=e.bottom-e.top,new yt(e))}}function vt(t,e){for(const n of wt)t[n]=e[n]}function Et(t){return!!Tt(t)&&t===t.ownerDocument.body}function Tt(t){return null!==t&&"object"==typeof t&&1===t.nodeType&&"function"==typeof t.getBoundingClientRect}function It(t){return t.ownerDocument.defaultView.getComputedStyle(t).position}function xt(t,e=0){const n=t.map((t=>{if(t instanceof Document){const t=new yt(dt.window);return t.top+=e,t.height-=e,t}return new yt(t)}));let o=n[0];for(const t of n.slice(1))o&&(o=o.getIntersection(t));return o}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Lt(t){const e=[];let n=pt(t);for(;n&&n!==dt.document.body;)e.push(n),n=pt(n);return e.push(dt.document),e}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Ot(t){return t instanceof HTMLTextAreaElement?t.value:t.innerHTML}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */class kt{constructor(t,e){kt._observerInstance||kt._createObserver(),this._element=t,this._callback=e,kt._addElementCallback(t,e),kt._observerInstance.observe(t)}get element(){return this._element}destroy(){kt._deleteElementCallback(this._element,this._callback)}static _addElementCallback(t,e){kt._elementCallbacks||(kt._elementCallbacks=new Map);let n=kt._elementCallbacks.get(t);n||(n=new Set,kt._elementCallbacks.set(t,n)),n.add(e)}static _deleteElementCallback(t,e){const n=kt._getElementCallbacks(t);n&&(n.delete(e),n.size||(kt._elementCallbacks.delete(t),kt._observerInstance.unobserve(t))),kt._elementCallbacks&&!kt._elementCallbacks.size&&(kt._observerInstance=null,kt._elementCallbacks=null)}static _getElementCallbacks(t){return kt._elementCallbacks?kt._elementCallbacks.get(t):null}static _createObserver(){kt._observerInstance=new dt.window.ResizeObserver((t=>{for(const e of t){const t=kt._getElementCallbacks(e.target);if(t)for(const n of t)n(e)}}))}}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
function At(t,e){t instanceof HTMLTextAreaElement&&(t.value=e),t.innerHTML=e}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Nt(t){return e=>e+t}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Ct(t){let e=0;for(;t.previousSibling;)t=t.previousSibling,e++;return e}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 ...
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function Rt(t){try{dt.document.createAttribute(t)}catch(t){return!1}return!0}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 ...
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
function jt({element:t,target:e,positions:n,limiter:o,fitInViewport:r,viewportOffsetConfig:s}){i(e)&&(e=e()),i(o)&&(o=o());const l=function(t){return t&&t.parentNode?t.offsetParent===dt.document.body?null:t.offsetParent:null}(t),c=new yt(t),a=new yt(e);let h;const u=r&&function(t){t=Object.assign({top:0,bottom:0,left:0,right:0},t);const e=new yt(dt.window);return e.top+=t.top,e.height-=t.top,e.bottom-=t.bottom,e.height-=t.bottom,e}(s)||null,f={targetRect:a,elementRect:c,positionedElementAncestor:l,viewportRect:u};if(o||r){const t=o&&new yt(o).getVisible();Object.assign(f,{limiterRect:t,viewportRect:u}),h=function(t,e){const{elementRect:n}=e,o=n.getArea(),r=t.map((t=>new Bt(t,e))).filter((t=>!!t.name));let i=0,s=null;for(const t of r){const{limiterIntersectionArea:e,viewportIntersectionArea:n}=t;if(e===o)return t;const r=n**2+e**2;r>i&&(i=r,s=t)}return s}(n,f)||new Bt(n[0],f)}else h=new Bt(n[0],f);return h}function Pt(t){const{scrollX:e,scrollY:n}=dt.window;return t.clone().moveBy(e,n)}kt._observerInstance=null,kt._elementCallbacks=null;class Bt{constructor(t,e){const n=t(e.targetRect,e.elementRect,e.viewportRect);if(!n)return;const{left:o,top:r,name:i,config:s}=n;this.name=i,this.config=s,this._positioningFunctionCorrdinates={left:o,top:r},this._options=e}get left(){return this._absoluteRect.left}get top(){return this._absoluteRect.top}get limiterIntersectionArea(){const t=this._options.limiterRect;if(t){const e=this._options.viewportRect;if(!e)return t.getIntersectionArea(this._rect);{const n=t.getIntersection(e);if(n)return n.getIntersectionArea(this._rect)}}return 0}get viewportIntersectionArea(){const t=this._options.viewportRect;return t?t.getIntersectionArea(this._rect):0}get _rect(){return this._cachedRect||(this._cachedRect=this._options.elementRect.clone().moveTo(this._positioningFunctionCorrdinates.left,this._positioningFunctionCorrdinates.top)),this._cachedRect}get _absoluteRect(){return this._cachedAbsoluteRect||(this._cachedAbsoluteRect=Pt(this._rect),this._options.positionedElementAncestor&&function(t,e){const n=Pt(new yt(e)),o=bt(e);let r=0,i=0;r-=n.left,i-=n.top,r+=e.scrollLeft,i+=e.scrollTop,r-=o.left,i-=o.top,t.moveBy(r,i)}(this._cachedAbsoluteRect,this._options.positionedElementAncestor)),this._cachedAbsoluteRect}}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 ...
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */(e);s;){let c;c=Gt(s==i?t:l),Ht({parent:c,getRect:()=>Xt(t,s),alignToTop:o,ancestorOffset:n,forceScroll:r});const a=Xt(t,s);if(Wt({window:s,rect:a,viewportOffset:e,alignToTop:o,forceScroll:r}),s.parent!=s){if(l=s.frameElement,s=s.parent,!l)return}else s=null}}function Kt(t,e,n){Ht({parent:Gt(t),getRect:()=>new yt(t),ancestorOffset:e,limiterElement:n})}function Wt({window:t,rect:e,alignToTop:n,forceScroll:o,viewportOffset:r}){const i=e.clone().moveBy(0,r.bottom),s=e.clone().moveBy(0,-r.top),l=new yt(t).excludeScrollbarsAndBorders(),c=n&&o,a=[s,i].every((t=>l.contains(t)));let{scrollX:h,scrollY:u}=t;const f=h,d=u;c?u-=l.top-e.top+r.top:a||(Ut(s,l)?u-=l.top-e.top+r.top:qt(i,l)&&(u+=n?e.top-l.top-r.top:e.bottom-l.bottom+r.bottom)),a||(Yt(e,l)?h-=l.left-e.left+r.left:$t(e,l)&&(h+=e.right-l.right+r.right)),h==f&&u===d||t.scrollTo(h,u)}function Ht({parent:t,getRect:e,alignToTop:n,forceScroll:o,ancestorOffset:r=0,limiterElement:i}){const s=zt(t),l=n&&o;let c,a,h;const u=i||s.document.body;for(;t!=u;)a=e(),c=new yt(t).excludeScrollbarsAndBorders(),h=c.contains(a),l?t.scrollTop-=c.top-a.top+r:h||(Ut(a,c)?t.scrollTop-=c.top-a.top+r:qt(a,c)&&(t.scrollTop+=n?a.top-c.top-r:a.bottom-c.bottom+r)),h||(Yt(a,c)?t.scrollLeft-=c.left-a.left+r:$t(a,c)&&(t.scrollLeft+=a.right-c.right+r)),t=t.parentNode}function qt(t,e){return t.bottom>e.bottom}function Ut(t,e){return t.top<e.top}function Yt(t,e){return t.left<e.left}function $t(t,e){return t.right>e.right}function zt(t){return mt(t)?t.startContainer.ownerDocument.defaultView:t.ownerDocument.defaultView}function Gt(t){if(mt(t)){let e=t.commonAncestorContainer;return _t(e)&&(e=e.parentNode),e}return t.parentNode}function Xt(t,e){const n=zt(t),o=new yt(t);if(n===e)return o;{let t=n;for(;t!=e;){const e=t.frameElement,n=new yt(e).excludeScrollbarsAndBorders();o.moveBy(n.left,n.top),t=t.parent}}return o}const Jt={ctrl:"⌃",cmd:"⌘",alt:"⌥",shift:"⇧"},Qt={ctrl:"Ctrl+",alt:"Alt+",shift:"Shift+"},Zt=function(){const t={arrowleft:37,arrowup:38,arrowright:39,arrowdown:40,backspace:8,delete:46,enter:13,space:32,esc:27,tab:9,ctrl:1114112,shift:2228224,alt:4456448,cmd:8912896};for(let e=65;e<=90;e++){t[String.fromCharCode(e).toLowerCase()]=e}for(let e=48;e<=57;e++)t[e-48]=e;for(let e=112;e<=123;e++)t["f"+(e-111)]=e;for(const e of"`-=[];',./\\")t[e]=e.charCodeAt(0);return t}(),te=Object.fromEntries(Object.entries(Zt).map((([t,e])=>[e,t.charAt(0).toUpperCase()+t.slice(1)])));function ee(t){let e;if("string"==typeof t){if(e=Zt[t.toLowerCase()],!e)throw new v("keyboard-unknown-key",null,{key:t})}else e=t.keyCode+(t.altKey?Zt.alt:0)+(t.ctrlKey?Zt.ctrl:0)+(t.shiftKey?Zt.shift:0)+(t.metaKey?Zt.cmd:0);return e}function ne(t){return"string"==typeof t&&(t=function(t){return t.split("+").map((t=>t.trim()))}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */(t)),t.map((t=>"string"==typeof t?function(t){if(t.endsWith("!"))return ee(t.slice(0,-1));const e=ee(t);return l.isMac&&e==Zt.ctrl?Zt.cmd:e}(t):t)).reduce(((t,e)=>e+t),0)}function oe(t){let e=ne(t);return Object.entries(l.isMac?Jt:Qt).reduce(((t,[n,o])=>(0!=(e&Zt[n])&&(e&=~Zt[n],t+=o),t)),"")+(e?te[e]:"")}function re(t){return t==Zt.arrowright||t==Zt.arrowleft||t==Zt.arrowup||t==Zt.arrowdown}function ie(t,e){const n="ltr"===e;switch(t){case Zt.arrowleft:return n?"left":"right";case Zt.arrowright:return n?"right":"left";case Zt.arrowup:return"up";case Zt.arrowdown:return"down"}}function se(t,e){const n=ie(t,e);return"down"===n||"right"===n}const le=["ar","ara","fa","per","fas","he","heb","ku","kur","ug","uig"];function ce(t){return le.includes(t)?"rtl":"ltr"}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 ...
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */class pe extends(at(Y())){constructor(){super(),this._elements=new Set,this._nextEventLoopTimeout=null,this.set("isFocused",!1),this.set("focusedElement",null)}add(t){if(this._elements.has(t))throw new v("focustracker-add-element-already-exist",this);this.listenTo(t,"focus",(()=>this._focus(t)),{useCapture:!0}),this.listenTo(t,"blur",(()=>this._blur()),{useCapture:!0}),this._elements.add(t)}remove(t){t===this.focusedElement&&this._blur(),this._elements.has(t)&&(this.stopListening(t),this._elements.delete(t))}destroy(){this.stopListening()}_focus(t){clearTimeout(this._nextEventLoopTimeout),this.focusedElement=t,this.isFocused=!0}_blur(){clearTimeout(this._nextEventLoopTimeout),this._nextEventLoopTimeout=setTimeout((()=>{this.focusedElement=null,this.isFocused=!1}),0)}}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */class ge{constructor(){this._listener=new(at())}listenTo(t){this._listener.listenTo(t,"keydown",((t,e)=>{this._listener.fire("_keydown:"+ee(e),e)}))}set(t,e,n={}){const o=ne(t),r=n.priority;this._listener.listenTo(this._listener,"_keydown:"+o,((t,n)=>{e(n,(()=>{n.preventDefault(),n.stopPropagation(),t.stop()})),t.return=!0}),{priority:r})}press(t){return!!this._listener.fire("_keydown:"+ee(t),t)}stopListening(t){this._listener.stopListening(t)}destroy(){this.stopListening()}}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
 ...
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
function me(t){return et(t)?new Map(t):function(t){const e=new Map;for(const n in t)e.set(n,t[n]);return e}(t)}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function be(t,e,n,o){if(Math.max(e.length,t.length)>1e4)return t.slice(0,n).concat(e).concat(t.slice(n+o,t.length));{const r=Array.from(t);return r.splice(n,o,...e),r}}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function _e(t,e){let n;function o(...r){o.cancel(),n=setTimeout((()=>t(...r)),e)}return o.cancel=()=>{clearTimeout(n)},o}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function we(t){function e(t){return t.length>=40&&t.length<=255?"VALID":"INVALID"}if(!t)return"INVALID";let n="";try{n=atob(t)}catch(t){return"INVALID"}const o=n.split("-"),r=o[0],i=o[1];if(!i)return e(t);try{atob(i)}catch(n){try{if(atob(r),!atob(r).length)return e(t)}catch(n){return e(t)}}if(r.length<40||r.length>255)return"INVALID";let s="";try{atob(r),s=atob(i)}catch(t){return"INVALID"}if(8!==s.length)return"INVALID";const l=Number(s.substring(0,4)),c=Number(s.substring(4,6))-1,a=Number(s.substring(6,8)),h=new Date(l,c,a);return h<O||isNaN(Number(h))?"INVALID":"VALID"}
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */function ye(t){return!!t&&1==t.length&&/[\u0300-\u036f\u1ab0-\u1aff\u1dc0-\u1dff\u20d0-\u20ff\ufe20-\ufe2f]/.test(t)}function ve(t){return!!t&&1==t.length&&/[\ud800-\udbff]/.test(t)}function Ee(t){return!!t&&1==t.length&&/[\udc00-\udfff]/.test(t)}function Te(t,e){return ve(t.charAt(e-1))&&Ee(t.charAt(e))}function Ie(t,e){return ye(t.charAt(e))}const xe=function(){const t=/\p{Regional_Indicator}{2}/u.source,e="(?:"+[/\p{Emoji}[\u{E0020}-\u{E007E}]+\u{E007F}/u,/\p{Emoji}\u{FE0F}?\u{20E3}/u,/\p{Emoji}\u{FE0F}/u,/(?=\p{General_Category=Other_Symbol})\p{Emoji}\p{Emoji_Modifier}*/u].map((t=>t.source)).join("|")+")";return new RegExp(`${t}|${e}(?:‍${e})*`,"ug")}();function Le(t,e){const n=String(t).matchAll(xe);return Array.from(n).some((t=>t.index<e&&e<t.index+t[0].length))}export{v as CKEditorError,fe as Collection,ot as Config,at as DomEmitterMixin,Q as ElementReplacer,S as EmitterMixin,g as EventInfo,pe as FocusTracker,ge as KeystrokeHandler,ue as Locale,Y as ObservableMixin,yt as Rect,kt as ResizeObserver,tt as compareArrays,Z as count,nt as createElement,_e as delay,f as diff,d as diffToChanges,l as env,a as fastDiff,pt as findClosestScrollableAncestor,de as first,gt as getAncestors,ee as getCode,Ot as getDataFromElement,xt as getElementsIntersectionRect,oe as getEnvKeystrokeText,ce as getLanguageDirection,ie as getLocalizedArrowKeyCodeDirection,jt as getOptimalPosition,Lt as getScrollableAncestors,dt as global,Ct as indexOf,St as insertAt,w as insertToPriorityArray,re as isArrowKeyCode,ye as isCombiningMark,Mt as isComment,se as isForwardArrowKeyCode,ve as isHighSurrogateHalf,Ie as isInsideCombinedSymbol,Le as isInsideEmojiSequence,Te as isInsideSurrogatePair,et as isIterable,Ee as isLowSurrogateHalf,st as isNode,mt as isRange,_t as isText,Rt as isValidAttributeName,Dt as isVisible,Zt as keyCodes,T as logError,E as logWarning,p as mix,ne as parseKeystroke,_ as priorities,O as releaseDate,Vt as remove,Kt as scrollAncestorsToShowTarget,Ft as scrollViewportToShowTarget,At as setDataInElement,be as spliceArray,ae as toArray,me as toMap,Nt as toUnit,b as uid,we as verifyLicense,L as version};