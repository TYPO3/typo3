 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */(e);s;){let c;c=Xt(s==i?t:l),qt({parent:c,getRect:()=>Jt(t,s),alignToTop:o,ancestorOffset:n,forceScroll:r});const a=Jt(t,s);if(Kt({window:s,rect:a,viewportOffset:e,alignToTop:o,forceScroll:r}),s.parent!=s){if(l=s.frameElement,s=s.parent,!l)return}else s=null}}function Ht(t,e,n){qt({parent:Xt(t),getRect:()=>new xt(t),ancestorOffset:e,limiterElement:n})}function Kt({window:t,rect:e,alignToTop:n,forceScroll:o,viewportOffset:r}){const i=e.clone().moveBy(0,r.bottom),s=e.clone().moveBy(0,-r.top),l=new xt(t).excludeScrollbarsAndBorders(),c=n&&o,a=[s,i].every((t=>l.contains(t)));let{scrollX:u,scrollY:h}=t;const f=u,d=h;c?h-=l.top-e.top+r.top:a||(Yt(s,l)?h-=l.top-e.top+r.top:Ut(i,l)&&(h+=n?e.top-l.top-r.top:e.bottom-l.bottom+r.bottom)),a||($t(e,l)?u-=l.left-e.left+r.left:zt(e,l)&&(u+=e.right-l.right+r.right)),u==f&&h===d||t.scrollTo(u,h)}function qt({parent:t,getRect:e,alignToTop:n,forceScroll:o,ancestorOffset:r=0,limiterElement:i}){const s=Gt(t),l=n&&o;let c,a,u;const h=i||s.document.body;for(;t!=h;)a=e(),c=new xt(t).excludeScrollbarsAndBorders(),u=c.contains(a),l?t.scrollTop-=c.top-a.top+r:u||(Yt(a,c)?t.scrollTop-=c.top-a.top+r:Ut(a,c)&&(t.scrollTop+=n?a.top-c.top-r:a.bottom-c.bottom+r)),u||($t(a,c)?t.scrollLeft-=c.left-a.left+r:zt(a,c)&&(t.scrollLeft+=a.right-c.right+r)),t=t.parentNode}function Ut(t,e){return t.bottom>e.bottom}function Yt(t,e){return t.top<e.top}function $t(t,e){return t.left<e.left}function zt(t,e){return t.right>e.right}function Gt(t){return vt(t)?t.startContainer.ownerDocument.defaultView:t.ownerDocument.defaultView}function Xt(t){if(vt(t)){let e=t.commonAncestorContainer;return yt(e)&&(e=e.parentNode),e}return t.parentNode}function Jt(t,e){const n=Gt(t),o=new xt(t);if(n===e)return o;{let t=n;for(;t!=e;){const e=t.frameElement,n=new xt(e).excludeScrollbarsAndBorders();o.moveBy(n.left,n.top),t=t.parent}}return o}const Qt={ctrl:"⌃",cmd:"⌘",alt:"⌥",shift:"⇧"},Zt={ctrl:"Ctrl+",alt:"Alt+",shift:"Shift+"},te={37:"←",38:"↑",39:"→",40:"↓",9:"⇥"},ee=function(){const t={arrowleft:37,arrowup:38,arrowright:39,arrowdown:40,backspace:8,delete:46,enter:13,space:32,esc:27,tab:9,ctrl:1114112,shift:2228224,alt:4456448,cmd:8912896};for(let e=65;e<=90;e++){t[String.fromCharCode(e).toLowerCase()]=e}for(let e=48;e<=57;e++)t[e-48]=e;for(let e=112;e<=123;e++)t["f"+(e-111)]=e;return Object.assign(t,{"'":222,",":108,"-":109,".":110,"/":111,";":186,"=":187,"[":219,"\\":220,"]":221,"`":223}),t}(),ne=Object.fromEntries(Object.entries(ee).map((([t,e])=>{let n;return n=e in te?te[e]:t.charAt(0).toUpperCase()+t.slice(1),[e,n]})));function oe(t){let e;if("string"==typeof t){if(e=ee[t.toLowerCase()],!e)throw new E("keyboard-unknown-key",null,{key:t})}else e=t.keyCode+(t.altKey?ee.alt:0)+(t.ctrlKey?ee.ctrl:0)+(t.shiftKey?ee.shift:0)+(t.metaKey?ee.cmd:0);return e}function re(t){return"string"==typeof t&&(t=function(t){return t.split("+").map((t=>t.trim()))}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */(t)),t.map((t=>"string"==typeof t?function(t){if(t.endsWith("!"))return oe(t.slice(0,-1));const e=oe(t);return(c.isMac||c.isiOS)&&e==ee.ctrl?ee.cmd:e}(t):t)).reduce(((t,e)=>e+t),0)}function ie(t){let e=re(t);return Object.entries(c.isMac||c.isiOS?Qt:Zt).reduce(((t,[n,o])=>(0!=(e&ee[n])&&(e&=~ee[n],t+=o),t)),"")+(e?ne[e]:"")}function se(t){return t==ee.arrowright||t==ee.arrowleft||t==ee.arrowup||t==ee.arrowdown}function le(t,e){const n="ltr"===e;switch(t){case ee.arrowleft:return n?"left":"right";case ee.arrowright:return n?"right":"left";case ee.arrowup:return"up";case ee.arrowdown:return"down"}}function ce(t,e){const n=le(t,e);return"down"===n||"right"===n}const ae=["ar","ara","fa","per","fas","he","heb","ku","kur","ug","uig"];function ue(t){return ae.includes(t)?"rtl":"ltr"}
/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
