...
class RecyclerModuleController extends \TYPO3\CMS\Backend\Module\BaseScriptClass {
	...
	protected function getDocHeaderButtons() {
		...
		// SAVE button
		$buttons['save'] = '';
		//<input type="image" class="c-inputButton" name="submit" value="Update"' . TYPO3\CMS\Backend\Utility\IconUtility::skinImg($GLOBALS['BACK_PATH'], 'gfx/savedok.gif', '') . ' title="' . $GLOBALS['LANG']->sL('LLL:EXT:lang/locallang_core.php:rm.saveDoc', 1) . '" />';
		return $buttons;
	}
