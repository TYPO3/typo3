...
class Tx_Beuser_Domain_Model_BackendUserTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	...
	public function getAdminReturnInitialValueForBoolean() {
		$this->assertTrue($this->fixture->getAdmin() === FALSE, 'Admin status is correct.');
	}
	...
	public function setAdminToTrueSetsAdmin() {
		$this->fixture->setAdmin(TRUE);
		$this->assertTrue($this->fixture->getAdmin(), 'Admin status is not true, after setting to true.');
	}
	...
	public function setAdminToFalseSetsAdmin() {
		$this->fixture->setAdmin(FALSE);
		$this->assertFalse($this->fixture->getAdmin(), 'Admin status is not false, after setting to false.');
	}
