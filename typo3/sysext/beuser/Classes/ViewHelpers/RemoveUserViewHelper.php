...
class RemoveUserViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
	...
	public function render(\TYPO3\CMS\Beuser\Domain\Model\BackendUser $backendUser) {
		...
		return '<a href="' .$url. '"  onclick="return confirm(\''.\TYPO3\CMS\Extbase\Utility\LocalizationUtility::translate('confirm', 'beuser', $this->arguments['arguments']).'\')">' .\TYPO3\CMS\Backend\Utility\IconUtility::getSpriteIcon(('actions-edit-delete')). '</a>';
	}
