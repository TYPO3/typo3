...
$LOCAL_LANG = Array (
	...
	'cz' => Array (
		'mlang_labels_tablabel' => 'Administrace uivatelù backendu',
		'mlang_labels_tabdescr' => 'Modul administrace uivatelù poskytuje pøehled o všech uivatelích backendu. Mùete je seskupovat podle vlastností, abyste mohli monitorovat jejich pøístupová práva, mounty souborù, TSconfig, skupiny uivatelù atd. Tento modul je nepostradatelnı, abyste si byli jisti, e jsou uivatelé správnì nakonfigurováni.<br /><em>Pøístup pouze pro \'admin\' uivatele!</em>',
		'mlang_tabs_tab' => 'Uivatelé',
	),
	'pl' => Array (
	...
	'ru' => Array (
		'mlang_labels_tablabel' => 'Óïğàâëåíèå íàñòğîéêàìè âíóòğåííèõ ïîëüçîâàòåëåé',
		'mlang_labels_tabdescr' => 'Ìîäóëü óïğàâëåíèÿ ïîëüçîâàòåëÿìè ïğåäîñòàâëÿåò îáçîğ âñåõ âíóòğåííèõ ïîëüçîâàòåëåé. Âû ìîæåòå ãğóïïèğîâàòü èõ ïî èõ ñâîéñòâàì, ÷òîáû óâèäåòü èõ ïğàâà, êîğíåâûå ïàïêè ôàéëîâ, TSconfig, ÷ëåíñòâî â ãğóïïàõ è ò.ä. İòîò ìîäóëü - íåçàìåíèìûé èíñòğóìåíò äëÿ ïğîâåğêè ïğàâèëüíîé íàñòğîéêè ïîëüçîâàòåëåé.<BR><em>Äîñòóï òîëüêî äëÿ ïîëüçîâàòåëåé \'Admin\'!</em>',
		'mlang_tabs_tab' => 'User Admin',
	),
	'ro' => Array (
		'mlang_labels_tablabel' => 'Administrarea utilizatorilor Backend',
		'mlang_labels_tabdescr' => 'Modulul Administrare Utilizatori vã oferã o vedere de ansamblu a tuturor utilizatorilor backend. Îi puteşi grupa funcşie de proprietãşile lor, pentru a putea monitoriza permisiunile, cãile rãdãcinã, configurãrile TS, grupurile de membri, etc...Acest modul este o unealtã indispensabilã dacã dorişi sã fişi sigur cã toşi utilizatorii sînt corect configuraşi.',
		'mlang_tabs_tab' => 'Administrare Utilizatori',
	),
	'ch' => Array (
	),
	'sk' => Array (
		'mlang_labels_tablabel' => 'Administrácia uívate¾ov backendu',
		'mlang_labels_tabdescr' => 'Modul administrácie uívate¾ov poskytuje preh¾ad o všetkıch uívate¾och backendu. Môes ich zoskupovat pod¾a vlastností, aby si mohol monitorova ich prístupové práva, mounty súborov, TSconfig, skupiny uívate¾ov atd. Tento modul je nepostradate¾nı, aby si si bol istí, e sú uívatelia správne nakonfigurovaní.<BR><em>Prístup len pre \'admin\' uivate¾a !</em>',
		'mlang_tabs_tab' => 'Uívatelia',
	),
	'lt' => Array (
	),
	'is' => Array (
	...
	'hr' => Array (
		...
		'mlang_labels_tabdescr' => 'Modul za administraciju backend korisnika omoguæava pregled svih backend korisnika. Moete ih grupirati po osobinama kako bi mogli pratiti njihove dozvole, filemount-ove, TSconfig, grupe èlanove i sl. Ovaj je modul nezaobilazan alat za pravilno podešavanje korisnika.<BR /><em> Pristup dozvoljen samo admin korisnicima!</em>',
	...
	'hk' => Array (
		'mlang_labels_tablabel' => '«á¶Ô¨Ï¥ÎªÌºŞ²z',
		'mlang_labels_tabdescr' => '«á¶Ô¨Ï¥ÎªÌ¼Ò²Õ¨Ï§A¦³©Ò¦³«á¶Ô¨Ï¥ÎªÌªº·§Äı¡C§A¥i¥H«öµÛ¥L­Ìªº¯S©Ê¨Ó¬°¥L­Ì¬°²Õ¡A¥H­P§A¯à°÷ºÊ¹î¥L­ÌªºÅv­­¡NÀÉ®×ªş´Ş¡NTSconfig©M·|­û¸s²Õµ¥¡C³o­Ó¼Ò²Õ©ó¦³®Ä©M¥¿½T¦a³]©w¨Ï¥ÎªÌ¬O¤£¥i©Î¯Êªº¤u¨ã¡C<Br><em>¥u³\\¡uºŞ²z¡v¯Å¨Ï¥ÎªÌ¨Ï¥Î¡I</em?',
		'mlang_tabs_tab' => '¨Ï¥ÎªÌºŞ²z',
	),
	'eu' => Array (
	),
	'bg' => Array (
		'mlang_labels_tablabel' => 'Àäìèíèñòğàöèÿ íà Backend ïîòğåáèòåëè',
		'mlang_labels_tabdescr' => 'Ìîäóëà çà àäìèíèñòğèğàíå íà ïîòğåáèòåëèòå Âè îñèãóğÿâà ïğåãëåä (overview) íà âñè÷êè backend ïîòğåáèòåëè. Ìîæåòå äà ãè ãğóïèğàòå ïî òåõíèòå ñâîéñòâà, òàêà ÷å äà ìîãàò äà áúäàò íàáëşäàâàíè ïî òåõíèòå ïğàâà, çàêà÷åíè ôàéëîâå (filemounts), TSconfig, ÷ëåíñêè ãğóïè è äğ.. Òîçè ìîäóë å çàäúëæèòåëåí çà äà ñòå ñèãóğíè ÷å ïîòğåáèòåëèòå ñà êîíôèãóğèğàíè ïğàâèëíî. .<BR><em>Äîñòúï çà \'Àäìèí\' ïîòğåáèòåëè ñàìî!</em>',
		'mlang_tabs_tab' => 'Àäìèíèñòğàòîğ íà ïîòğåáèòåëèòå',
	),
	'br' => Array (
