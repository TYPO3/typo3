...
class TemplateView extends AbstractTemplateView {
	...
	public function __construct() {
		...
		$this->injectObjectManager(\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Extbase\\Object\\ObjectManagerInterface'));
	...
	protected function expandPatterns(array &$patterns, $search, array $replacements) {
		...
		foreach ($patterns as $pattern) {
			foreach ($replacements as $replacement) {
				$patternsWithReplacements[] = \TYPO3\CMS\Core\Utility\GeneralUtility::fixWindowsFilePath(str_replace($search, $replacement, $pattern));
			}
		}
