 ...
 * argument is set to true, the resulting image tag contains the source of the image in a base 64
 * encoded form.
 *
 * ..  code-block:: html
 * 
...
final class ImageViewHelper extends AbstractTagBasedViewHelper
{
    ...
    public function initializeArguments(): void
    {
        ...
        $this->registerArgument('base64', 'bool', 'base64 encoded image src: Adds the image data inline, Base64 encoded the images "src" attribute. Useful for FluidEmail templates.', false, false);
    }
