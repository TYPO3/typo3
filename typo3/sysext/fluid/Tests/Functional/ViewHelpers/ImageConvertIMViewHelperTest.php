...
final class ImageConvertIMViewHelperTest extends FunctionalTestCase
{
    ...
    public static function filesConvertedToJpegFileFormatUsingImageMagickDataProvider(): \Generator
    {
        ...
        yield 'svg to jpg' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/file.svg" width="481" height="203" alt="svg-to-jpg" />',
    ...
    public static function filesConvertedToWebpFileFormatUsingImageMagickDataProvider(): \Generator
    {
        ...
        yield 'svg to webp' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/file.svg" width="481" height="203" alt="svg-to-webp" />',
            'message' => 'File extension is "svg" for "svg" (unprocessed/non-web format/not-enforceable)',
        ];
        // invalid
        yield 'avi to webp' => [
    ...
    public static function filesConvertedToAvifFileFormatUsingImageMagickDataProvider(): \Generator
    {
        ...
        yield 'ai to avif' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" alt="ai-to-avif" />',
        ...
        yield 'avif to avif' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="60" alt="avif-to-avif" />',
        ...
        yield 'bmp to avif' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" alt="bmp-to-avif" />',
        ...
        yield 'gif to avif' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" alt="gif-to-avif" />',
        ...
        yield 'jpg to avif' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" alt="jpg-to-avif" />',
        ...
        yield 'pdf to avif' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" alt="pdf-to-avif" />',
        ...
        yield 'png to avif' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" alt="png-to-avif" />',
        ...
        yield 'tif to avif' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" alt="tif-to-avif" />',
        ...
        yield 'webp to avif' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" alt="webp-to-avif" />',
    ...
    public static function filesConvertedToTifFileFormatUsingImageMagickDataProvider(): \Generator
    {
        ...
        yield 'svg to tif' => [
            ...
            'contentMatchRegExp' => '<img src="fileadmin/file.svg" width="481" height="203" alt="svg-to-tif" />',
            'message' => 'File extension is "svg" for "svg" (unprocessed/non-web format/not-enforceable)',
        ];
        // invalid
        yield 'avi to tif' => [
