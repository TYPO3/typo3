...
final class ImageConvertIMViewHelperTest extends FunctionalTestCase
{
    ...
    public static function filesConvertedToDefaultFileFormatUsingImageMagickDataProvider(): \Generator
    {
        ...
        yield 'svg to default' => [
            ...
            'message' => 'File extension is "svg" for "svg" (unprocessed/original/pass-though-format)',
        ];
        // invalid
    ...
    #[DataProvider('filesConvertedToDefaultFileFormatUsingImageMagickDataProvider')]
    #[Test]
    public function filesConvertedToDefaultFileFormatUsingImageMagick(string $template, string $contentMatchRegExp, string $message): void
    {
    ...
    public static function filesConvertedToJpegFileFormatUsingImageMagickDataProvider(): \Generator
    {
        // web-format
        yield 'ai to jpg' => [
        ...
        yield 'jpg to jpg' => [
            ...
            'message' => 'File extension is "jpg" for "jpg" (processed/forced)',
        ];
        yield 'pdf to jpg' => [
        ...
        // pass-through-format - ImageMagick cannot write SVG
        yield 'svg to jpg' => [
            'template' => '<f:image src="fileadmin/file.svg" fileExtension="jpg" width="80" alt="svg-to-jpg" />',
            'contentMatchRegExp' => '<img alt="svg-to-jpg" src="fileadmin/file.svg" width="481" height="203" />',
            'message' => 'File extension is "svg" for "svg" (unprocessed/non-web format/not-enforceable)',
        ];
        // invalid
        yield 'avi to jpg' => [
        ...
        yield 'exe to jpg' => [
            ...
            'message' => 'File extension is "exe" for "exe" (unprocessed/invalid/not-enforceable)',
        ];
        yield 'zip to jpg' => [
            ...
            'message' => 'File extension is "zip" for "zip" (unprocessed/invalid/not-enforceable)',
        ];
    }

    #[DataProvider('filesConvertedToJpegFileFormatUsingImageMagickDataProvider')]
    #[Test]
    public function filesConvertedToJpegFileFormatUsingImageMagick(string $template, string $contentMatchRegExp, string $message): void
    {
        self::assertSame('ImageMagick', $GLOBALS['TYPO3_CONF_VARS']['GFX']['processor']);
        self::assertMatchesRegularExpression(sprintf('@\s*%s\s*@', $contentMatchRegExp), $this->renderTemplate($template), $message);
    }

    public static function filesConvertedToWebpFileFormatUsingImageMagickDataProvider(): \Generator
    {
        // web-format
        yield 'ai to webp' => [
        ...
        yield 'webp to webp' => [
            ...
            'message' => 'File extension is "webp" for "webp" (processed/forced)',
        ];
        // non-web-format
        yield 'eps to webp' => [
        ...
        yield 'svg to webp' => [
            ...
            'contentMatchRegExp' => '<img alt="svg-to-webp" src="fileadmin/file.svg" width="481" height="203" />',
            'message' => 'File extension is "svg" for "svg" (unprocessed/non-web format/not-enforceable)',
        ];
        // invalid
        yield 'avi to webp' => [
    ...
    #[DataProvider('filesConvertedToWebpFileFormatUsingImageMagickDataProvider')]
    #[Test]
    public function filesConvertedToWebpFileFormatUsingImageMagick(string $template, string $contentMatchRegExp, string $message): void
    {
        self::assertSame('ImageMagick', $GLOBALS['TYPO3_CONF_VARS']['GFX']['processor']);
        self::assertMatchesRegularExpression(sprintf('@\s*%s\s*@', $contentMatchRegExp), $this->renderTemplate($template), $message);
    }

    public static function filesConvertedToAvifFileFormatUsingImageMagickDataProvider(): \Generator
    {
        // web-format
        yield 'ai to avif' => [
            'template' => '<f:image src="fileadmin/file.ai" fileExtension="avif" width="80" alt="ai-to-avif" />',
            'contentMatchRegExp' => '<img alt="ai-to-avif" src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" />',
            'message' => 'File extension is "avif" for "ai" (processed/forced)',
        ];
        yield 'avif to avif' => [
            'template' => '<f:image src="fileadmin/file.avif" fileExtension="avif" width="80" alt="avif-to-avif" />',
            'contentMatchRegExp' => '<img alt="avif-to-avif" src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="60" />',
            'message' => 'File extension is "avif" for "avif" (processed/forced)',
        ];
        yield 'bmp to avif' => [
            'template' => '<f:image src="fileadmin/file.bmp" fileExtension="avif" width="80" alt="bmp-to-avif" />',
            'contentMatchRegExp' => '<img alt="bmp-to-avif" src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" />',
            'message' => 'File extension is "avif" for "bmp" (processed/forced)',
        ];
        yield 'gif to avif' => [
            'template' => '<f:image src="fileadmin/file.gif" fileExtension="avif" width="80" alt="gif-to-avif" />',
            'contentMatchRegExp' => '<img alt="gif-to-avif" src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" />',
            'message' => 'File extension is "avif" for "gif" (processed/forced)',
        ];
        yield 'jpg to avif' => [
            'template' => '<f:image src="fileadmin/file.jpg" fileExtension="avif" width="80" alt="jpg-to-avif" />',
            'contentMatchRegExp' => '<img alt="jpg-to-avif" src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" />',
            'message' => 'File extension is "avif" for "jpg" (processed/forced)',
        ];
        yield 'pdf to avif' => [
            'template' => '<f:image src="fileadmin/file.pdf" fileExtension="avif" width="80" alt="pdf-to-avif" />',
            'contentMatchRegExp' => '<img alt="pdf-to-avif" src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" />',
            'message' => 'File extension is "avif" for "pdf" (processed/forced)',
        ];
        yield 'png to avif' => [
            'template' => '<f:image src="fileadmin/file.png" fileExtension="avif" width="80" alt="png-to-avif" />',
            'contentMatchRegExp' => '<img alt="png-to-avif" src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" />',
            'message' => 'File extension is "avif" for "png" (processed/forced)',
        ];
        yield 'tif to avif' => [
            'template' => '<f:image src="fileadmin/file.tif" fileExtension="avif" width="80" alt="tif-to-avif" />',
            'contentMatchRegExp' => '<img alt="tif-to-avif" src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" />',
            'message' => 'File extension is "avif" for "tif" (processed/forced)',
        ];
        yield 'webp to avif' => [
            'template' => '<f:image src="fileadmin/file.webp" fileExtension="avif" width="80" alt="webp-to-avif" />',
            'contentMatchRegExp' => '<img alt="webp-to-avif" src="fileadmin/_processed_/.*/.*/csm_file_.*\.avif" width="80" height="34" />',
            'message' => 'File extension is "avif" for "webp" (processed/forced)',
        ];
        // non-web-format
        yield 'eps to avif' => [
    ...
    #[DataProvider('filesConvertedToAvifFileFormatUsingImageMagickDataProvider')]
    #[Test]
    public function filesConvertedToAvifFileFormatUsingImageMagick(string $template, string $contentMatchRegExp, string $message): void
    {
        self::assertSame('ImageMagick', $GLOBALS['TYPO3_CONF_VARS']['GFX']['processor']);
        self::assertMatchesRegularExpression(sprintf('@\s*%s\s*@', $contentMatchRegExp), $this->renderTemplate($template), $message);
    }

    public static function filesConvertedToTifFileFormatUsingImageMagickDataProvider(): \Generator
    {
        // web-format
        yield 'ai to tif' => [
        ...
        yield 'svg to tif' => [
            ...
            'contentMatchRegExp' => '<img alt="svg-to-tif" src="fileadmin/file.svg" width="481" height="203" />',
            'message' => 'File extension is "svg" for "svg" (unprocessed/non-web format/not-enforceable)',
        ];
        // invalid
        yield 'avi to tif' => [
    ...
    #[DataProvider('filesConvertedToTifFileFormatUsingImageMagickDataProvider')]
    #[Test]
    public function filesConvertedToTifFileFormatUsingImageMagick(string $template, string $contentMatchRegExp, string $message): void
    {
        self::assertSame('ImageMagick', $GLOBALS['TYPO3_CONF_VARS']['GFX']['processor']);
        self::assertMatchesRegularExpression(sprintf('@\s*%s\s*@', $contentMatchRegExp), $this->renderTemplate($template), $message);
    }
