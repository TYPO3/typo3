...
class TextareaViewHelperTest extends FunctionalTestCase
{
    ...
    public function renderCallsSetErrorClassAttribute(): void
    {
        ...
        $view->setTemplateSource('<f:form object="{formObject}" fieldNamePrefix="myFieldPrefix" objectName="myObjectName"><f:form.textarea property="someProperty" errorClass="myError" /></f:form>');
