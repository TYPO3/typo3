...
class DocumentController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function listAction() {
		...
		$hideDocuments = $GLOBALS['BE_USER']->getTSConfigVal('mod.help_DocumentationDocumentation.documents.hide');
		...
		$showDocuments = $GLOBALS['BE_USER']->getTSConfigVal('mod.help_DocumentationDocumentation.documents.show');
