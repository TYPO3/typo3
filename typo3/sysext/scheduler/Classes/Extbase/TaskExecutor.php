<?php
namespace TYPO3\CMS\Scheduler\Extbase;
 ...
 * Task Executor
 *
 * Takes a \TYPO3\CMS\Scheduler\Extbase\Task and executes the CommandController command
 * defined therein.
 */
class TaskExecutor implements \TYPO3\CMS\Core\SingletonInterface {
	 ...
	 *
	 * @param \TYPO3\CMS\Scheduler\Extbase\Task $task the task to execute
	 * @return void
	 */
	public function execute(\TYPO3\CMS\Scheduler\Extbase\Task $task) {
