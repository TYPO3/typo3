		...
		'category' => array(
			...
			'config' => array(
				...
				'items' => array(
					...
					array('LLL:EXT:sys_note/Resources/Private/Language/locallang_tca.xlf:sys_note.category.I.2', '2', 'sysext/t3skin/icons/ext/sys_note/icon-note.png'),
					array('LLL:EXT:sys_note/Resources/Private/Language/locallang_tca.xlf:sys_note.category.I.3', '3', 'sysext/t3skin/icons/ext/sys_note/icon-todo.png'),
					array('LLL:EXT:sys_note/Resources/Private/Language/locallang_tca.xlf:sys_note.category.I.4', '4', 'sysext/t3skin/icons/ext/sys_note/icon-template.png')
				),
				'default' => '0'
			)
		),
