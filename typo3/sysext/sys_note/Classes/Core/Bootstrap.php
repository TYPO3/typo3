...
class Bootstrap {
	...
	/**
	 * Do not rename, the property name is given via get_object_vars to extbase
	...
	public function run($actionName = 'index', array $arguments = array()) {
		...
		// WARNING, magic involved! The second parameter is a key-value of class properties and
		// values: array('vendorName' => 'TYPO3\CMS', ...)
		$content = $extbaseBootstrap->run('', get_object_vars($this));
