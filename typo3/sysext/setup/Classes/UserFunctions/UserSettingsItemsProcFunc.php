...
namespace TYPO3\CMS\Setup\UserFunctions;
...
final readonly class UserSettingsItemsProcFunc
{
    ...
    public function addLanguageItems(array &$params): void
    {
        ...
        foreach ($items as $languageCode => $name) {
            ...
            if ($languageCode === 'ch') {
                $labelIdentifier = 'LLL:EXT:setup/Resources/Private/Language/locallang.xlf:warning.chineseSimplified';
            } else {
    ...
    public function renderStartModuleSelect(array &$params): void
    {
        ...
        $params['items'][] = ['label' => 'LLL:EXT:setup/Resources/Private/Language/setup.messages.xlf:startModule.firstInMenu', 'value' => ''];
    ...
    {
        $params['items'][] = ['label' => 'LLL:EXT:setup/Resources/Private/Language/setup.messages.xlf:datetime_first_day_of_week.inherit', 'value' => ''];
