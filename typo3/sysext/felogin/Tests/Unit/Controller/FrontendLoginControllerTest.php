...
class FrontendLoginTest extends \tx_phpunit_testcase {
	...
	/**
	 * Data provider for validateRedirectUrlKeepsCleanUrls
	 *
	 * @return array
	 */
	public function validateRedirectUrlKeepsCleanUrlsDataProvider() {
		return array(
	...
	/**
	 * @test
	 * @dataProvider validateRedirectUrlKeepsCleanUrlsDataProvider
	 * @param string $url Clean URL to test
	 */
	public function validateRedirectUrlKeepsCleanUrls($url) {
		$this->setUpDatabaseMock();
	 ...
	 * @return array
	 */
	public function validateRedirectUrlClearsInvalidUrlsInSubdirectoryDataProvider() {
		return array(
	...
	/**
	 * @test
	 * @dataProvider validateRedirectUrlClearsInvalidUrlsInSubdirectoryDataProvider
	 * @param string $url Invalid Url
	 */
	public function validateRedirectUrlClearsInvalidUrlsInSubdirectory($url) {
	...
	/**
	 * Data provider for validateRedirectUrlKeepsCleanUrlsInSubdirectory
	 *
	 * @return array
	 */
	public function validateRedirectUrlKeepsCleanUrlsInSubdirectoryDataProvider() {
		return array(
	...
	/**
	 * @test
	 * @dataProvider validateRedirectUrlKeepsCleanUrlsInSubdirectoryDataProvider
	 * @param string $url Invalid Url
	 */
	public function validateRedirectUrlKeepsCleanUrlsInSubdirectory($url) {
		$this->testSitePath = '/subdir/';
		$this->setUpFakeSitePathAndHost();
		$this->setUpDatabaseMock();
		$this->assertEquals($url, $this->accessibleFixture->_call('validateRedirectUrl', $url));
