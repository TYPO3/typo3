...
class FileList extends \TYPO3\CMS\Backend\RecordList\AbstractRecordList {
	...
	/**
	 * Create delete record url for single file.
	 *
	 ...
	 * @return string
	 */
	public function deleteRecordUrl($table, $uid, $redirectUrl)
	{
		return $this->clipObj->backPath .
			'tce_db.php?cmd[' . $table . '][' . $uid . '][delete]=1' .
			\TYPO3\CMS\Backend\Utility\BackendUtility::getUrlToken('tceAction') .
			'&redirect=' . rawurlencode($redirectUrl) . '&vC=' .
