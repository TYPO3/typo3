	...
	public function main() {
		...
		if ($this->folderObject) {
					...
					if (top.TYPO3.FileUploadWindow.isFlashAvailable()) {
						...
						function initFlashUploader(event) {
							...
							if (typeof(event)=="string") {
								...
								target = "' . ($this->folderObject ? $this->folderObject->getCombinedIdentifier() : '') . '";
							}
			...
			if ($this->errorMessage) {
				...
				$content = $this->doc->moduleBody(array(), array_merge(array('LEVEL_UP' => '', 'REFRESH' => '', 'PASTE' => ''), $this->getButtons()), array('CSH' => '', 'TITLE' => '', 'FOLDER_INFO' => '', 'PAGE_ICON' => '', 'FUNC_MENU' => '', 'CONTENT' => $this->errorMessage->render()));
			}
