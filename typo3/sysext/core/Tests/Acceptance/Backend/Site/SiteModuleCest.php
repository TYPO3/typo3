...
class SiteModuleCest
{
     ...
     */
    public function editExistingRecord(BackendTester $I, ModalDialog $modalDialog)
    {
     ...
     * @param ModalDialog $modalDialog
     */
    public function defaultFrontendRendering(BackendTester $I, PageTree $pageTree, ModalDialog $modalDialog)
    {
