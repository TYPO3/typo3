...
class FileStorageTreeFilterCest
{
    ...
    public function filterTreeForFolder(BackendTester $I)
    {
    ...
    public function clearFilterReloadsTreeWithoutFilterApplied(BackendTester $I)
    {
        $I->fillField($this->filterInputField, 'styleguide');
        $this->waitForAjaxRequestToFinish($I);
    ...
    protected function clearTreeFilters(BackendTester $I): void
    {
        $I->click($this->filterInputFieldClearButton);
        $I->click($this->reloadButton);
        $I->cantSeeElement($this->filterInputFieldClearButton);
    ...
    protected function createNewFolder(BackendTester $I): void
    {
        // Create a new folder
