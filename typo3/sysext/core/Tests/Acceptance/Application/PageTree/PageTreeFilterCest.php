...
{
    private string $filterInputField = '#typo3-pagetree-toolbar .search-input';
    private string $pageTreeSecondaryOptions = '#typo3-pagetree-toolbar [data-bs-toggle="dropdown"]';
    private string $pageTreeReloadButton = '#typo3-pagetree-toolbar typo3-backend-icon[identifier=actions-refresh]';
