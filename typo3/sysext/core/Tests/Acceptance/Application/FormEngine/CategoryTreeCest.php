...
final class CategoryTreeCest
{
    ...
    public function editCategoryItem(ApplicationTester $I): void
    {
        ...
        $I->click('.nodes-container [role="treeitem"][data-id="7"] .node-contentlabel');
        $I->click('.nodes-container [role="treeitem"][data-id="3"] .node-contentlabel');
        $I->click('button[name="_savedok"]');
        // Wait for tree and check if isset level-1-4
        $I->waitForElement('.nodes-container .nodes-list');
