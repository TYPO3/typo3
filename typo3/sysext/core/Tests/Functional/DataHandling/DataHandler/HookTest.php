...
final class HookTest extends FunctionalTestCase
{
    ...
    private const int VALUE_ContentId = 297;
    private const string TABLE_Content = 'tt_content';
    private const string TABLE_Hotel = 'tx_testirreforeignfield_hotel';
    private const string TABLE_Category = 'sys_category';
    private const string FIELD_ContentHotel = 'tx_testirreforeignfield_hotels';
