...
namespace TYPO3\CMS\Core\Tests\Functional\DataScenarios\Uuid\WorkspacesModify;
...
final class ActionTest extends AbstractActionWorkspacesTestCase
{
    ...
    public function moveRecord(): void
    {
        ...
        self::assertEquals(self::VALUE_OriginalUuid, $records[0]['unique_identifier']);
        self::assertNotSame(self::VALUE_OriginalUuid, $records[1]['unique_identifier']);
    }
}
