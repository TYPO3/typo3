...
namespace TYPO3\CMS\Core\Tests\Functional\DataScenarios\UniqueValue\WorkspacesPublishAll;
...
/**
 * Values that end up in the live workspace after publishing the whole workspace.
 *
