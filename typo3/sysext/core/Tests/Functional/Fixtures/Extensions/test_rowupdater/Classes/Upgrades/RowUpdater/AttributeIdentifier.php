 ...
 */
#[AsRowUpdater('attributeRegisteredRowUpdaterWithCustomIdentifier')]
class AttributeIdentifier implements RowUpdaterInterface
{
    public function getTitle(): string
    {
        return 'RowUpdater test implementation using php attribute registration with identifier.';
    }
