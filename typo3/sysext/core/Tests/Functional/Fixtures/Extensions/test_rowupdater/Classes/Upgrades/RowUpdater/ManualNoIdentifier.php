...
/**
 * RowUpdater test fixture implementation using `Services.yaml` registration.
 */
class ManualNoIdentifier implements RowUpdaterInterface
{
    public function getTitle(): string
    {
        return 'RowUpdater test implementation using manual registration without identifier.';
    }
