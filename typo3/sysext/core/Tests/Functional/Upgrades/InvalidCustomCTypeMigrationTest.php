...
use TYPO3\CMS\Core\Tests\Functional\Upgrades\Fixtures\InvalidCustomCTypeMigrationEmptyArrayKey;
use TYPO3\CMS\Core\Tests\Functional\Upgrades\Fixtures\InvalidCustomCTypeMigrationEmptyArrayValue;
...
final class InvalidCustomCTypeMigrationTest extends FunctionalTestCase
{
    ...
    public function invalidGetListTypeToCTypeMappingArrayWithEmptyArrayKeyThrowsException(): void
    {
        ...
        new InvalidCustomCTypeMigrationEmptyArrayKey($connectionPool);
    }
    ...
    public function invalidGetListTypeToCTypeMappingArrayWithEmptyArrayValueThrowsException(): void
    {
        ...
        $connectionPool = $this->get(ConnectionPool::class);
        new InvalidCustomCTypeMigrationEmptyArrayValue($connectionPool);
    }
}
