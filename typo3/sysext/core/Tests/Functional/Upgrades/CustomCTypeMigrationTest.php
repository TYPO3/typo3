...
use TYPO3\CMS\Core\Tests\Functional\Upgrades\Fixtures\CustomCTypeMigration;
use TYPO3\TestingFramework\Core\Functional\FunctionalTestCase;

final class CustomCTypeMigrationTest extends FunctionalTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new CustomCTypeMigration($connectionPool);
    }
