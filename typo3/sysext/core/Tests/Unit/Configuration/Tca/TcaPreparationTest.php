...
{
    public static function controlSectionIntegrityIsEnsuredDataProvider(): \Generator
    {
        yield 'filled columns' => [
            [
                'aTable' => [
                    'ctrl' => [
                        'origUid' => 'aField',
    ...
    #[DataProvider('controlSectionIntegrityIsEnsuredDataProvider')]
    #[Test]
    public function ctrlIntegrityColumnsAreAvailable(array $input, array $expected): void
    {
