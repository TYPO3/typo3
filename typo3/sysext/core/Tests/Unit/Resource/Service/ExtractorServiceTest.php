...
final class ExtractorServiceTest extends UnitTestCase
{
    ...
    public function extractMetaDataComposesDataByAvailableExtractorsWithDifferentPriorities(
        ...
        $extractorObject1->expects($this->any())->method('getFileTypeRestrictions')->willReturn([FileType::IMAGE->value]);
        ...
        $extractorObject2->expects($this->any())->method('getFileTypeRestrictions')->willReturn([FileType::IMAGE->value]);
