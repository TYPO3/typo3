...
class FlashMessageQueueTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @var \TYPO3\CMS\Frontend\Authentication\FrontendUserAuthtenication|\PHPUnit_Framework_MockObject_MockObject
	 */
	protected $frontendUser;

	public function setUp() {
		$this->frontendUser = $this->getMock('TYPO3\CMS\Frontend\Authentication\FrontendUserAuthtenication', array('dummy'));
	 ...
	 * @test
	 */
	public function userSessionInitiliallyIsEmpty() {
	...
	public function getAllMessagesAndFlushClearsSessionStack() {
		...
		/** @var $frontendUser \TYPO3\CMS\Frontend\Authentication\FrontendUserAuthtenication */
