...
class SqlParserTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	 ...
	 * @param string $message Custom name for data set
	 */
	public function trimSqlReallyTrimsAllWhitespace($sql, $expected, $message) {
	...
	public function trimSqlReallyTrimsAllWhitespaceDataProvider() {
		return array(
			array('SELECT * FROM test WHERE 1=1;', 'SELECT * FROM test WHERE 1=1 ', 'Nothing to trim'),
			array('SELECT * FROM test WHERE 1=1; ', 'SELECT * FROM test WHERE 1=1 ', 'Space after ;'),
			array('SELECT * FROM test WHERE 1=1 ;', 'SELECT * FROM test WHERE 1=1 ', 'Space before ;'),
			array('SELECT * FROM test WHERE 1=1 ; ', 'SELECT * FROM test WHERE 1=1 ', 'Space before and after ;'),
			array('SELECT * FROM test WHERE 1=1' . LF . ';', 'SELECT * FROM test WHERE 1=1 ', 'Linefeed after ;'),
			array('SELECT * FROM test WHERE 1=1;' . LF, 'SELECT * FROM test WHERE 1=1 ', 'Linefeed before ;'),
			array('SELECT * FROM test WHERE 1=1' . LF . ';' . LF, 'SELECT * FROM test WHERE 1=1 ', 'Linefeed before and after ;'),
			array('SELECT * FROM test WHERE 1=1' . TAB . ';', 'SELECT * FROM test WHERE 1=1 ', 'Tab after ;'),
			array('SELECT * FROM test WHERE 1=1;' . TAB, 'SELECT * FROM test WHERE 1=1 ', 'Tab before ;'),
			array('SELECT * FROM test WHERE 1=1' . TAB . ';' . TAB, 'SELECT * FROM test WHERE 1=1 ', 'Tab before and after ;'),
		);
	}
