...
final class UuidDataTypeTest extends AbstractDataTypeBaseTestCase
{
    #[Test]
    public function canParseUuidDataType(): void
    {
        self::assertInstanceOf(UuidDataType::class, $this->createSubject('UUID')->dataType);
    }
}
