 ...
 */
class IpAnonymizationUtilityTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @return array
     */
    public function anonymizeIpReturnsCorrectValueDataProvider()
    {
        return [
            'empty address' => ['', 1, ''],
     ...
     */
    public function anonymizeIpReturnsCorrectValue($address, $mask = null, $expected)
    {
     ...
     * @expectedExceptionCode 1519739203
     */
