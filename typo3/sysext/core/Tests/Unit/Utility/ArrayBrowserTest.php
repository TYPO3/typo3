...
/**
 * Testcase for the \TYPO3\CMS\Core\Utility\ArrayBrowser class in the TYPO3 Core.
 *
 * @package TYPO3
 * @subpackage t3lib
...
class ArrayBrowserTest extends \tx_phpunit_testcase {
	...
	/**
	 * @var \TYPO3\CMS\Core\Utility\ArrayBrowser
	 */
	private $fixture;

	public function setUp() {
		$this->fixture = new \TYPO3\CMS\Core\Utility\ArrayBrowser();
	}
