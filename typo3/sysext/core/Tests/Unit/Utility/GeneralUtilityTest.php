...
text with a ' . $urlMatch . '$|s'),
	...
	public function testGetUrlRedirects() {
		...
		Utility\GeneralUtility::setTestModeOption(Utility\GeneralUtility::TESTOPTION_NOFOLLOWLOCATION, TRUE);
		$content = Utility\GeneralUtility::getUrl($url);
		Utility\GeneralUtility::setTestModeOption(Utility\GeneralUtility::TESTOPTION_NOFOLLOWLOCATION, FALSE);
	 ...
	 * @test
	 */
	public function testGetUrlRedirectsWithBrokenCurl() {
		if (!$GLOBALS['TYPO3_CONF_VARS']['SYS']['curlUse']) {
			$this->markTestSkipped('This test makes sense only if $TYPO3_CONF_VARS[\'SYS\'][\'curlUse\'] is enabled.');
		}
		...
		Utility\GeneralUtility::setTestModeOption(Utility\GeneralUtility::TESTOPTION_NOFOLLOWLOCATION, TRUE);
		Utility\GeneralUtility::setTestModeOption(Utility\GeneralUtility::TESTOPTION_NOREDIRECTURL, TRUE);
		$content = Utility\GeneralUtility::getUrl($url);
		Utility\GeneralUtility::setTestModeOption(Utility\GeneralUtility::TESTOPTION_NOFOLLOWLOCATION, FALSE);
		Utility\GeneralUtility::setTestModeOption(Utility\GeneralUtility::TESTOPTION_NOREDIRECTURL, FALSE);
	 ...
	 * @test
	 */
	public function testGetUrlRedirectsPlusHeadersWithBrokenCurl() {
		if (!$GLOBALS['TYPO3_CONF_VARS']['SYS']['curlUse']) {
			$this->markTestSkipped('This test makes sense only if $TYPO3_CONF_VARS[\'SYS\'][\'curlUse\'] is enabled.');
		}
		...
		Utility\GeneralUtility::setTestModeOption(Utility\GeneralUtility::TESTOPTION_NOFOLLOWLOCATION, TRUE);
		Utility\GeneralUtility::setTestModeOption(Utility\GeneralUtility::TESTOPTION_NOREDIRECTURL, TRUE);
		$content = Utility\GeneralUtility::getUrl($url, 1);
		Utility\GeneralUtility::setTestModeOption(Utility\GeneralUtility::TESTOPTION_NOFOLLOWLOCATION, FALSE);
		Utility\GeneralUtility::setTestModeOption(Utility\GeneralUtility::TESTOPTION_NOREDIRECTURL, FALSE);

		self::assertContains('Success.', $content);
		self::assertContains('Date:', $content);
	}
