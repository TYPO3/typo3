...
{
    private const VALID_HASH = '$argon2id$v=19$m=65536,t=4,p=1$TlluZEF0cXRDSE4xSmxYUQ$xlrkRszoVY9icCjHV7sDP3+QOZ2XOFxFEJdjJeNIG3I';
    private const DEFAULT_OPTIONS = [
        'memory_cost' => 65536,
        'time_cost' => 4,
        'threads' => 1,
    ];
    private const FAST_OPTIONS = [
        'memory_cost' => 8,
        'time_cost' => 1,
        'threads' => 1,
    ];
    ...
    public function checkPasswordReturnsTrueForHashedPasswordWithValidAlphaCharClassPassword(): void
    {
        $password = 'aEjOtY';
        $subject = new Argon2idPasswordHash(self::DEFAULT_OPTIONS);
        $hash = password_hash($password, PASSWORD_ARGON2ID, self::FAST_OPTIONS);
