...
class BootstrapTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	public function checkUtf8DatabaseSettingsInitializesSetDBinit() {
		...
		$testStatementNoMatch = 'someTotallyUselessStatement';
		$GLOBALS['TYPO3_CONF_VARS']['SYS']['setDBinit'] = $testStatementNoMatch;
		$bootstrapInstance->_call('checkUtf8DatabaseSettingsOrDie');
		$this->assertEquals($testStatementNoMatch . $defaultValue, $GLOBALS['TYPO3_CONF_VARS']['SYS']['setDBinit']);

		// string that matches regex is not touched
		$testStatementMatch1 = 'SET NAMES "utf8";';
		$GLOBALS['TYPO3_CONF_VARS']['SYS']['setDBinit'] = $testStatementMatch1;
		$bootstrapInstance->_call('checkUtf8DatabaseSettingsOrDie');
		$this->assertEquals($testStatementMatch1, $GLOBALS['TYPO3_CONF_VARS']['SYS']['setDBinit']);

		// another string that matches regex is not touched
		$testStatementMatch2 = 'myUselessString; SET NAMES "utf8"; myOtherUselessString;';
		$GLOBALS['TYPO3_CONF_VARS']['SYS']['setDBinit'] = $testStatementMatch2;
		$bootstrapInstance->_call('checkUtf8DatabaseSettingsOrDie');
		$this->assertEquals($testStatementMatch2, $GLOBALS['TYPO3_CONF_VARS']['SYS']['setDBinit']);

		// another string that matches regex is not touched
		$testStatementMatch3 = 'SET NAMES "utf8 COLLATE utf8_unicode_ci;';
		$GLOBALS['TYPO3_CONF_VARS']['SYS']['setDBinit'] = $testStatementMatch3;
		$bootstrapInstance->_call('checkUtf8DatabaseSettingsOrDie');
		$this->assertEquals($testStatementMatch3, $GLOBALS['TYPO3_CONF_VARS']['SYS']['setDBinit']);
