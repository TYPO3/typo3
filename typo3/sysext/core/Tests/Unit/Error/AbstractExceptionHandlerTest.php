 ...
 */
class AbstractExceptionHandlerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    /**
     ...
     */
    public function anonymizeTokenReturnsCorrectModifiedUrl($originalUrl, $expectedUrl)
    {
