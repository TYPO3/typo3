...
use TYPO3\CMS\Core\Settings\Type\NumberType;
use TYPO3\TestingFramework\Core\Unit\UnitTestCase;

final class NumberTypeTest extends UnitTestCase
{
    ...
    #[DataProvider('allowedValuesDataProvider')]
    #[Test]
    public function allowedValuesAreTransformed(mixed $value, int|float $expected): void
    {
        $intType = new NumberType(new NullLogger());
    ...
    public static function disallowedValuesDataProvider(): array
    {
        return [
            'true' => [true],
            'false' => [false],
            // @todo: MathUtility::canBeInterpretedAsFloat incorrectly marks this as valid
