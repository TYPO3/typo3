...
class TypoScriptParserTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * Data provider for setValHandlesDoubleQoutesInTypoScriptSetupKeys
	 */
	public function setValHandlesDoubleQoutesInTypoScriptSetupKeysDataProvider() {
		return array(
			'find qoutes in the middle of keys' => array(
				'foo.bar."settings.key".value',
				array('foobar'),
				array(
					'foo.' => array(
						'bar.' => array(
			...
			'find quotes at the end of keys' => array(
				'foo.bar."settings.key"',
				array('foobar'),
				array(
					'foo.' => array(
						'bar.' => array(
	...
	/**
	 * @param string $keys The keys of the TypoScript option
	 * @param array $value The value of the TypoScript option
	 * @param array $expected The expected result of the test
	 * @test
	 * @dataProvider setValHandlesDoubleQoutesInTypoScriptSetupKeysDataProvider
	 */
	public function setValHandlesDoubleQoutesInTypoScriptSetupKeys($keys, array $value, array $expected) {
		$setup = array();
