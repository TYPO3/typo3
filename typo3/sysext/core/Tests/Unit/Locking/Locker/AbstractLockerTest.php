...
class AbstractLockerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * Test validates that if locking could not be released lock-could-not-be-released-exception will be thrown.
	 *
	 * @return void
	...
	/**
	 * Test validates that if locking could not be released within internal doRelease function and a lock-could-not-be-released-exception has been thrown it will be passed through the api.
	 *
	 * @return void
	 * @expectedException \TYPO3\CMS\Core\Locking\Exception\LockCouldNotBeReleasedException
	 * @test
