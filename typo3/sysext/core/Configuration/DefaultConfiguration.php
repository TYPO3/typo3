...
return array(
	...
	'FE' => array( // Configuration for the TypoScript frontend (FE). Nothing here relates to the administration backend!
		...
		'pageForbidden_handling_statheader' => 'HTTP/1.0 403 Forbidden',		// If 'pageNotFound_handling' is enabled, this string will always be sent as header when access is forbidden.
