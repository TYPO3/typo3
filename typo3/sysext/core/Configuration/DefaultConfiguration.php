					...
					pages {
						...
						items {
							...
							430 {
								...
								spriteIcon = actions-edit-hide
								displayCondition = getOverlayRecord|hidden = 0 && overlayCanBeDisabledAndEnabled != 0 && getLanguage > 0
							...
							460 {
								...
								spriteIcon = actions-edit-unhide
								displayCondition = getOverlayRecord|hidden = 1 && overlayCanBeDisabledAndEnabled != 0  && getLanguage > 0
							...
							550 {
								...
								spriteIcon = actions-page-open
								displayCondition = overlayCanBeEdited != 0 && getLanguage > 0
