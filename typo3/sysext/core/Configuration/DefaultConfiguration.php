...
return array(
	...
	'SYS' => array(
		...
		't3lib_cs_convMethod' => '',			// String (values: "mbstring", "iconv", "recode", "internal"for homemade PHP-code; defaults to autodetection). Defines which of these PHP-features to use for various charset conversion functions in t3lib_cs. Using integrated functions instead of PHP-code will speed up charset conversion radically.
		't3lib_cs_utils' => '',					// String (values: "mbstring", "iconv", "internal" for homemade PHP-code; defaults to autodetection). Defines which of these PHP-features to use for various charset processing functions in t3lib_cs. Using integrated functions instead of PHP-code will speed up charset functions radically.
