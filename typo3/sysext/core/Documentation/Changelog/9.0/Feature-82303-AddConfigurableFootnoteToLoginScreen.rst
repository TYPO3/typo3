...
A new option to provide an optional footnote for the login screen has been introduced.
The footnote can provide for example legal information for the login
