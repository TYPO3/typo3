...
The hook :php:`$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/form']['beforeRemoveFromParentRenderable']`
has been removed in favor of the more powerful PSR-14 :php:`TYPO3\CMS\Form\Event\BeforeRenderableIsRemovedFromFormEvent`.
...
Use the :ref:`PSR-14 Event <feature-107528-1758703683>` to allow greater
