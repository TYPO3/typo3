...
property in TYPO3 instances. Instances can use the Backend Template module to
scan for usages.
...
This will add the according CSS to all :typoscript:`PAGE` objects. A more specific
inclusion can be done for single page objecs with :typoscript:`myPage.config.cssInline`.
