...
By raising TYPO3s' symfony dependencies to `6.2` in :issue:`99239`, a couple
of new features were made available for the `expression language`_, which is
used by TYPO3 for its `TypoScript conditions`_.
...
.. _TypoScript conditions: https://docs.typo3.org/m/typo3/reference-typoscript/main/en-us/Conditions/Index.html
