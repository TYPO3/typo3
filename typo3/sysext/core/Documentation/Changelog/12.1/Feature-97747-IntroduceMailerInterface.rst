...
To be able to use your own custom MailerInterface implementation in the TYPO3 core, an
...
By default :php:`TYPO3\CMS\Core\Mail\Mailer` is registered as implementation in `Service.yaml`.
