...
However, the mapping was still used for detecting the language from the user agent,
...
TYPO3 installations which have been maintained for more than 15 years, still using this method,
or still using this legacy language keys.


Migration
=========

Migrate to the official language keys / locales by renaming the language files. It is still highly unlikely that these "old" language keys worked in the past major versions of TYPO3.
