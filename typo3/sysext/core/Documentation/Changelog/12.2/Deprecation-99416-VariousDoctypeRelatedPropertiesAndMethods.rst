...
current doctype — e.g. "is the current page HTML5 compliant.

Various TypoScript properties will instruct PageRenderer as before, there is
no need to use other configuration options. It is however, recommended to use
