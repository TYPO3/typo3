...
When working with File references (sys_file_reference records) within FormEngine,
...
the two other label fields are hard-coded. This is especially useful to override such a label
when only a certain type of media (e.g. just images) or online media of type YouTube.
