...
similar to the backend-variant :php:`$TYPO3_CONF_VARS[BE][versionNumberInFilename]`.


Impact
======

If the option is now set to "false", it behaves as "querystring" before, setting
it to "true", the feature behaves exactly to "embed". The original empty option
...
is automatically migrated. If this is not possible - e.g. configuration in
