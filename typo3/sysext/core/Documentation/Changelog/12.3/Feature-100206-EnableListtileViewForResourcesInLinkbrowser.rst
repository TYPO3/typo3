...
now the parent folder of the selected element folder instead of
showing the contents of the selected resource. The user now sees
...
the linkbrowser and now covers, the filelist module, element
browser and linkbrowser.
