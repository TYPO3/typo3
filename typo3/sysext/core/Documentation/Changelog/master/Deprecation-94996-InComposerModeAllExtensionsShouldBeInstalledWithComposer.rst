...
A deprecation level error message is logged for any extension that is not
...
Now, when `example-extension` is located `packages/example-extension`, it is picked
