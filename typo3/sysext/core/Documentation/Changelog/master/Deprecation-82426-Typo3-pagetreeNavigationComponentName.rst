...
A new name `TYPO3/CMS/Backend/PageTree/PageTreeElement` should be used instead.

Impact
======

Calling :php:`ExtensionUtility::registerModule()` with old navigation component name will trigger a deprecation log entry.

Affected Installations
======================

All installations having custom BE modules passing old navigation component name to :php:`ExtensionUtility::registerModule()`.
