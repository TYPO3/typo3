...
in :php:`TPO3\CMS\Backend\Template\ModuleTemplate` have been deprecated,
...
trigger a deprecation log entry. The extension scanner also detects
...
Inject the corresponding services :php:`TYPO3\CMS\Core\Imaging\IconFacotry`
