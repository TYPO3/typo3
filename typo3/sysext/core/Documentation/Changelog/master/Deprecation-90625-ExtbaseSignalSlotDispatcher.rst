...
TYPO3 has had various methods to extend existing TYPO3 Core functionality via PHP.
...
Since March 2019, a new standards recommendation in PHP - PSR-14 - was put into place, and adopted
...
For this reason, the Extbase SignalSlot Dispatcher has been deprecated in TYPO3 Core.
...
As SignalSlotDispatcher is still in place within TYPO3 Core for backwards-compatibility reasons,
and extensions still have lots of Signals defined, no deprecation warning will be triggered
