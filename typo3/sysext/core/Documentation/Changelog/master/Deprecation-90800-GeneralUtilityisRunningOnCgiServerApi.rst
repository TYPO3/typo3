...
Calling the method from GeneralUtility will trigger a PHP deprecation message.
...
Use the new method instead which works exactly the same :php:`Environment::isRunningOnCgiServer()`.
