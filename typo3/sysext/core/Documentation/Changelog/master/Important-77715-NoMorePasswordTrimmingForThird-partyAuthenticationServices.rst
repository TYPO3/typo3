...
providers - which they can now decide to also trim passwords or keep them as is.

This logic is mostly handled within `processLoginData()`. If the Third-Party
Authentication Provider is extending from Core's AuthenticationService and does
