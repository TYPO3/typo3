...
This works for each field, that defines cropVariants for any :sql:`sys_file_reference` usage.

Impact
======

This will optionally let you disable aspect ratios for a specific field or CType, which is sometimes necessary because the ratio won't fit in the frontend.
