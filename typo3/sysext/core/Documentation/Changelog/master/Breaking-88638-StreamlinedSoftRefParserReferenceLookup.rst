...
:php:`BackendUtility::softRefParserObj()` kept a runtime cache of created objects
...
Replace the global variable access via the API call to BackendUtility, if this
is applicable.
