...
frontend layouts of a page in the `Web Info` module. Therefore a
new entry `Layouts` is available for the Pagetree overview.
...
The `Web Info` module now contains a new Pagetree overview type, which
