...
The following globally available variables in TYPO3 Backend's JavaScript code have been deprecated:
...
have been superseded by TYPO3's Module Menu Component (since 4.5) and the newly introduced Backend Routing Component in JavaScript
since TYPO3 v11.
...
The variables will work and filled as expected in TYPO3 v11, but will not be available anymore in TYPO3 v12.
