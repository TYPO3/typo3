...
The database field `static_lang_isocode` is a reference to a language within the third-party
...
Migrating to TYPO3 v10.0 will remove the field in the Database Comparison View.
...
The field can safely be removed in the Database Comparison View if it is not used by an extension.
