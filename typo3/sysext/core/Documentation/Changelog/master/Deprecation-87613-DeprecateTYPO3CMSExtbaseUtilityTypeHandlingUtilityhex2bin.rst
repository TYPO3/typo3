...
:php:`\TYPO3\CMS\Extbase\Utility\TypeHandlingUtility::hex2bin` has been deprecated and will be removed in TYPO3 11.0.


Impact
======

Calling :php:`\TYPO3\CMS\Extbase\Utility\TypeHandlingUtility::hex2bin` will trigger a deprecation log entry.
