...
The Record Selectors are used when e.g. choosing a Target Page for a
Shortcut-Page, or selecting a Storage Page in a plugin.
...
* Resizing and expand/collapse of the tree area in all modals are available
...
* Only showing specific mount points configurable via
  TSconfig `options.pageTree.altElementBrowserMountPoints`
...
All page- and folder-based trees are now completely streamlined all over TYPO3
