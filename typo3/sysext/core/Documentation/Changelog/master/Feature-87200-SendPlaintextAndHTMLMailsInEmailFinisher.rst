...
The :php:`EmailFinisher` of EXT:form now sends mails with a plaintext and an HTML part. A new option :yaml:`addHtmlPart` has been added to configure if a HTML part should be added to mails.
