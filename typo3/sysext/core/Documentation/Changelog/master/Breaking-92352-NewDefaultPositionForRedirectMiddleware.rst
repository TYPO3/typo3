...
In TYPO3 10 introduced the feature toggle `rearrangedRedirectMiddlewares` to rearrange the middlewares
...
If needed the order of the middlewares can be switched back manually as described in the docs.
