...
Only third-party extension that use this code for frontend-related
image rendering might directly call these PHP methods. Calling these
methods will trigger a PHP deprecation notice.
...
methods. TYPO3's Extension Scanner code can directly detect these changes.
