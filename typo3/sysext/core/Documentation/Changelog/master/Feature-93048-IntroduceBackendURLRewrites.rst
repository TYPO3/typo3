...
the use of speaking urls. This will furthermore enable TYPO3
to introduce deep-linking functionality in the future. By
that, it will be possible to share URLs, which directly link
to a specifc module or even a specific record, in the backend.
...
To generate speaking urls for custom backend modules and routes,
...
The core now builds speaking urls for the backend by default.
