...
database table `tx_extensionmanager_domain_model_repository`.
...
Accessing `tx_extensionmanager_domain_model_repository` will
...
:file:`Configuration/Services.yaml` using the `extension.remote` tag.
