...
Registering soft reference parsers in the global array will trigger a
deprecation error.
...
.. code-block:: php
  ...
  $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['GLOBAL']['softRefParser']['your_key'] = YourSoftReferenceParser::class;
