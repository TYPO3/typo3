...
:php:`HttpUtility` have been marked as deprecated:

* :php:`redirect()`
* :php:`setResponseCode()`
* :php:`setResponseCodeAndExit()`

TYPO3 Core already provides a couple of possibilities to properly handle
...
directly return a PSR-7 response. In such case, the :php:`PropagateResponseException`
...
Calling one of those methods will log a deprecation warning and the
methods are dropped with TYPO3 v12.
...
Response, you can use the :php:`PropagateResponseException` as an intermediate
solution.
