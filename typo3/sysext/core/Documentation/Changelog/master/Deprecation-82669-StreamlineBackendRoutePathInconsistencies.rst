...
option in the module configuration section within `ext_tables.php`.

Backend Routes to modules without path configurations are now named
...
TYPO3 Backend Links via `buildUriFromRoutePath()` should be used with the new module name as
described above.
