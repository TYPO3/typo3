...
in the listing. More detailed information, e.g. last hit, are available in the
...
.. note:
   ...
   feature is enabled, see: #83677.

Impact
======

The creation date of a redirect is now shown in the "Statistics" tab of the
records' editing mask.
