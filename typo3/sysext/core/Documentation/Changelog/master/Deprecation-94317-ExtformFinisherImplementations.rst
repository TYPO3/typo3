...
A compatibility layer detects not adapted finishers and falls back to
initialization using extbase ObjectManager. This will raise a
deprecation log level entry and will stop working in core v12.
...
be added to :php:`TYPO3\CMS\Form\Domain\Finishers\FinisherInterface` in core v12.
