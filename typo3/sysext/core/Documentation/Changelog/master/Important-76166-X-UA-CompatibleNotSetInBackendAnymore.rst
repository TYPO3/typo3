...
As the official recommendation of Microsoft regarding the X-UA-Compatible tag is to not set this in the HTML code but instead via server configuration, the tag is not rendered by default in the backend anymore.
