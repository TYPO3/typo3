...
Calling :php:`GeneralUtility::shortMD5()` will trigger a deprecation level log
entry.
...
Any extension using :php:`GeneralUtility::shortMD5()` is affected. The extension
scanner will find usages of that method.
