...
This served as a short-hand for `$GLOBALS['TYPO3_CONF_VARS']['SVCONF']['auth']`, which was common in TYPO3 v4 days, but is
...
Manipulate the global array :php:`$GLOBALS['TYPO3_CONF_VARS']['SVCONF']['auth']` directly instead, preferably in `AdditionalConfiguration.php` or in an extensions' `ext_localconf.php` file.
