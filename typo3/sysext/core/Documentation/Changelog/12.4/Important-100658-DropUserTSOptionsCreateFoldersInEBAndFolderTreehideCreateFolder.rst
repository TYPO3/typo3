...
==============================================================================================
Important: #100658 - Drop UserTS options `createFoldersInEB` and `folderTree.hideCreateFolder`
==============================================================================================
...
The UserTS options `createFoldersInEB` and `folderTree.hideCreateFolder` were
