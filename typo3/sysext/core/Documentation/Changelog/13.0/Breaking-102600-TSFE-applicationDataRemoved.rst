...
:php:`EnableIndexingEvent` to get know if indexing should be performed. The 3rd
party crawler extension should use this instead of setting that information
on :php:`$GLOBALS['TSFE']`.
