...
image files is possible. In addition, a new report in the Reports module of
TYPO3 Backend shows if TYPO3 is properly configured for generating WebP
image files.
...
compression for converting e.g. PNG files will result in smaller file sizes as
