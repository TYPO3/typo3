...
Method :php:`TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig()`
...
Add default Page TSconfig to an :file:`Configuration/page.tsconfig` file within an
