...
required hook implementations to implement :php:`\TYPO3\CMS\Frontend\ContentObject\ContentObjectGetImageResourceHookInterface`.
...
and TYPO3 v13.x (using the new :doc:`PSR-14 Event <../13.0/Feature-102755-PSR-14EventForModifyingGetImageResourceResult>`),
