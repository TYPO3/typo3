...
TYPO3 has had multiple concepts of a Recycler / Trash Bin. One of the oldest
...
to such a page instead of deleting it. One other option is to use the Recycler
backend module (available with the shipped recycler system extension). This
process is much more user-friendly: Any kind of record which has been
(soft-deleted) can be viewed and re-added via this module, no manual process
during the deletion process is needed.
...
A migration is in place, it is recommended to use the Recycler module with
