...
Method :php:`TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addUserTSConfig()`
...
Add default User TSconfig to an :file:`Configuration/user.tsconfig` file within an
