...
The command `redirects:cleanup` has been extended by the option "integrityStatus".
...
In the `redirects:checkintegrity` command, the type of conflict is now displayed
in the table.
