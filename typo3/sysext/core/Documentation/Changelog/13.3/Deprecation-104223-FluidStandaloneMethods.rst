...
* :php:`AbstractTagBasedViewHelper->registerUniversalTagAttributes()`
* :php:`AbstractTagBasedViewHelper->registerTagAttribute()`
...
are just added as-is by :php:`AbstractTagBasedViewHelper`. This only needs attention
