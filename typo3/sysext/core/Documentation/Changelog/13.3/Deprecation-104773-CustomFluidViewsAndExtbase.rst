...
Instances with extensions that create view instances of :php:`StandaloneView` or
:php:`TemplateView` are affected. The extension scanner will find possible candidates.
...
should implement an own :php:`TYPO3\CMS\Core\View\ViewFactoryInterface` and configure
