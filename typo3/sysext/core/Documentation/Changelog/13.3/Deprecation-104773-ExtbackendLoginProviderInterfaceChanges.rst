...
The default :php:`LoginProviderInterface` implementation is
:php:`UsernamePasswordLoginProvider` provided by ext:core. This consumer
has been adapted.
...
Consumers of :php:`LoginProviderInterface` should implement :php:`modifyView()`
instead, the transition should be smooth. Consumers that need :php:`PageRenderer`
for JavaScript magic, should use dependency injection to receive an instance
of it.

Consumers of :php:`ModifyPageLayoutOnLoginProviderSelectionEvent` should use the
request instead, and/or should get an instance of :php:`PageRenderer` injected
as well.
