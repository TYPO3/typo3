...
- :php:`\TYPO3\CMS\Backend\Domain\Model\Module\BackendModule->setNavigationFrameScript()`
- :php:`\TYPO3\CMS\Backend\Domain\Model\Module\BackendModule->getNavigationFrameScript()`
- :php:`\TYPO3\CMS\Backend\Domain\Model\Module\BackendModule->setNavigationFrameScriptParameters()`
- :php:`\TYPO3\CMS\Backend\Domain\Model\Module\BackendModule->getNavigationFrameScriptParameters()`
- :php:`\TYPO3\CMS\Backend\Domain\Model\Module\BackendModule->setOnClick()`
- :php:`\TYPO3\CMS\Backend\Domain\Model\Module\BackendModule->getOnClick()`
