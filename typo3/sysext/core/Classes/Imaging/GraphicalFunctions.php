...
class GraphicalFunctions {
	 ...
	 * @var array
	 */
	protected $allowedColorSpaceNames = array('RGB', 'sRGB');
	...
	public function init() {
		...
		if ($gfxConf['RGB_colorSpace'] && in_array($gfxConf['RGB_colorSpace'], $this->allowedColorSpaceNames)) {
