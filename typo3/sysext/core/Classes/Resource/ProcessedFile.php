...
class ProcessedFile extends AbstractFile
{
    ...
    protected function reconstituteFromDatabaseRecord(array $databaseRow): void
    {
        ...
        $this->processingConfiguration = $this->processingConfiguration ?: (array)unserialize($databaseRow['configuration'] ?? '', ['allowed_classes' => [\TYPO3\CMS\Core\Resource\Processing\ImageCropScaleMaskTask::class, \TYPO3\CMS\Core\Imaging\ImageManipulation\Area::class]]);
