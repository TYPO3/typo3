...
class ProcessedFile extends AbstractFile {
	...
	public function __construct(File $originalFile, $taskType, array $processingConfiguration) {
	 ...
	 */
	static public function reconstituteFromDatabaseRecord(File $originalFile, array $record) {
		$taskType = $record['task_type'];
		$processingConfiguration = unserialize($record['configuration']);

		$file = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(__CLASS__, $originalFile, $taskType, $processingConfiguration);
