...
class ResourceStorage {
	...
	*/
	...
	public function addFile($localFilePath, Folder $targetFolder, $fileName = '', $conflictMode = 'changeName') {
		$localFilePath = \TYPO3\CMS\Core\Utility\PathUtility::cleanDirectoryName($localFilePath);
	...
	public function getFile($identifier) {
		$identifier = \TYPO3\CMS\Core\Utility\PathUtility::cleanDirectoryNameAndFile($identifier);
