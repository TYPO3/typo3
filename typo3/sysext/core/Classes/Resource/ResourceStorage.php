...
class ResourceStorage implements ResourceStorageInterface
{
    ...
    protected function handleRenameFile(
        ...
        string $conflictMode = DuplicationBehavior::RENAME,
    ): FileInterface {
        // The new name should be different from the current.
     ...
     */
    public function replaceAndRenameUploadedFile(array|UploadedFile $sourceFile, FileInterface $targetFile, ?string $targetFileName = null): FileInterface
    {
