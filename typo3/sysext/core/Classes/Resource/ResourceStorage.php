...
class ResourceStorage {
	...
	public function renameFolder($folderObject, $newName) {
		...
		if (!$this->checkFolderActionPermission('remove', $folderObject)) {
			throw new \TYPO3\CMS\Core\Resource\Exception\InsufficientFileAccessPermissionsException('You are not allowed to access the folder "' . $folderObject->getIdentifier() . '\'', 1357811441);
		}
