...
class FileRepository extends AbstractRepository {
	 ...
	 * @deprecated since TYPO3 6.2 - indexing should be handled transparently, not only upon request
	 */
	 ...
	 * @deprecated since TYPO3 6.2; - use FileIndexRepository::isIndexed
	 */
	 ...
	 * @param File $fileObject
	 * @return bool|array
	 * @deprecated since TYPO3 6.2; use FileIndexRepository instead
	 */
	public function getFileIndexRecord(File $fileObject) {
		GeneralUtility::logDeprecatedFunction();
		$storageUid = $fileObject->getStorage()->getUid();
		$identifier = $fileObject->getIdentifier();
		return FileIndexRepository::getInstance()->findOneByStorageUidAndIdentifier($storageUid, $identifier);
	}
	 ...
	 * @return array
	 * @deprecated since TYPO3 6.2; use FileIndexRepository::findByContentHash
	 */
	 ...
	 * @return void
	 * @deprecated since TYPO3 6.2 LTS; use FileIndexRepository::update
	 */
