...
class XcacheBackend extends AbstractBackend implements TaggableBackendInterface {
	 ...
	 * In this case all methods fail silently as xdebug
	 * var cache is not available in CLI context.
	 * The same happens if the cache has zero size, which
	 * happens for the same reason or due to a misconfiguration.
	 *
	 * @return bool
	 */
	public function runningFromCliOrWrongConfiguration() {
