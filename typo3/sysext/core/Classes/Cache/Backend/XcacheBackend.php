 ...
 */
class XcacheBackend extends \TYPO3\CMS\Core\Cache\Backend\AbstractBackend implements \TYPO3\CMS\Core\Cache\Backend\TaggableBackendInterface {
	...
	public function __construct($options = array()) {
		if (!extension_loaded('xcache')) {
			throw new \TYPO3\CMS\Core\Cache\Exception('The PHP extension "xcache" must be installed and loaded in order to use the xcache backend.', 1343331520);
		}
	...
	protected function findTagsByIdentifier($identifier) {
		...
		return empty($tags) ? array() : (array) $tags;
	}
