...
class ConfigurationManager implements \TYPO3\CMS\Core\SingletonInterface {
	...
	public function getDefaultConfigurationFileResource() {
		return PATH_site . static::DEFAULT_CONFIGURATION_FILE;
	}
	...
	public function getLocalConfigurationFileResource() {
		return PATH_site . static::LOCAL_CONFIGURATION_FILE;
	}
	...
	public function getAdditionalConfigurationFileResource() {
		return PATH_site . static::ADDITIONAL_CONFIGURATION_FILE;
	}
	...
	public function canWriteConfiguration() {
		...
		if (!@is_writable(($this->getLocalConfigurationFileResource())) && !@is_writable((PATH_site . static::LOCALCONF_FILE))) {
			$result = FALSE;
		}
		return $result;
	}
