...
class ConfigurationManager {
	...
	static protected function writeLocalConfiguration(array $configuration) {
		...
		$result = \TYPO3\CMS\Core\Utility\GeneralUtility::writeFile($localConfigurationFile, '<?php' . LF . 'return ' . \TYPO3\CMS\Core\Utility\ArrayUtility::arrayExport($configuration) . ';' . LF . '?>');
