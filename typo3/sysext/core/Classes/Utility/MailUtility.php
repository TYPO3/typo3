...
class MailUtility {
	 ...
	 *
	 * Ready to be passed to $mail->setFrom() (TYPO3\CMS\Core\Mail\Mailer)
	 *
	...
	static public function parseAddresses($rawAddresses = '') {
		...
		$addressParser = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Core\\Mail\\Rfc822AddressesParser',
			$rawAddresses);
