...
class GeneralUtility {
	 ...
	 * brought back due to many failing extensions relying on this function, as a
	 * redirect to the recommended usage VersionNumberUtility::convertVersionNumberToInteger
	 *
