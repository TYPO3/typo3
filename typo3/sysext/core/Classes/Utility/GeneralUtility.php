...
';
	...
	static public function plainMailEncoded($email, $subject, $message, $headers = '', $encoding = 'quoted-printable', $charset = '', $dontEncodeHeader = FALSE) {
		...
		case 'base64':
			$headerSet->addTextHeader('Content-Transfer-Encoding', 'base64');
			...
			break;
		case '8bit':
			$headerSet->addTextHeader('Content-Transfer-Encoding', '8bit');
			break;
		case 'quoted-printable':

		default:
			$headerSet->addTextHeader('Content-Transfer-Encoding', 'quoted-printable');
