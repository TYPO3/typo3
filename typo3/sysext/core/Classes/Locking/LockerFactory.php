...
class LockerFactory implements \Typo3\CMS\Core\SingletonInterface {
	...
	/**
	 * List of support locker types by the core
	 *
	 * @var array
	 */
	protected $typeMap = array(
		'disabled' => 'TYPO3\\CMS\\Core\\Locking\\Locker\\NullLocker',
		'file' => 'TYPO3\\CMS\\Core\\Locking\\Locker\\FileLocker',
		'flock' => 'TYPO3\\CMS\\Core\\Locking\\Locker\\FileLockLocker',
		'semaphore' => 'TYPO3\\CMS\\Core\\Locking\\Locker\\SemaphoreLocker',
	);
	 ...
	 * @api
	 */
	public function create($type, $context, $id, array $options = array()) {
		...
		$locker = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance($className, $context, $id, $options);
