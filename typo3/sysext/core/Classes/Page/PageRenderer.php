...
<link rel="icon" href="%1$s"%2$s />';
	 ...
	 * additionally, via a hook, more AMD-ready JS modules can be loaded via RequireJS
	 * this allows that when the BE needs e.g. "TYPO3.CMS.Backend.FormEngine" that other modules are loaded right after that
	 *
