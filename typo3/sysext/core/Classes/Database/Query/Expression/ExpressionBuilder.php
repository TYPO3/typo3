...
class ExpressionBuilder
{
     ...
     * @param string|Connection::PARAM_*|null $type The type of the parameter.
     * @return mixed Often string, but also int or float or similar depending on $input and platform
     * @todo: Change signature to literal($input, int $type = Connection::PARAM_STR) as breaking change in v12.
     */
