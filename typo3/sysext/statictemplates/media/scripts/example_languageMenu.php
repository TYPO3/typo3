 ...
 ***************************************************************/
/**
 * Creates a language-selector menu with three flags, an english, a
 * danish and a german flag for each language supported on the site.
 *
 * THIS IS AN EXAMPLE designed to work with the official TYPO3
...
// Little red arrow, which is inserted to the left of the flag-icon
