...
class tx_impexp {
	...
	var $maxFileSize = 1000000;
		// 1MB max record size
	var $maxRecordSize = 1000000;
		// 10MB max export size
	var $maxExportSize = 10000000;
