...
$TYPO3_CONF_VARS['SC_OPTIONS']['ext/install']['compat_version']['tx_cssstyledcontent_headlineposition'] = array(
	'title' => 'CSS Styled Content: Header position',
	'version' => 6000000,
	'description' => '<ul>
		...
		<li>To achieve these features, TypoScript in &quote;tt_content.textpic.10.if&quote; and &quote;tt_content.textpic.20.text.10.if&quote; was changed.</li>
	</ul>',
	'description_acknowledge' => 'Watch out and review TypoScript if you did any changes to if parts in tt_content.textpic!'
);
