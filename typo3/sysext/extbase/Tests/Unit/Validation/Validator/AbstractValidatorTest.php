 ...
 *                                                                        */
require_once __DIR__ . '/AbstractValidatorTestclass.php';
...
class AbstractValidatorTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	public function validatorAcceptsSupportedOptions() {
		...
		$validator = $this->getAccessibleMock('TYPO3\\CMS\\Extbase\\Tests\\Unit\\Validation\\Validator\\AbstractValidatorTestclass', array('dummy'), array($inputOptions));
