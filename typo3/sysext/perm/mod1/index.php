...
class SC_mod_web_perm_index {
	...
	public function doEdit() {
		...
		$code='
			...
			'<input type="submit" value="' . $GLOBALS['LANG']->getLL('Abort', 1) . '" onclick="' . htmlspecialchars('jumpToUrl(' . t3lib_div::quoteJSvalue(t3lib_BEfunc::getModuleUrl('web_perm') . '&id=' . $this->id) . '); return false;') . '" />
