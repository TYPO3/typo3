...
class ElementBrowser {
	...
	protected function file_generateSearchForm() {
		...
		<input type="hidden" name="tx_recordlist_elementbrowser[baseFolder]" value="' . $this->selectedFolder->getCombinedIdentifier() . '" />
		<input type="hidden" name="action" value="results" />
		<input type="hidden" name="controller" value="FileSearch" />
		<input type="hidden" name="extension" value="Recordlist" />
				<label for="search">' . $GLOBALS['LANG']->getLL('file_filter_searchfor') . '</label><input type="search" id="search" name="tx_recordlist_elementbrowser[filePattern]" value="' . htmlspecialchars($searchValue) . '">
				<div style="margin-top:5px;margin-bottom:5px"><input type="checkbox" class="checkbox" id="search_recursive" name="tx_recordlist_elementbrowser[recursive]" value="1" '. ($recursive ? 'checked="checked"' : '')
