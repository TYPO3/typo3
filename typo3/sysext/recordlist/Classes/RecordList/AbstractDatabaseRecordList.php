...
class AbstractDatabaseRecordList extends \TYPO3\CMS\Backend\RecordList\AbstractRecordList {
	...
	public function generateList() {
		...
		foreach ($GLOBALS['TCA'] as $tableName => $value) {
			...
			if (is_array($GLOBALS['TCA'][$tableName]) && (!$this->table || $tableName == $this->table) && (!$this->tableList || \TYPO3\CMS\Core\Utility\GeneralUtility::inList($this->tableList, $tableName)) && $GLOBALS['BE_USER']->check('tables_select', $tableName)) {
