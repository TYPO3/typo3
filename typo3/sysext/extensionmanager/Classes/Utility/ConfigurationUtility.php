...
class ConfigurationUtility implements \TYPO3\CMS\Core\SingletonInterface {
	...
	public function getCurrentConfiguration($extensionKey) {
		$defaultConfiguration = $this->getDefaultConfigurationFromExtConfTemplateAsFlatItemArray($extensionKey);
	 ...
	 * @return array
	 */
	public function getDefaultConfigurationFromExtConfTemplateAsFlatItemArray($extensionKey) {
