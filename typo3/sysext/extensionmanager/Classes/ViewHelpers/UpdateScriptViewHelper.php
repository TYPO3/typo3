...
class UpdateScriptViewHelper extends \TYPO3\CMS\Fluid\ViewHelpers\Link\ActionViewHelper {
	...
	public function render($extension) {
		...
		if ($extension['installed'] && file_exists(PATH_site . $extension['siteRelPath'] . '/class.ext_update.php')) {
			...
			$this->tag->setContent(\TYPO3\CMS\Backend\Utility\IconUtility::getSpriteIcon('apps-tcatree-select-recursive'));
			$tag = $this->tag->render();
		}
		return $tag;
	}
