...
class ExtensionRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
	...
	/**
	 * @var \TYPO3\CMS\Extbase\Persistence\Mapper\DataMapper
	 */
	 ...
	 *
	 * @param \TYPO3\CMS\Extbase\Persistence\Mapper\DataMapper $dataMapper
	 * @return void
	 */
	public function injectDataMapper(\TYPO3\CMS\Extbase\Persistence\Mapper\DataMapper $dataMapper) {
	 ...
	 *
	 * @param \TYPO3\CMS\Extbase\Persistence\Query $query the query to adjust
	 * @return \TYPO3\CMS\Extbase\Persistence\Query
	 */
	protected function addDefaultConstraints(\TYPO3\CMS\Extbase\Persistence\Query $query) {
