...
class ConfigurationItemRepository {
	...
	public function findByExtensionKey($extensionKey) {
		$configurationArray = $this->convertRawConfigurationToArray($extensionKey);
	 ...
	 * @return array
	 */
	protected function convertRawConfigurationToArray($extensionKey) {
		/** @var $configurationUtility \TYPO3\CMS\Extensionmanager\Utility\ConfigurationUtility */
		$configurationUtility = $this->objectManager->get('TYPO3\\CMS\\Extensionmanager\\Utility\\ConfigurationUtility');
		$defaultConfiguration = $configurationUtility->getDefaultConfigurationFromExtConfTemplateAsFlatItemArray($extensionKey);
