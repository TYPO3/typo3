...
class ExtensionTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * Data provider for getCategoryIndexFromStringOrIndexReturnsIndex
	 *
	 * @return array
	 */
	public function getCategoryIndexFromStringOrIndexReturnsIndexDataProvider() {
		return array(
			'empty string' => array(
				'',
				4
	...
	/**
	 * @test
	 * @dataProvider getCategoryIndexFromStringOrIndexReturnsIndexDataProvider
	 * @param string|integer $input Given input
	 * @param integer $expected Expected result
	 * @return void
	 */
	public function getCategoryIndexFromStringOrIndexReturnsIndex($input, $expected) {
