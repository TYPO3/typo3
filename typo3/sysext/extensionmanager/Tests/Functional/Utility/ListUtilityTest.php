...
final class ListUtilityTest extends FunctionalTestCase
{
    ...
    public function getAvailableAndInstalledExtensionsReturnsExpectedResultForComplexExtensionDependencyChainConstellation(): void
    {
        ...
        self::assertSame('2.0.2', $result['deepl_base']['updateToVersion']->getVersion());
        ...
        self::assertSame('1.0.2', $result['deepl_write']['updateToVersion']->getVersion());
        ...
        self::assertSame('2.0.1', $result['deepltranslate_core']['updateToVersion']->getVersion());
