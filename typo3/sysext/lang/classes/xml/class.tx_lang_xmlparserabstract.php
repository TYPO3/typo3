 ...
 */
abstract class tx_lang_XmlParserAbstract implements tx_Lang_ParserInterface {
	 ...
	 *
	 * @throws tx_lang_FileNotFoundException
	...
	protected function parseXmlFile() {
		...
		if (!isset($rootXmlNode) || $rootXmlNode === FALSE) {
			throw new tx_lang_InvalidXMLFileException(
