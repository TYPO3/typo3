...
class tx_lang_Factory implements t3lib_Singleton {
	...
	public function initialize() {
		$cacheClass = TYPO3_UseCachingFramework ? 'tx_Lang_CacheCachingFramework' : 'tx_Lang_CacheFile';
	...
	public function getParsedData($fileReference, $languageKey, $charset, $errorMode) {
		...
		try {
			...
			/** @var $parser tx_Lang_ParserInterface */
			...
			} catch (tx_lang_FileNotFoundException $exception) {
