...
$LOCAL_LANG = Array (
	...
	'si' => Array (
		...
		'endText' => 'Monosti se lahko razlikujejo glede na vašo verzijo in privilegije',
	...
	'tr' => Array (
		...
		'introtext2' => 'Bu mevcut modüllerin tanıtımının özetidir:',
		'endText' => 'Özellikler websitenize ve izinlerinize değişik bir şekilde bağlanıyor olabilir',
		'userInfo' => 'Kullanıcı olarak giriş yaptınız:',
	),
	'se' => Array (
		'introtext' => 'Web Content Management System',
	...
	'ro' => Array (
		...
		'endText' => 'Pot apãrea diferenşe în ceea ce priveºte opşiunile disponibile în funcşie de site ºi permisiuni',
		'userInfo' => 'Sînteşi conectat cu pseudonimul:',
	),
	'ch' => Array (
		'introtext' => 'ÍøÕ¾ÄÚÈİ¹ÜÀíÏµÍ³',
		'introtext2' => 'ÕâÊÇ¿ÉÓÃÄ£¿éµÄ¼ò¶ÌËµÃ÷',
		'endText' => 'ÌØÕ÷¿ÉÄÜ¸ù¾İÄúµÄÍøÕ¾ºÍÈ¨ÏŞ¶ø¸Ä±ä',
		'userInfo' => 'ÄúµÄµÇÂ¼Éí·İ:',
	),
	'sk' => Array (
		'introtext' => 'Systém pre správu obsahu na webe',
		'introtext2' => 'Toto je krátky popis dostupnıch modulov:',
		'endText' => 'Charakteristiky systému môu závisie od tvojho web sajtu a prístupovıch práv',
		'userInfo' => 'Si prihlásenı ako uívate¾:',
	),
	'lt' => Array (
	...
	'vn' => Array (
		'introtext' => 'Há»‡ Thá»‘ng Quáº£n LÃ½ TÃ i Liá»‡u TrÃªn Máº¡ng',
		'introtext2' => 'CÃ¡i nÃ y lÃ  tÃ³m táº¯c cá»§a nhá»¯ng modules hiá»‡n cÃ³:',
		'endText' => 'Chá»©c nÄƒng tÃ¹y theo trang máº¡ng vÃ  phÃ©p',
		'userInfo' => 'Báº¡n Ä‘ang logged in as a user',
	),
);
?>