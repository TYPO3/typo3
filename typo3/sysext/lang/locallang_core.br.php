...
Deseja continuar SEM salvar?',
		'labels.noRTEfound' => 'Atenção: Você não pode editar este campo, pois ele só pode ser editado com o Rich Text Editor, mas nenhum editor estava disponível ou a opção de edição com o RTE foi desativada.',
		...
		'labels.refreshList' => 'Atualizar lista do servidor',
		'labels.close' => 'Fechar',
		'labels.new' => 'NOVO',
		...
		'labels.clipInsert_file' => 'Inserir %s arquivo(s) da área de transferência',
		'labels.clipInsert_db' => 'Inserir %s registro(s) da área de transferência',
