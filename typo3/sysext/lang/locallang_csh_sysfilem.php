...
Your PHP-configuration may also impose other restrictions on you if safe-mode like features are enabled. Then use relative paths.',
	...
	'ch' => Array (
		'.description' => 'FilemountsÃèÊöÔÚ·şÎñÆ÷ÉÏµÄÒ»¸öÎÄ¼şÂ·¾¶,Ïà¶ÔÂ·¾¶»ò¾ø¶ÔÂ·¾¶.',
		'.details' => 'ÔÚºó¶ËÓÃ»§×éÖĞ´´½¨Ò»¸öfile mount¼ÇÂ¼²¢¶Ô´Ë¼ÇÂ¼·ÅÖÃÒ»¸ö²Î¿¼Ê±,
Äú¿ÉÒÔÔÊĞíÒ»¸öÓÃ»§ÔÚÎÄ¼ş>ÁĞ±íÄ£¿éÖĞ·ÃÎÊfile mount.
ÄúĞèÒª´´½¨²¢ÉèÖÃÖÁÉÙÒ»¸öÆäÖĞ´øÓĞÎÄ¼ş¼Ğ\'_temp_\'µÄfilemount,
Èç¹ûÄúÏëÓÃ»§Í¨¹ıÍøÒ³ä¯ÀÀÆ÷ÉÏ´«ÎÄ¼ş.
FilemountsÒ²¿ÉÒÔÔÚ·şÎñÆ÷ÉÏÅäÖÃµ½Ò»¸öÂ·¾¶µÄ·ÃÎÊ,ÓÃ»§ÓĞ¸Ã·şÎñ
µÄFTP·ÃÎÊ.Ö»Òª¼Ç×¡ÔÚ·şÎñÆ÷ÉÏÕıÈ·ÉèÖÃÎÄ¼şÈ¨ÏŞ,Ê¹ÍøÕ¾·şÎñÆ÷
ÓÃ»§(ÔËĞĞRHPµÄ)ÖÁÉÙÓĞµ½FTPÄ¿Â¼µÄ¶ÁÈ¨ÏŞ.',
		'title.description' => 'ÎªfilemountÊäÈëÒ»¸ö±êÌâ',
		'path.description' => 'ÊäÈëfilemountµÄÂ·¾¶,Ïà¶ÔÂ·¾¶»ò¾ø¶ÔÂ·¾¶È¡¾öÓÚBASEµÄÉèÖÃ.',
		'path.details' => 'Èç¹ûBASEÉèÖÃÎªÏà¶Ô,ÒÑmountµÄÂ·¾¶ÔÚÍøÕ¾µÄ×ÓÄ¿Â¼"fileadmin/" ÖĞÕÒµ½.
È»ºóÄúÓ¦¸ÃÔÚ"fileadmin/"ÖĞÊäÈëÂ·¾¶×ÓÄ¿Â¼×÷ÎªÂ·¾¶.ÀıÈç,Èç¹ûÄúÏëmount
µ½"fileadmin/user_uploads/all/"µÄ·ÃÎÊ,ÄÇÃ´ÊäÈëÖµ"user_uploads/all"×÷
ÎªÂ·¾¶Öµ.
Èç¹ûBASEÉèÖÃÎª¾ø¶Ô,ÄúÓ¦¸ÃÔÚ·şÎñÆ÷ÉÏÊäÈë¾ø¶ÔÂ·¾¶,
Èç"/home/ftp_upload"»ò"C:/home/ftp_upload".

<strong>×¢Òâ:</strong>ÔÚÈÎºÎÇé¿öÏÂ,È·±£PHPÕıÔÚÔËĞĞµÄÍøÕ¾·şÎñÆ÷
ÓÃ»§<em>ÖÁÉÙ</em>ÓĞµ½Â·¾¶µÄ¶ÁÈ¨ÏŞ.Èç¹ûÃ»ÓĞ,mount½«²»ÏÔÊ¾²¢ÇÒ
Ã»ÓĞÈÎºÎ¾¯¸æ.
Èç¹ûÄúÓĞÎÊÌâ-ÓÈÆäÊÇ¶ÔÓÚ¾ø¶Ômounts - ÊÔ×ÅÔÚfileadminÖĞmountÒ»Ğ©
ÀàËÆÓÚÏà¶ÔÂ·¾¶µÄ¶«Î÷.Èç¹ûË³Àû¹¤×÷µÄ»°,ÊÔÒ»ÏÂ¾ø¶ÔÂ·¾¶.

ÄúµÄPHPÅäÖÃ¿ÉÄÜ»áÔöÇ¿¶ÔÄúµÄÏŞÖÆÈç¹ûÏó°²È«-Ä£Ê½µÄÌØĞÔÎª¼¤»î.
ÄÇÃ´Ê¹ÓÃÏà¶ÔÂ·¾¶.',
		'hidden.description' => 'Ê¹ÓÃ´ËÑ¡ÏîÀ´ÔİÊ±½ûÖ¹filemount.',
		'hidden.details' => 'ËùÓĞÊ¹ÓÃmountµÄºó¶ËÓÃ»§½«²»ÔÙÓĞ·ÃÎÊÈ¨ÏŞ.Õâ°üÀ¨\'¹ÜÀíÔ±\'ÓÃ»§.',
		'base.description' => 'È·¶¨Â·¾¶ÓòµÄÖµÊÇ·ñÎª±»Ê¶±ğÎª·şÎñÆ÷ÉÏµÄÒ»¸ö¾ø¶ÔÂ·¾¶»¹ÊÇ¶ÔÓÚÍøÕ¾fileadmin/×ÓÄ¿Â¼µÄÒ»¸öÏà¶ÔÂ·¾¶.',
	),
	'sk' => Array (
	),
	'lt' => Array (
