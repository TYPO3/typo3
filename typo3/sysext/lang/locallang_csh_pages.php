...
<b>Merk:</b> Hver type har normalt et eget ikon tilknyttet. Dessuten kan visse typer være utilgjengelige for en bruker (så du kan oppleve at noen muligheter ikke er tilgjengelige for deg!). Hver type er satt opp til kun å tillate visse tabellelementer på siden. (SysFolder vil dog tillate et hvilket som helst element hvis du skulle få problemer).',
	...
	'fi' => Array (
		...
		'.description' => '\'Sivu\' (\'Page\')  tieto esittää useimmiten kokonaista www-sivua Typo3ssa. Kaikilla sivuilla on ID-numero jonka perusteella niitä voidaan linkittää ja referoida. \'Sivu\' tiedossa ei itsessään ole sisältöä vaan tähän tarkoitukseen on Sinun luotava \'Sivun sisältö\' (\'Page content\') tiedot.',
...
Teknisesti kaikissa tietokannan elementeiss\' on \'uid\' joka on yksilöllinen tunnus. Edelleen elementeillä tulee olla tieto \'pid\' joka sisältää kunkin sivun \'uid\' tunnuksen mikäm kukin elemntti kuuluu. Jos \'pid\' tieyto on nolla, tietoa kutsutaan silloin ns. juureksi (root).  Vain admistraattoreilla on oikeus juuren käsittelyyn. Lisäksi kaikkien taulun tietojen tulee olla asetettuja kuulumaan joko johonkin sivuun tai juureen.',
		'doktype.description' => 'Valitse sivun tyyppi. Tämän vaikutus on; kuuluuko sivu johonkin näkyvään sivuun vai käytetäänkö sitä muuhun tarkoitukseen.',
		'doktype.details' => '\'Standard\' tyyppi on normaali esitettävä www-sivu.
...
<B>Huomautus:</B>Eri tyypeillä on yleensä erilaiset ikonit. On huomattavaa ettei kaikkia tyyppejä ole käytössä erilaisilla käyttäjillä (voit ehkä huomata sen nytkin!) Ja lopuksi, erilaiset tyypit on konfiguroitu käyttämään ainoastaan määrittyjä taulu tietoja sivuilla (SysFolder mahdollistaa minkä tahansa tiedon jos Sinulla on ongelmia).',
		'TSconfig.description' => 'Sivun TypoScript asetukset.',
		'TSconfig.details' => 'Periaatteessa \'TypoScript\' on konsepti jolla annetaan arvoja puu-rakenteessa. Tämä tulee erityisesti esille luotaessamallinteita TYPO3 www-sivustoille.
...
Lopputuloksena syntyy sivulle \'TSconfig\' joka on itse asiassa kaikkien arvojen summa juuresta kullekin sivulle asti. Myös ko. sivun alasivut saavat vaikutuksen ylemmistä.Sivun TSconfig tiedodoista saa tulosteen valikosta \'Sivun TSconfig\' (\'Page TSconfig\') \'Web>Info\' modulissa (lisäohjelma "info_pagetsconfig" tuleeolla asennettuna).',
