...
$LOCAL_LANG = Array (
	'default' => array (
		...
		'TCEforms_docSelector.description' => "[FILL IN] TCEforms Document Sel",
		'TCEforms_cacheSelector.description' => "[FILL IN] TCEforms Cache Sel",
		...
		'wizard_forms_wiz.description' => "[FILL IN] wizard_forms_wiz",
		'wizard_forms_wiz_buttons.description' => "[FILL IN] wizard_forms_wiz_buttons",
		'wizard_forms_wiz_formmail_info.description' => "[FILL IN] wizard_forms_wiz_formmail_info",
		'wizard_table_wiz.description' => "[FILL IN] wizard_table_wiz",
		'wizard_table_wiz_buttons.description' => "[FILL IN] wizard_table_wiz_buttons",
		'.description' => "[FILL IN] ",
		'.description' => "[FILL IN] ",
		'.description' => "[FILL IN] ",
		'.description' => "[FILL IN] ",
