	...
	function uploadToTER($em) {
		...
		$extensionData = array(
			...
			'technicalData' => array(
				...
				'uploadFolder' => is_bool($uArr['EM_CONF']['uploadfolder']) ? $uArr['EM_CONF']['uploadfolder'] : (boolean) intval($uArr['EM_CONF']['uploadfolder']),
				'createDirs' => utf8_encode($uArr['EM_CONF']['createDirs']),
				'shy' => is_bool($uArr['EM_CONF']['shy']) ? $uArr['EM_CONF']['shy'] : (boolean) intval($uArr['EM_CONF']['shy']),
				...
				'clearCacheOnLoad' => if_bool($uArr['EM_CONF']['clearCacheOnLoad']) ? (boolean) intval($uArr['EM_CONF']['clearCacheOnLoad']) : $uArr['EM_CONF']['clearCacheOnLoad'],
