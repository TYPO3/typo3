...
class tx_cms_layout extends recordList {
	...
	function getTable_tt_content($id) {
		...
		/*$GLOBALS['SOBE']->doc->getPageRenderer()->addJsFile($GLOBALS['BACK_PATH'] . 'sysext/cms/layout/js/GridElementsDD_onReady.js');
		$GLOBALS['SOBE']->doc->getPageRenderer()->addJsFile($GLOBALS['BACK_PATH'] . 'sysext/cms/layout/js/GridElementsDD.js');*/
