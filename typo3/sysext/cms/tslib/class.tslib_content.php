...
class tslib_cObj {
	...
	var $stdWrapOrder = array(
		...
		'cache_read' => 'hook', // this is a placeholder for checking if the content is available in cache
		...
		'editPanel' => 'boolean',
		'editPanel.' => 'array',
		'cache_store' => 'hook', // this is a placeholder for storing the content in cache
	 ...
	 * @return	string		The processed input value
	 */
	public function stdWrap_cache_read($content = '', $conf = array()) {
	 ...
	 * @return	string		The processed input value
	 */
	public function stdWrap_cache_store($content = '', $conf = array()) {
		if (!empty($conf['cache.']['key'])) {
			if (defined('TYPO3_UseCachingFramework') && TYPO3_UseCachingFramework) {
				$cacheFrontend = $GLOBALS['typo3CacheManager']->getCache('cache_hash'); /* @var $cacheFrontend t3lib_cache_frontend_VariableFrontend */
				if ($cacheFrontend) {
