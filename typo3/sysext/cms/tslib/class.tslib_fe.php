 ...
 */
 class tslib_fe {
	...
	var $workspacePreview = NULL;			// Integer, that indicates which workspace is being previewed.
...
// -->
	 ...
	 *
	 * @return	void
	 * @deprecated since TYPO3 4.6, will be removed in TYPO3 4.8 as this is part of Tx_Version now
	 */
	...
	public function doWorkspacePreview() {
		return ($this->workspacePreview !== NULL ? TRUE : FALSE);
	}
