...
'	function openPic(url,winName,winParams)	{	//
	...
	function getLLL($index, $LOCAL_LANG) {
		if (isset($LOCAL_LANG[$this->lang][$index][0]['target']) && trim((string)$LOCAL_LANG[$this->lang][$index][0]['target']) !== '') {
			return $LOCAL_LANG[$this->lang][$index][0]['target'];
		} elseif (isset($LOCAL_LANG['default'][$index][0]['target']) && trim((string)$LOCAL_LANG['default'][$index][0]['target']) !== '') {
