...
// -->
	 ...
	 *
	 * configure: set config.stat_IP_anonymize.mask_ipv6 to a prefix-length (0 to 128)
	...
	protected function stripIPv6($strIP) {
		if(!empty($this->config['config']['stat_IP_anonymize']['mask_ipv6'])) {
			$netPrefix = intval($this->config['config']['stat_IP_anonymize']['mask_ipv6']);
		} else {
			$netprefix = 64;
		}
	 ...
	 *
	 * configure: set config.stat_IP_anonymize.mask_ipv4 to a prefix-length (0 to 32)
	...
	protected function stripIPv4($strIP) {
		if(!empty($this->config['config']['stat_IP_anonymize']['mask_ipv4'])) {
			$netPrefix = intval($this->config['config']['stat_IP_anonymize']['mask_ipv4']);
		} else {
			$netprefix = 24;
		}
