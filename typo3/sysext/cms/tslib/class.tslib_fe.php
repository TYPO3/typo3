	...
	*/
	...
	function makeCacheHash()	{
		...
		if ($this->cHash && is_array($GET))	{
			$this->cHash_array = t3lib_cacheHash::getRelevantParameters(t3lib_div::implodeArrayForUrl('', $GET));
			...
			if (t3lib_cacheHash::parametersRequireCacheHash(t3lib_div::implodeArrayForUrl('', $GET))) {
				$this->reqCHash();
			}
		}
	}
