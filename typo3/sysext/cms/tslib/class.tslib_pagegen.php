...
' . $mSOa_key . ' {' . $mSOa_value . '}';
	...
	TABLE.typo3-editPanel TD { border: 0px; }
		...
		if (is_array($GLOBALS['TSFE']->pSetup['javascriptLibs.'])) {
			...
			if ($GLOBALS['TSFE']->pSetup['javascriptLibs.']['jQuery']) {
					// Check if version / source is set, if not set variable to null to use the default from the page renderer class
				$version = $GLOBALS['TSFE']->pSetup['javascriptLibs.']['jQuery.']['version'] ? $GLOBALS['TSFE']->pSetup['javascriptLibs.']['jQuery.']['version'] : NULL;
				$source = $GLOBALS['TSFE']->pSetup['javascriptLibs.']['jQuery.']['source'] ? $GLOBALS['TSFE']->pSetup['javascriptLibs.']['jQuery.']['source'] : NULL;
