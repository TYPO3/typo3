...
class tx_cms_fehooks {
	...
	public function hook_eofe($params, $pObj) {
		if ($pObj->fePreview !== 1 || (isset($pObj->config['config']['disablePreviewNotification']) && intval($pObj->config['config']['disablePreviewNotification']) === 1)) {
			return;
		}
