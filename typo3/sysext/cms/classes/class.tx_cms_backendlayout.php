...
class tx_cms_BackendLayout implements t3lib_Singleton {
	...
	protected function loadSetup() {
		...
		// Load page TSconfig.
		$pageTSconfig = t3lib_BEfunc::getPagesTSconfig($this->pageUid);
	...
	protected function isOverruleRecords($pageTSconfig) {
		return (isset($pageTSconfig['tx_cms_backendlayout.']['overruleRecords']) && $pageTSconfig['tx_cms_backendlayout.']['overruleRecords'] == '1');
	}
