	...
	'types' => array(
		'1' => array(
			'showitem' =>
				...
				--palette--;LLL:EXT:cms/locallang_tca.xlf:backend_layout.palette.appearance;appearance,
				--div--;LLL:EXT:cms/locallang_tca.xlf:backend_layout.tabs.configuration, config,
