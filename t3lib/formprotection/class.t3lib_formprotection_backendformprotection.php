...
class t3lib_formprotection_BackendFormProtection extends t3lib_formprotection_Abstract {
	...
	public function clean() {
		parent::clean();
		$this->removeSessionTokenFromRegistry();
	}
	...
	public function setSessionTokenFromRegistry() {
		...
		return $this->sessionToken = $registry->get('core', 'formSessionToken:' . $this->backendUser->user['uid']);
	}
	...
	public function storeSessionTokenInRegistry() {
		$registry = t3lib_div::makeInstance('t3lib_Registry');
		$registry->set('core', 'formSessionToken:' . $this->backendUser->user['uid'], $this->sessionToken);
	}
	 ...
	 * @return string
	 */
	protected function removeSessionTokenFromRegistry() {
		$registry = t3lib_div::makeInstance('t3lib_Registry');
		return $registry->remove('core', 'formSessionToken:' . $this->backendUser->user['uid']);
	}
