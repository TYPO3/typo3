...
class t3lib_TCEmain {
	...
	function checkValue_group_select($res, $value, $tcaFieldConf, $PP, $uploadedFiles, $field) {
		...
		$valueArray = $this->applyFiltersToGroupValues($tcaFieldConf, $valueArray);
	 ...
	 */
	protected function applyFiltersToGroupValues(array $tcaFieldConfiguration, array $values) {
