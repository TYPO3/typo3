...
' . $content;
	...
	/**
	 * Return array this is set as $GLOBALS['TYPO3_LOADED_EXT'] in bootstrap.
	 * The array contains basic information about every loaded extension,
	 * see createTypo3LoadedExtensionInformationArray method for details.
	 *
	 * This is an internal method. It is only used during bootstrap and
	 * extensions should not used it!
	 *
	 * @param boolean $allowCaching If TRUE, the array will not be read / created from cache
	...
	/**
	 * Set up array with basic informations about loaded extension:
	 *
	 * array(
	 * 		'extensionKey' => array(
