...
TYPO3.Flashmessage = function () {
	...
	function createBox(severity, title, message) {
		return ['<div class="typo3-message message-', severity, '" style="width: 400px">',
				'<div class="t3-icon t3-icon-actions t3-icon-actions-message t3-icon-actions-message-close t3-icon-message-'+severity+'-close" style="float:right;cursor:pointer;"></div>', 
	...
	return {
		...
		display : function (severity, title, message, duration) {
			...
			console.log(box);
			console.log(box.child('.t3-icon-actions-message-close'));
