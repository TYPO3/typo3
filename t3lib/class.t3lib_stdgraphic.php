...
class t3lib_stdGraphic {
	...
	function init() {
		...
		if (!$gfxConf['im_version_5'] || $gfxConf['im_version_5'] === 'im4') {
			t3lib_div::deprecationLog('The option $TYPO3_CONF_VARS[\'GFX\'][\'im_version_5\'] is set to \'im4\'. Support has been removed in TYPO3 4.6. Make sure to upgrade to ImageMagick version 6 or GraphichsMagick.');
		} elseif ($gfxConf['im_version_5'] === 'im5') {
			t3lib_div::deprecationLog('The option $TYPO3_CONF_VARS[\'GFX\'][\'im_version_5\'] is set to \'im5\'. Support has been removed in TYPO3 4.6. Make sure to upgrade to ImageMagick version 6 or GraphichsMagick.');
		}
