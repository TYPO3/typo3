...
class t3lib_file_Utility_FileExtensionFilter {
	...
	protected function isAllowed(t3lib_file_FileInterface $file) {
		...
		if ($this->allowedFileExtensions !== NULL && count($this->allowedFileExtensions) > 0
		...
		if ($this->disallowedFileExtensions !== NULL && count($this->disallowedFileExtensions) > 0
		    && in_array($fileExt, $this->disallowedFileExtensions)) {
