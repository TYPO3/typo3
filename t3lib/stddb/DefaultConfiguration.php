...
return array(
	...
	'EXT' => array( // Options related to the Extension Management
		...
		'excludeForPackaging' => '(CVS|\\.(?!htaccess).*|.*~|.*\\.bak)',		// String: List of directories and files which will not be packaged into extensions nor taken into account otherwise by the Extension Manager. Perl regular expression syntax!
