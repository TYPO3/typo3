...
return array(
	...
	'BE' => array(
		...
		// String: Used to register own/other spriteGenerating Handler, they have to implement the interface TYPO3\CMS\Backend\Sprite\SpriteIconGeneratorInterface. If set to "TYPO3\CMS\Backend\Sprite\SpriteBuildingHandler" icons from extensions will automatically merged into sprites.
		'debug' => FALSE,
		...
		'AJAX' => array(
			...
			'SC_alt_file_navframe::expandCollapse' => 'typo3/sysext/backend/Classes/Controller/FileSystemNavigationFrameController.php:TYPO3\\CMS\\Backend\\Controller\\FileSystemNavigationFrameController->ajaxExpandCollapse',
			'TYPO3_tcefile::process' => 'typo3/sysext/backend/Classes/Controller/File/FileController.php:TYPO3\\CMS\\Backend\\Controller\\File\\FileController->processAjaxRequest',
			't3lib_TCEforms_inline::createNewRecord' => 'typo3/sysext/backend/Classes/Form/Element/InlineElement.php:InlineElement->processAjaxRequest',
			't3lib_TCEforms_inline::getRecordDetails' => 'typo3/sysext/backend/Classes/Form/Element/InlineElement.php:InlineElement->processAjaxRequest',
			't3lib_TCEforms_inline::synchronizeLocalizeRecords' => 'typo3/sysext/backend/Classes/Form/Element/InlineElement.php:InlineElement->processAjaxRequest',
			't3lib_TCEforms_inline::setExpandedCollapsedState' => 'typo3/sysext/backend/Classes/Form/Element/InlineElement.php:InlineElement->processAjaxRequest',
			't3lib_TCEforms_suggest::searchRecord' => 'typo3/sysext/backend/Classes/Form/Element/SuggestElement.php:SuggestElement->processAjaxRequest',
			'ShortcutMenu::getGroups' => 'typo3/sysext/backend/Classes/Toolbar/ShortcutToolbarItem.php:ShortcutToolbarItem->getAjaxShortcutGroups',
			'ShortcutMenu::saveShortcut' => 'typo3/sysext/backend/Classes/Toolbar/ShortcutToolbarItem.php:ShortcutToolbarItem->setAjaxShortcut',
			'ShortcutMenu::render' => 'typo3/sysext/backend/Classes/Toolbar/ShortcutToolbarItem.php:ShortcutToolbarItem->renderAjax',
			'ShortcutMenu::delete' => 'typo3/sysext/backend/Classes/Toolbar/ShortcutToolbarItem.php:ShortcutToolbarItem->deleteAjaxShortcut',
			'ShortcutMenu::create' => 'typo3/sysext/backend/Classes/Toolbar/ShortcutToolbarItem.php:ShortcutToolbarItem->createAjaxShortcut',
			...
			'BackendLogin::login' => 'typo3/sysext/backend/Classes/AjaxLoginHandler.php:TYPO3\\CMS\\Backend\\AjaxLoginHandler->login',
			'BackendLogin::logout' => 'typo3/sysext/backend/Classes/AjaxLoginHandler.php:TYPO3\\CMS\\Backend\\AjaxLoginHandler->logout',
			'BackendLogin::refreshLogin' => 'typo3/sysext/backend/Classes/AjaxLoginHandler.php:TYPO3\\CMS\\Backend\\AjaxLoginHandler->refreshLogin',
			'BackendLogin::isTimedOut' => 'typo3/sysext/backend/Classes/AjaxLoginHandler.php:TYPO3\\CMS\\Backend\\AjaxLoginHandler->isTimedOut',
			'BackendLogin::getChallenge' => 'typo3/sysext/backend/Classes/AjaxLoginHandler.php:TYPO3\\CMS\\Backend\\AjaxLoginHandler->getChallenge',
			'BackendLogin::refreshTokens' => 'typo3/sysext/backend/Classes/AjaxLoginHandler.php:TYPO3\\CMS\\Backend\\AjaxLoginHandler->refreshTokens',
