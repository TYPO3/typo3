...
<link rel="icon" href="%1$s"%2$s />';
	 ...
	 * Only called during processing of uncached content objects (USER_INT, COA_INT)
	 *
	 * @access private
	 */
	public function resetForProcessingOfUncachedContentObjects() {
		$this->jsLibs = array();
		$this->jsFiles = array();
		$this->jsFooterFiles = array();
		$this->cssFiles = array();
