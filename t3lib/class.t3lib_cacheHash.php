...
class t3lib_cacheHash implements t3lib_Singleton {
	 ...
	 */
	public function setCachedParametersWhiteList(array $cachedParametersWhiteList) {
	 ...
	 */
	public function setExcludeAllEmptyParameters($excludeAllEmptyParameters) {
	 ...
	 */
	public function setExcludedParameters(array $excludedParameters) {
	 ...
	 */
	public function setExcludedParametersIfEmpty(array $excludedParametersIfEmpty) {
	 ...
	 */
	public function setRequireCacheHashPresenceParameters(array $requireCacheHashPresenceParameters) {
