 ...
 * @internal
 */
class t3lib_beUserAuth extends t3lib_userAuth {
	...
	var $includeHierarchy = array();
		// List of group_id's in the order they are processed.
	var $includeGroupArray = array();
