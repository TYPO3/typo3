...
/**
 * A class to store and retrieve entries in a registry.
 *
 ...
 * @subpackage t3lib
 */
abstract class t3lib_utility_registry_AbstractRegistry implements t3lib_Singleton {
	...
	/**
	 * Unsets all entries of the given namespace.
	 *
	 * @param	string	Namespace. extension key for extensions or 'core' for core registry entries
	 * @return	void
	 * @throws	InvalidArgumentException	Throws an exception if the given namespace is not valid
