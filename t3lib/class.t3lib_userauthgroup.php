...
abstract class t3lib_userAuthGroup extends t3lib_userAuth {
	...
	protected function initializeFileStorages() {
		...
		if ($this->isAdmin()) {
			...
			// Inject the users' permissions to each storage
	...
	/**
	 * get the file permissions for a storage
	 ...
	 * @deprecated since TYPO3 4.7, use the TSconfig settings instead
	 */
	 ...
	 * @deprecated since TYPO3 4.7, will be removed in TYPO3 4.9, all data is stored in $this->fileStorages now, see initializeFileStorages()
	 * @access private
	 */
	 ...
	 *
	 * @return array
	 * @deprecated since TYPO3 4.7, will be removed in TYPO3 4.9 as getFileStorages() should be the one to be used
	 */
