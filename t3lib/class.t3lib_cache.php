...
class t3lib_cache {
	...
	public static function initializeCachingFramework() {
		if (!self::isCachingFrameworkInitialized()) {
			...
			t3lib_div::addFinalClassNameToRegister('t3lib_cache_Manager', 't3lib_cache_Manager');
			...
			t3lib_div::addFinalClassNameToRegister('t3lib_cache_Factory', 't3lib_cache_Factory');
