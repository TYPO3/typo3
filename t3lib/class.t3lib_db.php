...
class t3lib_DB {
	...
	var $store_lastBuiltQuery = FALSE;
	 ...
	 *
	 * @param string $table Table name for which to return an empty date. Just enter the table that the field-value is selected from (and any DBAL will look up
	 * @return array
	 */
