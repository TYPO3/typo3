...
class t3lib_log_Record implements ArrayAccess {
	...
	/** @var array gettable properties for ArrayAccess */
	...
	/** @var array settable properties for ArrayAccess */
	...
	public function offsetExists($offset) {
		...
		if (in_array($offset, $this->gettableProperties) && isset($this->$offset)) {
			$offsetExists = TRUE;
		}
	...
	public function offsetGet($offset) {
		if (!in_array($offset, $this->gettableProperties)) {
			return NULL;
		}
	...
	public function offsetSet($offset, $value) {
		if (in_array($offset, $this->settableProperties)) {
			$this->$offset = $offset;
		}
	}
