...
$TYPO3_CONF_VARS = array(
	...
	'SYS' => array(			// System related concerning both frontend and backend.
		...
		'exceptionalErrors' => E_ALL ^ E_NOTICE ^ E_DEPRECATED ^ E_WARNING ^ E_USER_ERROR ^ E_USER_NOTICE ^ E_USER_WARNING,	// Integer: The E_* constant that will be handled as an exception by t3lib_error_ErrorHandler. Default is "E_ALL ^ E_NOTICE ^ E_DEPRECATED ^ E_WARNING ^ E_USER_ERROR ^ E_USER_NOTICE ^ E_USER_WARNING" (20725) and "0" if displayError=0. See <a href="http://php.net/manual/en/errorfunc.constants.php" target="_blank">PHP documentation</a>.
