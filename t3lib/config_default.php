...
$TYPO3_CONF_VARS = array(
	...
	'SYS' => array(			// System related concerning both frontend and backend.
		...
		'userFuncClassPrefix' => '',	// This prefix must be the first part of any custom function or class name called directly from TYPO3, for instance in the TypoScript stdWrap function or as name for a registry class. Set to empty to allow all prefixes.
...
if(isset($GLOBALS['TYPO3_CONF_VARS']['FE']['userFuncClassPrefix'])) {
	$GLOBALS['TYPO3_CONF_VARS']['SYS']['userFuncClassPrefix'] = $GLOBALS['TYPO3_CONF_VARS']['FE']['userFuncClassPrefix'];
		// Deprecation log since 4.6, can be removed in 4.8
	t3lib_div::deprecationLog('$GLOBALS[\'TYPO3_CONF_VARS\'][\'FE\'][\'userFuncClassPrefix\'] is deprecated, use $GLOBALS[\'TYPO3_CONF_VARS\'][\'SYS\'][\'userFuncClassPrefix\'] instead');
}
