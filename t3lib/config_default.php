...
$TYPO3_CONF_VARS = array(
	...
	'SYS' => array(			// System related concerning both frontend and backend.
		...
		'errorHandlerErrors'=> E_ALL ^ E_COMPILE_WARNING ^ E_COMPILE_ERROR ^ E_CORE_WARNING ^ E_CORE_ERROR ^ E_NOTICE ^ E_PARSE ^ E_ERROR,	// Integer: The E_* constant that will be handled by the errorhandler. Not all PHP error types can be handled! Default is <tt>E_ALL ^ E_COMPILE_WARNING ^ E_COMPILE_ERROR ^ E_CORE_WARNING ^ E_CORE_ERROR ^ E_NOTICE ^ E_PARSE ^ E_ERROR</tt> (30466).
		'exceptionalErrors' => E_ALL ^ E_USER_NOTICE ^ E_USER_WARNING ^ E_USER_ERROR ^ E_COMPILE_WARNING ^ E_COMPILE_ERROR ^ E_CORE_WARNING ^ E_CORE_ERROR ^ E_NOTICE ^ E_PARSE ^ E_WARNING ^ E_ERROR,	// Integer: The E_* constant that will be handled as an exception by t3lib_error_ErrorHandler. Default is <tt>E_ALL ^ E_USER_NOTICE ^ E_USER_WARNING ^ E_USER_ERROR ^ E_COMPILE_WARNING ^ E_COMPILE_ERROR ^ E_CORE_WARNING ^ E_CORE_ERROR ^ E_NOTICE ^ E_PARSE ^ E_WARNING ^ E_ERROR</tt> (28917) and "0" if <tt>displayErrors=0</tt> (see <a href="http://php.net/manual/en/errorfunc.constants.php" target="_blank">PHP documentation</a>).
