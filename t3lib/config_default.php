...
//			'everybody' => ''					// default in tce_main is ''. If this is set (uncomment), this value is used instead.
	...
	'HTTP' => array(						// HTTP configuration to tune how TYPO3 behaves on HTTP request
		'adapter' => 'socket',					// String: Default adapter - either "socket" or "curl".
		'followRedirects' => FALSE, 			// Boolean: If set, redirects are followed by default. If number of tries are exceeded, an exception is thrown.
		'maxRedirects' => 5, 					// Integer: Maximum number of tries before an exception is thrown.
		'proxyHost' => '', 						// String: Default proxy server as http://proxy.example.org (You must not set the port here. Set the port below.)
		'proxyPort' => '', 						// Integer: Default proxy server port.
		'proxyUser' => '', 						// String: Default user name.
		'proxyPassword' => '', 					// String: Default password.
		'proxyMethod' => 'basic', 				// String: Default authentication method. Can either be "basic" or "digest". Defaults to "basic".
		'connectionTimeout' => 10, 				// Integer: Default timeout for connection. Exception will be thrown if connecting to remote host takes more than this number of seconds.
		...
		'userAgent' => '',						// String: Default user agent. If empty, this will be TYPO3/4.x, while x is the current branch version. This overrides the constant TYPO3_user_agent.
	),
