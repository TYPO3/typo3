...
/*]]>*/
	...
	public static function cHashParams($addQueryParams) {
		...
		$pA = t3lib_cacheHash::getRelevantHashParameters($addQueryParams);
	...
	public static function generateCHash($addQueryParams) {
		t3lib_div::logDeprecatedFunction();
		return t3lib_cacheHash::generateCacheHashForGetQuery($addQueryParams);
	}
	...
	public static function calculateCHash($params) {
		t3lib_div::logDeprecatedFunction();
		return t3lib_cacheHash::calculateCacheHash($params);
	}
