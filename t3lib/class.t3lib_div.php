...
/*]]>*/
	...
	public static function readLLfile($fileRef, $langKey, $charset = '', $errorMode = 0) {
		/** @var $languageFactory tx_language_Factory */
		$languageFactory = t3lib_div::makeInstance('tx_language_Factory');
	 ...
	 * @deprecated since TYPO3 4.6, will be removed in TYPO3 4.8 - use tx_language_LlphpParser::readLLfile() from now on
	 */
	 ...
	 * @param	string		Character set (optional)
	 * @return	array		LOCAL_LANG array in return.
	 * @deprecated since TYPO3 4.6, will be removed in TYPO3 4.8 - use tx_language_LlxmlParser->readLLfile() from now on
	 */
