...
/*]]>*/
	 ...
	 */
	public static function hasValidClassPrefix($classRef, $additionalPrefixes = array()) {
		$hasValidPrefix = FALSE;
		$validPrefixes = array('tx_', 'Tx_', $GLOBALS['TYPO3_CONF_VARS']['FE']['userFuncClassPrefix']);
		$classRef = trim($classRef);

		if (is_array($additionalPrefixes)) {
			$validPrefixes = self::array_merge_recursive_overrule($additionalPrefixes, $validPrefixes);
		}
