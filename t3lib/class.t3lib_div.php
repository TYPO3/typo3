...
/*]]>*/
	 ...
	 * @deprecated since TYPO3 4.6 - will be removed in TYPO3 4.8 - use tslib_caching_chash instead
	 */
	public static function cHashParams($addQueryParams) {
		/** @var $tslib_caching_chash tslib_caching_CacheHash */
		$tslibCacheHashInstance = self::makeInstance('tslib_caching_CacheHash');
		$pA = $tslibCacheHashInstance->getRelevantHashParameters($addQueryParams);
	 ...
	 * @deprecated since TYPO3 4.6 - will be removed in TYPO3 4.8 - use tslib_caching_CacheHash instead
	 */
	public static function generateCHash($addQueryParams) {
		/** @var $tslibCacheHashInstance tslib_caching_CacheHash */
		$tslibCacheHashInstance = self::makeInstance('tslib_caching_CacheHash');
		return $tslibCacheHashInstance->generateCHashForGetQuery($addQueryParams);
	}
