...
/*]]>*/
	...
	public static function getValidClassPrefixes() {
		...
		if(isset($GLOBALS['TYPO3_CONF_VARS']['SYS']['userFuncClassPrefix']) && is_string($GLOBALS['TYPO3_CONF_VARS']['SYS']['userFuncClassPrefix'])) {
			$validPrefixes = array_merge($validPrefixes, explode(',', $GLOBALS['TYPO3_CONF_VARS']['SYS']['userFuncClassPrefix']));
		}
