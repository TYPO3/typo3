...
/*]]>*/
	 ...
	 * @param $includeHeader $includeHeader Whether the HTTP header should be fetched or not. 0=disable, 1=fetch header+content, 2=fetch header only
	 * @param $requestHeaders $requestHeaders HTTP headers to be used in the request
	 * @param $report $report Error code/message and, if $includeHeader is 1, response meta data (HTTP status and content type)
