	...
	public static function png_to_gif_by_imagemagick($theFile) {
		if ($GLOBALS['TYPO3_CONF_VARS']['FE']['png_to_gif']
			...
			if (@is_file($newFile)) {
				...
				// unlink old file?? May be bad idea because TYPO3 would then recreate the file every time as TYPO3 thinks the file is not generated because it's missing!! So do not unlink $theFile here!!
		}
		return $theFile;
	}
...
/*]]>*/
	 ...
	 * Prints an array
	 *
	 * @param mixed $array Array to print visually (in a table).
	 * @return void
	 * @see view_array()
	 ...
	 * @param string $serviceSubStype Sub type like file extensions or similar. Defined by the service.
