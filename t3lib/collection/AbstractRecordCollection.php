 ...
 *
 * RecordCollections are collections of TCA-Records.
 * These collections are meant to be stored in TCA-table sys_collections and manageable
 * via TCEforms.
 *
 * RecordCollections might be used to group a set of records (e.g. news, images, contentElements)
