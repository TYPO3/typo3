...
class t3lib_PageRendererTest extends tx_phpunit_testcase {
	...
	public function loadJqueryLoadsTheLatestJqueryMinifiedVersionInNoConflictMode() {
		$expectedRegExp =
				'#<script src="contrib/jquery/jquery-' . t3lib_PageRenderer::JQUERY_VERSION_LATEST . '\.min\.(js|\d+\.js|js\?\d+)" type="text/javascript"></script>' . LF .
				'<script type="text/javascript">[ ]*var TYPO3 = TYPO3 \|\| {}; TYPO3.jQuery = jQuery = jQuery.noConflict\(true\);[ ]*</script>#';
	...
	public function loadJqueryRespectsGivenNamespace() {
		$expectedRegExp =
				'#<script src="contrib/jquery/jquery-' . t3lib_PageRenderer::JQUERY_VERSION_LATEST . '\.min\.(js|\d+\.js|js\?\d+)" type="text/javascript"></script>' . LF .
				'<script type="text/javascript">[ ]*var TYPO3 = TYPO3 \|\| {}; TYPO3.MyNameSpace = jQuery = jQuery.noConflict\(true\);[ ]*</script>#';
	...
	public function loadJqueryLoadsTheLatestJqueryVersionInNoConflictModeUncompressedInDebugMode() {
		$expectedRegExp =
				'#<script src="contrib/jquery/jquery-' . t3lib_PageRenderer::JQUERY_VERSION_LATEST . '\.(js|\d+\.js|js\?\d+)" type="text/javascript"></script>' . LF .
				'<script type="text/javascript">[ ]*var TYPO3 = TYPO3 \|\| {}; TYPO3.jQuery = jQuery = jQuery.noConflict\(true\);[ ]*</script>#';
		$this->fixture->loadJquery();
