 ...
 *    2011-2012 Steffen Gebert (steffen.gebert@typo3.org)
* All rights reserved
*
...
class t3lib_log_LogManagerTest extends tx_phpunit_testcase {
	...
	public function turnsUnderScoreStyleLoggerNamesIntoDotStyleLoggerNames() {
		$logger = t3lib_log_LogManager::getLogger('t3lib_log_LogManager');

		$this->assertEquals('t3lib.log.LogManager', $logger->getName());
	}
	...
	public function managerReturnsSameLoggerOnRepeatedRequest() {
		...
		t3lib_log_LogManager::registerLogger($loggerName);

		$logger1 = t3lib_log_LogManager::getLogger($loggerName);
		$logger2 = t3lib_log_LogManager::getLogger($loggerName);
	...
	public function configuresLoggerWithCorrectWriter() {
		...
		$logger = t3lib_log_LogManager::getLogger($component);
