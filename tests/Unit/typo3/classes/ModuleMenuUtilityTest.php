 ...
 * @subpackage tests
 */
class Typo3_ModuleMenu_UtiliyTest extends Tx_PhpUnit_TestCase {

	/**
	 * @var Typo3_ModuleMenu_Utility
	 */
	...
	public function createEntryFromRawDataGeneratesMenuEntry() {
		$entry = $this->callInaccessibleMethod('Typo3_ModuleMenu_Utility', 'createEntryFromRawData', array());
		$this->assertInstanceOf('Typo3_ModuleMenuEntry', $entry);
	}
	...
	public function createEntryFromRawDataSetsPropertiesInEntryObject() {
		...
		$entry = $this->callInaccessibleMethod('Typo3_ModuleMenu_Utility', 'createEntryFromRawData', $rawModule);
