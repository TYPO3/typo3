...
composer require --no-progress --no-interaction --dev typo3tests/dataset-import:@dev typo3/cms-styleguide:^12.0.5 typo3/testing-framework:^8.2.7 ${EXTRA_PACKAGES}
