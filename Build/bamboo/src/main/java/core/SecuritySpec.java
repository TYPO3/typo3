...
public class SecuritySpec extends AbstractCoreSpec {
    ...
    Plan createPlan() {
        ...
        jobsMainStage.add(this.getJobIntegrationDocBlocks(0, "PHP72", this.getTaskComposerInstall("PHP72"), true));
        ...
        jobsMainStage.add(this.getJobUnitJavaScript(0, "JS", this.getTaskComposerInstall("PHP72"), true));
